...
DEFAULT_CHAINS: dict[str, list[str]] = {
    ...
    "custom_wib92":             ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "justel_html":              ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_change_lg":         ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_bs_bilingual":      ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "pymupdf_wetboek":          ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
