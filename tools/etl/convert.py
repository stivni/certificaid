...
DEFAULT_CHAINS: dict[str, list[str]] = {
    "pdftotext_ejustice":       ["cleanup_basics", "unindent_pdftotext_margin", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "split_merged_headings", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "custom_wetboek":           ["cleanup_basics", "strip_kb_bijwerkingen", "strip_amendment_overview", "strip_fisconet_artefacts", "fix_stuck_art_number", "inject_headings_wettekst", "split_merged_headings", "strip_empty_trailing_headings", "emit_frontmatter"],
