...
DEFAULT_CHAINS: dict[str, list[str]] = {
    "pdftotext_ejustice":       ["cleanup_basics", "unindent_pdftotext_margin", "strip_french_bilingue_bleed", "strip_amendment_overview", "fix_stuck_art_number", "normalize_artikel_to_art", "fix_pdftotext_glue_bugs", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "custom_wib92":             ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
