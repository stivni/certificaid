...
DEFAULT_CHAINS: dict[str, list[str]] = {
    ...
    "custom_wib92":             ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
