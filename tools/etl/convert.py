...
DEFAULT_CHAINS: dict[str, list[str]] = {
    ...
    "justel_html":              ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_change_lg":         ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_bs_bilingual":      ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
