...
DEFAULT_CHAINS: dict[str, list[str]] = {
    ...
    "extract_norm":             ["cleanup_basics", "unindent_pdftotext_margin", "strip_pdf_page_noise", "strip_itaa_norm_footers", "merge_broken_sentences", "fix_italic_spacing", "normalize_bullet_glyphs", "emit_frontmatter"],
