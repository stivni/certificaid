...
DEFAULT_CHAINS: dict[str, list[str]] = {
    "pdftotext_ejustice":       ["cleanup_basics", "unindent_pdftotext_margin", "strip_french_bilingue_bleed", "strip_amendment_overview", "fix_stuck_art_number", "normalize_artikel_to_art", "fix_pdftotext_glue_bugs", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "custom_wetboek":           ["cleanup_basics", "strip_french_bilingue_bleed", "strip_kb_bijwerkingen", "strip_amendment_overview", "strip_fisconet_artefacts", "fix_stuck_art_number", "normalize_artikel_to_art", "fix_pdftotext_glue_bugs", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    "custom_wib92":             ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "justel_html":              ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_change_lg":         ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_bs_bilingual":      ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
    # strip_letter_spaced_page_headers: parlementaire letter-gespatieerde koppen (MvT-stijl)
    ...
    "extract_norm":             ["cleanup_basics", "unindent_pdftotext_margin", "strip_pdf_page_noise", "strip_itaa_norm_footers", "strip_norm_toc_residue", "merge_broken_sentences", "fix_italic_spacing", "normalize_bullet_glyphs", "promote_norm_section_labels", "strip_norm_column_bleed", "emit_frontmatter"],
    "pdftotext_compilatie_btw": ["cleanup_basics", "unindent_pdftotext_margin", "strip_running_page_headers", "strip_mb_compilatie_cover", "strip_kb_bijwerkingen", "strip_compilatie_appendix", "strip_amendment_overview", "fix_stuck_art_number", "normalize_artikel_to_art", "merge_article_reference_wraps", "merge_broken_sentences", "fix_pdftotext_glue_bugs", "split_merged_headings", "inject_headings_wettekst", "merge_wrapped_headings", "strip_toc_headings_with_art_range", "strip_inline_footnote_block", "strip_concord_table_headings", "strip_duplicate_toc_headings", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "promote_wettekst_section_labels", "promote_roman_rubrieken", "split_long_art_heading", "strip_opgeheven_kb_appendix", "strip_empty_trailing_headings", "emit_frontmatter"],
