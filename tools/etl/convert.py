...
DEFAULT_CHAINS: dict[str, list[str]] = {
    "pdftotext_ejustice":       ["cleanup_basics", "unindent_pdftotext_margin", "strip_amendment_overview", "fix_stuck_art_number", "normalize_artikel_to_art", "fix_pdftotext_glue_bugs", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "custom_wetboek":           ["cleanup_basics", "strip_kb_bijwerkingen", "strip_amendment_overview", "strip_fisconet_artefacts", "fix_stuck_art_number", "normalize_artikel_to_art", "fix_pdftotext_glue_bugs", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "custom_wib92":             ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    ...
    "justel_html":              ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_change_lg":         ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "justel_bs_bilingual":      ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
    "pymupdf_wetboek":          ["cleanup_basics", "strip_amendment_overview", "fix_stuck_art_number", "inject_headings_wettekst", "strip_leading_toc_heading_block", "fix_pdf_slash_loss_in_article_headings", "split_merged_headings", "promote_wettekst_section_labels", "strip_empty_trailing_headings", "emit_frontmatter"],
