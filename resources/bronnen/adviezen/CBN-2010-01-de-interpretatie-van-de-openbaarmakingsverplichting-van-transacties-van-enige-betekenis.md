...
Voor wat de interpretatie betreft van deze passus is de Commissie de mening toegedaan, dat hier transacties worden bedoeld die plaatsvinden tussen vennootschappen van de groep die volledig[^3] in eigendom zijn van de groep. Deze transacties moeten alsdan dus niet worden opgenomen in deze nieuwe staat van de toelichting. 
