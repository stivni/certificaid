...
provenance:
  ...
  trust:
    ...
    rationale: 'Kort advies (1837 chars): geen ETL-artefacten aangetroffen. Afwezigheid van ##-headings is normaal conform QA-richtlijn voor korte adviezen.'
    layer1:
      status: pass
      run_id: 20260512-233938
      run_at: '2026-05-12T23:39:39Z'
      heading_count: 0
      max_section_chars: 1834
      file_size_chars: 1834
      flags: []
    layer2:
      status: trusted
...
Toch zou de Commissie met betrekking tot degressieve afschrijvingen een aanbeveling willen geven om op een bondige wijze de uitwerking van het degressieve systeem toe te lichten, om duidelijk het onderscheid te laten blijken met andere afschrijvingsvormen. 
