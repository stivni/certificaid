...
provenance:
  ...
  trust:
    ...
    layer2:
      ...
      concrete_problemen: []
      rationale: 'Laag-1 pass, geen flags. Drie ## headings met volledige titels,
        voetnoten [^1]–[^2] intact, inhoud compleet (verwijst correct naar advies
        175/1 en bespreekt de afwikkeling). Geen artefacten zichtbaar.'
      run_at: '2026-05-11T12:09:17Z'
      status: trusted
    rationale: 'Laag-1 pass, geen flags. Drie ## headings met volledige titels, voetnoten
      [^1]–[^2] intact, inhoud compleet (verwijst correct naar advies 175/1 en bespreekt
      de afwikkeling). Geen artefacten zichtbaar.'
    status: trusted
themas:
- toelichting
