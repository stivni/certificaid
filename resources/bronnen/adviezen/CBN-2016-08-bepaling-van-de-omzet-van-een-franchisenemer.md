...
provenance:
  ...
  trust:
    ...
    layer1:
      ...
      heading_count: 3
      max_section_chars: 5752
      file_size_chars: 8274
      flags: []
    layer2:
      status: trusted
...
In die zin leunt de commerciële samenwerkingsovereenkomst waarbij een eigendom en bijgevolg de risico’s slechts worden overgedragen bij de verkoop aan de uiteindelijke klant,[^12] dichter aan bij de commissionairsovereenkomst dan bij de franchiseovereenkomst[^13] en zijn bijgevolg de aanbevelingen van de Commissie met betrekking tot tussenpersonen die optreden voor rekening van hun opdrachtgever van toepassing.
