...
provenance:
  ...
  tooling:
    ...
    model:
    prompt_version:
  generated_at: '2026-05-08T18:33:27Z'
  stale: false
  stale_reason:
  trust:
    status: needs-rework
...
- dat het beginsel van het compensatieverbod[^1]
   alsook het beginsel van de volledige aard van de jaarrekening[^2]
 in elk geval moeten worden nageleefd. 
