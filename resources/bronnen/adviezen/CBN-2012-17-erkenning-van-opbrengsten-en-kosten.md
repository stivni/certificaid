...
Veronderstel dat een onderneming een machine verkoopt in het jaar X die ze levert aan de koper in datzelfde jaar X[^9]. De partijen komen overeen dat de risico’s van verlies of beschadiging van de machine worden overgedragen aan de koper bij de levering van de machine. De verkoper blijft echter eigenaar van de machine, als “waarborg”, tot de prijs volledig is betaald in jaar X+1.
