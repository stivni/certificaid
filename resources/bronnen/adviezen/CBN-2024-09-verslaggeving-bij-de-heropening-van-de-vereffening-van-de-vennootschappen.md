...
provenance:
  ...
  trust:
    ...
    layer1:
      verdict: warn
      heading_count: 13
      max_section_chars: 28437
      file_size_chars: 29413
      flags:
        - name: max_section_size
          status: warn
          detail: 'langste sectie op ##-niveau: 28437 chars (>24000); chunker splitst auto op alinea-grenzen via split_long_chunk'
          samples: []
...
| | 489 | Andere diverse schulden | 20 | |
| aan | 473 | Andere rechthebbenden | | 35 |
...
Om die redenen dient er na de heropening geen boekhouding te worden gevoerd14,15, geen jaarrekening te worden opgemaakt en geen aangifte in de vennootschapsbelasting16 te worden ingediend.17
