...
provenance:
  ...
  trust:
    ...
    layer1:
      ...
      heading_count: 0
      max_section_chars: 11724
      file_size_chars: 11724
      flags: []
    layer2:
      status: trusted
...
1. In een eerste benadering wordt verwezen naar de boekhoudkundige verwerking door de vennootschap die de terugbetaling of uitkering verricht : 
...
2. Een tweede benadering gaat ervan uit dat er in boekhoudkundig opzicht, ten aanzien van de aandeelhouder en onverminderd de fiscale kwalificatie van de betrokken uitkering, sprake is van : 
