...
## Overzicht: waar worden stopzettingsmeerwaarden aangegeven?
...
Dit vak geldt voor **alle** stopzettingsmeerwaarden — zowel voor vroegere handelaars/nijveraars (winst) als voor vroegere vrije beroepen (baten).
...
|---|---|---|---|
| 2 | Winst/baten die overeenstemmen met de voorheen afgetrokken werkelijke kosten van overdracht van activa waarop u na de stopzetting een stopzettingsmeerwaarde hebt verwezenlijkt | **1693-53** | 2693-23 |
...
| Rubriek | Omschrijving | Code belastingplichtige | Code partner |
|---|---|---|---|
| 4 | Winst en baten verkregen of vastgesteld na de stopzetting (behalve de in rubrieken 1 t/m 3, 5 en 6 bedoelde inkomsten en vergoedingen tot herstel tijdelijke derving) | **1695-51** | 2695-21 |

### Rubriek 5 en 6 — Sportbeoefenaars (niet relevant voor stopzettingsmeerwaarden)
...
Dit vak is voor meerwaarden verwezenlijkt **tijdens** de beroepswerkzaamheid (dus niet bij stopzetting).
...
## Tariefsamenvatting voor stopzettingsmeerwaarden (vak XXI)
...
## Opgaven te voegen bij de aangifte
