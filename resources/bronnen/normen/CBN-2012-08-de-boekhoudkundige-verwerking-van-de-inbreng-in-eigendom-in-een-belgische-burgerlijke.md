...
Gelet op het feit dat een burgerlijke maatschap geen rechtspersoonlijkheid heeft en dus niet over een afgescheiden vermogen beschikt[^2], worden de ingebrachte goederen[^3] geen eigendom van de maatschap, maar komen deze daarentegen in mede-eigendom tussen de verschillende vennoten.[^4] Een rechtspersoon die een goed (in eigendom) inbrengt in een burgerlijke maatschap, blijft dus eigenaar voor zijn onverdeeld aandeel, voor zover in de maatschapsovereenkomst niet anders is bepaald.[^5] 
