...
provenance:
  ...
  trust:
    ...
    layer1:
      verdict: pass
      heading_count: 6
      max_section_chars: 4531
      file_size_chars: 5973
      flags: []
...
In de voorbereidende werken van de wet van 1873[^4], die de bron is van de verplichting tot vorming van een wettelijke reserve, wordt gesteld dat de wettelijke reserve tot doel heeft het maatschappelijk kapitaal ongeschonden te bewaren, en dit zowel ten bate van de aandeelhouders als ten bate van derden.[^5] 
...
[^9]: Artikel 319bis, tweede lid W.Venn.
