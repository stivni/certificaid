...
Actualisering van vorderingen en schulden op korte termijn (update)
...
actualisering van schulden op korte termijn

actualisering van vorderingen op korte termijn
...
Renteloze vorderingen (schulden) en vorderingen (schulden) met een abnormaal lage rente, op meer dan één jaar
