...
- Select - Algemeen Vrije keuze tussen de geconsolideerde en geaggregeerde methode -- Berekening op geconsolideerde basis -- Berekening op geaggregeerde basis (+ 20%-methode) -- Voorbeelden ---- Voorbeeld 1 ---- Voorbeeld 2 ---- Voorbeeld 3 ---- Voorbeeld 4
...
Voor een moedervennootschap vindt de beoordeling van de groottecriteria plaats hetzij op geconsolideerde 3
 basis, hetzij op geaggregeerde 4
 basis. De moedervennootschap heeft de vrije keuze welke 5
...
Indien de vennootschap ervoor kiest om de beoordeling van de groottecriteria toe te passen op de geconsolideerde gegevens, moet 7
...
In het voorbeeld wordt er hypothetisch vanuit gegaan dat de omzet van de vennootschap B een intragroepsomzet omvat van 7.000.000 euro die geëlimineerd wordt voor de bepaling van de opbrengsten op geconsolideerde basis 38
...
Groottecriteria – Boekjaar korter of langer dan 12 maanden (update)
