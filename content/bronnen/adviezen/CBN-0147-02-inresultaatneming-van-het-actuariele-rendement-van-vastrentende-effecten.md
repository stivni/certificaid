...
Op 20 september 1991 boden volgende twee Staatsleningen, met een vergelijkbare resterende looptijd, hetzelfde actuariële rendement bij aankoop: 9,44 % 2
 : 
...
Actuariële opwaardering

Cumul actuariële opwaardering

Resultatenrekening vóór beurs-correcties
...
Beurskoers-correcties (**)

Boekwaarde nà correcties

Totaal resultaten

Ter vergelijking: Resultaten bij behoud v/d oorspronkelijke aanschaffingswaarde (**)
...
(*) d.i. de waarde bij actualisatie van de toekomstige inkomstenstroom tegen het actuariële rendement bij aankoop (= 9,44%) verminderd met de gelopen niet vervallen intresten.

(**) Toepassing van artikelen 29, § 2, tweede lid, 31, lid 2-4, 19, lid 6 van het K.B. van 8 oktober 1976.

Tweede voorbeeld

Aankoop staatsfonds code 224 - 1985-1994 - coupondatum 14/05 -

nominale rente = 11,25%
...
Actuariële afwaardering

Cumul actuariële afwaardering

Resultatenrekening vóórbeurscorrecties
