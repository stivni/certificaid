---
title: "Obligatielening — v5 (boekingen verplaatst, hints in onderdelen)"
tags:
  - experiment
  - mockup
status: experimental
...
> **Vergelijkings-versie v5** — alle boekings-tabellen + balans-snapshots
> staan chronologisch onder Perspectieven per actor. In "Hoe het werkt"
> blijven **korte rekeningen-hints** per onderdeel staan
> (*Rekeningen: 4901 over te dragen disagio…*). Vergelijk met
> [[obligatielening-v4|v4]] en [[obligatielening-v6|v6]];
> overzicht: [[obligatielening-v2-mockup|alle versies]].
>
...
*Rekeningen:* **201 "Kosten uitgifte leningen"** (subrubriek van
oprichtingskosten) — afschrijving via **6300**.
...
*Rekeningen:* **4901 "Over te dragen disagio"** (uitgestelde last) of
**4902 "Over te dragen agio"** (uitgestelde opbrengst), met spreiding
via **6500** of een corresponderende opbrengst-rekening.
...
*Rekeningen:* **650 "Rentekosten obligatielening"** voor de last,
**492 "Toe te rekenen kosten"** voor de prorata-positie op balansdatum.
...
*Rekeningen:* **170** wordt geledigd; **550** vermindert.
...
**v5 (huidige)** — wijzigingen t.o.v. v4:
