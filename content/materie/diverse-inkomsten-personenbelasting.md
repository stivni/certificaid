...
|---|---|---|
| **1° Occasionele winsten of baten** | Eenmalige consultancy buiten beroep om | 33% afzonderlijk |
| **2° Prijzen, subsidies en gelijkaardige uitkeringen** | Wetenschappelijke prijs, sportoverwinning | 16,5% afzonderlijk (boven plafond) |
| **3° Onderhoudsuitkeringen ontvangen** | Alimentatie ex-echtgenoot | Progressieve tarieven |
| **5° Inkomsten uit onderverhuring of vrijgesteld OG** | Onderhuur van een woning | Progressieve tarieven |
| **6° Loten van obligaties** | Trekkingsprijs | 30% (RV) |
| **8° Toevallige meerwaarden op gronden** | Verkoop bouwgrond binnen 5 of 8 jaar | 33% / 16,5% |
| **9° Toevallige meerwaarden op gebouwen** | Verkoop woning (niet eigen) binnen 5 jaar | 16,5% |
| **9° (bis) Aanmerkelijke deelneming verkocht aan buitenl. ven.** | > 25% verkoop aan niet-EU vennootschap | 16,5% |
| **10° Meerwaarden vruchtgebruik / opstal / erfpacht** | Vergoeding tegen opheffing zakelijk recht | Progressieve tarieven |
| **12° Inkomsten uit deeleconomie** | Vergoedingen via erkende deelplatforms | 20% bevrijdend (tot plafond) |
...
**Niet meer "normaal beheer"** wanneer ten minste één van volgende kenmerken aanwezig is:
- **Speculatief karakter** — kort tijdsverloop, hoge frequentie, geleende fondsen
- **Beroepsmatige aanpak** — systematische zoekactie, professionele tools, aanzienlijk tijdsbestek
...
>
> Het bedrag van de winst is **op zich geen criterium** voor speculatie. Een grote meerwaarde kan voortvloeien uit normaal beheer (lange beleggingshorizon, geen geleende fondsen, geen speculatief patroon). Cruciaal zijn de **omstandigheden**: tijdsverloop, frequentie, gebruik van geleende fondsen, professionele aanpak. Een belegger die 10 jaar lang aandelen behoudt en met grote winst verkoopt, doet aan normaal beheer — vrijgesteld. Een day-trader met dezelfde winst doet aan speculatie — 33% afzonderlijke aanslag.
>
> 🤖 *AI-aanvulling*
...
- Verkoop van een grote partij wijn of antiek door een privépersoon, met grote meerwaarde, na korte aanhoudingsperiode
- Speculatieve transacties op aandelen of derivaten (day-trading, marge-handel)
...
|---|---|---|
| **Bouwgronden, ongebouwde OG** | Verkoop binnen **5 jaar** na verwerving | 33% |
| **Bouwgronden, ongebouwde OG** | Verkoop tussen 5 en 8 jaar na verwerving | 16,5% |
| **Bouwgronden, ongebouwde OG** | Verkoop na 8 jaar | 0% (vrijgesteld) |
| **Gebouwen** | Verkoop binnen **5 jaar** na verwerving | 16,5% |
| **Gebouwen** | Verkoop na 5 jaar | 0% (vrijgesteld) |

**Berekening meerwaarde**:

```
Verkoopprijs (excl. registratierechten/notariskosten van koper)
−  Verkrijgingskosten (aankoopprijs + reg.rechten + notariskosten + verbouwingen)
=  Meerwaarde
```
...
> [!info]- In de praktijk
>
> Een belastingplichtige koopt in 2022 een appartement (geen eigen woning) voor € 280 000. In 2025 verkoopt hij voor € 350 000 (na 3 jaar — binnen de 5-jaarstermijn voor gebouwen).
>
> - Meerwaarde: € 350 000 − € 280 000 (excl. verkoopkosten en eventuele renovatie) = € 70 000
> - Aanslag: € 70 000 × 16,5% = € 11 550 afzonderlijk belast
>
> Wachten tot 2027 (na 5 jaar): meerwaarde **vrijgesteld** — besparing van € 11 550.
>
> 🤖 *AI-aanvulling*

> [!warning]- De 5-jaars termijn loopt vanaf datum verwerving, niet vanaf eerste bewoning
> ❌ *"Ik koop een huis in 2020, verbouw het tot 2022, en verkoop in 2024 — minder dan 5 jaar 'gebruik' dus belastbaar."*
>
> De bewaartermijn loopt vanaf de **datum van de oorspronkelijke verwerving** (notariële akte aankoop), niet vanaf de eerste bewoning of het einde van de verbouwing. Een aankoop in 2020 + verkoop in 2024 = **4 jaar** → onder 5 jaar → meerwaarde belastbaar aan 16,5%. Verbouwingen verlengen de termijn niet — wel verhogen ze de aankoopkosten en verlagen ze dus de te belasten meerwaarde.
>
> 🤖 *AI-aanvulling*
...
**Vrijstelling**: verkoop aan een EER-vennootschap (Eu+IJsland/Liechtenstein/Noorwegen) — ook bij grote deelneming → **0% PB-heffing**.
...
|---|---|
| Tot ~ € 7 460 brutoinkomen via erkend platform | **20%** bevrijdend (door platform ingehouden) |
| Boven plafond | Reclassificatie als **beroepsinkomen** (progressieve tarieven) |

**Voorwaarden**:
1. Diensten geleverd via een **door FOD Financiën erkend platform**
2. Diensten verleend aan **particulieren** (niet aan ondernemingen)
3. Geen verkoop van goederen — enkel diensten
4. Geen sociale bijdragen verschuldigd (binnen plafond)

**Niet-erkende platformen**: opbrengsten worden niet als deeleconomie behandeld, maar volgens algemene regels (occasionele winst → 33%, of beroepsinkomen → progressieve tarieven).
...
| Bedrag | Behandeling |
|---|---|
| Tot een geïndexeerd plafond per jaar | Vrijgesteld |
| Daarboven | 16,5% afzonderlijk belast |

**Vrijstellingsplafond** (cijferzakboekje aj. 2026, indicatief): ~ € 4 470 per persoon per jaar.

**Beroepsmatige prijzen**: een prijs ontvangen in het kader van de uitoefening van een beroep (bv. Beste Architect-prijs) wordt belast als **beroepsinkomen** — niet als divers inkomen.
...
**Reden**: de onderverhuurder heeft geen eigendom van het OG → het is geen "onroerend inkomen" in fiscale zin maar een **inkomen uit een rechtshandeling**.
...
- Specifieke infrastructuur (kantoor, software, personeel)
- Tijdsbesteding aan de activiteit
- Externe communicatie (website, advertenties)
- Hoofdbron van inkomsten

**Gevolg van herkwalificatie**:
- Belastbaarheid aan **progressieve tarieven** (i.p.v. 33% afzonderlijk)
- **Sociale bijdragen** verschuldigd (zelfstandig stelsel)
- **Boekhoudplicht** + retroactieve toepassing
- Vaak **belastingverhoging** wegens oneerlijke aangifte

> [!warning]- Een "occasionele" activiteit van enkele jaren kan beroepsmatig worden gekwalificeerd
> ❌ *"Ik verkoop al 4 jaar elk weekend antiek op de markt — ik geef het aan als occasionele winst (33% afzonderlijk) want ik ben geen beroepshandelaar."*
>
> Frequentie en regelmaat zijn cruciale herkwalificatiecriteria. Wekelijkse marktverkoop gedurende 4 jaar voldoet aan de **regelmaatcriteria** voor beroepsinkomen — ongeacht of de belastingplichtige zich als zelfstandige heeft geregistreerd. Bij een controle volgt herkwalificatie naar beroepsinkomsten met progressieve tarieven, sociale bijdragen, boekhoudplicht én belastingverhoging. Strategische keuze: registreren als zelfstandige in bijberoep zodra de regelmaat duidelijk wordt.
>
> 🤖 *AI-aanvulling*
...
Kenniselementen:
- VIII.A — Aangifte diverse inkomsten
- VIII.B — Berekening belastbaar diverse inkomen

### Voorbeeldvragen

> [!question]- Verkoop bouwgrond na 4 jaar
>
> Een belastingplichtige koopt in 2021 een bouwgrond voor € 100 000. In 2025 verkoopt hij hem voor € 180 000. Hij gebruikt de grond niet zelf. Wat is de fiscale gevolg?
>
> > [!success]- Antwoord
> >
...
> [!question]- Aandelen verkopen na 8 jaar
>
> Een belegger heeft sinds 2017 een aandelenportefeuille die hij zelf beheert (lange-termijnbeleggen, geen geleende fondsen, geen day-trading). In 2025 verkoopt hij de portefeuille met een meerwaarde van € 200 000. Belastbaar?
>
> > [!success]- Antwoord
> >
...
> [!question]- Airbnb-verhuur eigen woning
>
> Een belastingplichtige verhuurt elke vakantieperiode zijn eigen huis via Airbnb (een erkend platform). In 2025 verdient hij € 8 500 bruto. Hoe belast?
>
> > [!success]- Antwoord
> >
...
> [!question]- Wekelijkse marktverkoop antiek
>
> Een belastingplichtige verkoopt al 3 jaar elk weekend antiek op rommelmarkten — geen registratie als zelfstandige, geen BTW. Jaarlijkse omzet ~ € 12 000. Hij geeft dit aan als occasionele winst (33%). Klopt dat?
>
> > [!success]- Antwoord
> >
