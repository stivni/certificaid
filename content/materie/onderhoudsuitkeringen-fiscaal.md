...
bouwversie: 2
bronnen:
  - WIB92 art. 90, 99, 104, 105, 145
  - BW art. 203 (kinderonderhoud), 213 (echtgenoten), 207 (ouders)
---
...
| Verplichting | BW-grond |
|---|---|
| Tussen **echtgenoten** (tijdens of na scheiding) | Art. 213, 301, 1280 |
| Tussen **ex-echtgenoten** | Art. 301 (na echtscheiding) |
| Van **ouders aan kinderen** | Art. 203 (alle vormen — geboorte, scheiding, adoptie) |
| Van **kinderen aan ouders** | Art. 205 (volwassen kind aan behoeftige ouders) |
| Tussen **bloed- en aanverwanten in rechte lijn** | Art. 207 (grootouders, schoonouders) |
| Tussen **broers en zussen** | Niet wettelijk verplicht — geen aftrek |

**Vorm**: in principe **periodieke** betaling (maandelijks, trimestrieel) — kapitalen onder uitzonderingsregime.
...
```
Brutoberoepsinkomen schuldenaar           : € 60 000
Beroepskosten                             : € 5 000
Onderhoudsuitkering betaald aan ex        : € 6 000  (€ 500/maand × 12)
   80% aftrekbaar                         : € 4 800
                                          ─────────
Netto belastbaar inkomen                  : € 50 200
```

Belastingvoordeel: € 4 800 × marginale aanslagvoet 50% = € 2 400 fiscale besparing voor een hoog inkomen.
...
| **5. Geen cumul met kind ten laste** | Onderhoudsuitkering aan kind ten laste van de schuldenaar (ook bij [[gezinsfiscaliteit#-fiscaal-co-ouderschap\|co-ouderschap]]) niet aftrekbaar |

**Begunstigde in het buitenland**: aftrek toegestaan mits bewijs van wettelijke verplichting **én** dubbelbelastingverdrag dat de Belgische heffingsbevoegdheid bepaalt. Onder DBV is de begunstigde meestal belast in zijn woonstaat — geen Belgische heffing op de uitkering.
...
> [!warning]- Vrijwillige bijdrage zonder wettelijke onderhoudsplicht is niet aftrekbaar
> ❌ *"Ik betaal € 200/maand aan mijn meerderjarige student-broer omdat hij studiekosten heeft. Dat is aftrekbaar."*
>
> Tussen broers en zussen bestaat **geen wettelijke onderhoudsplicht** in het BW. Een vrijwillige bijdrage — hoe redelijk ook — is fiscaal **niet aftrekbaar**. Aftrek beperkt zich tot uitkeringen die voortvloeien uit een onderhoudsplicht uit het BW (echtgenoten, ouders-kinderen, grootouders-kleinkinderen). Een notariële schenking valt onder het successierecht, niet onder de inkomstenbelasting.
>
> 🤖 *AI-aanvulling*
...
**Geen forfaitaire kostenaftrek**: in tegenstelling tot beroepsinkomsten geldt voor de begunstigde **geen** aftrek van forfaitaire of werkelijke kosten — het belastbare bedrag is integraal 80% van wat ontvangen werd.

**Voorbeeld** (vervolg op het schuldenaars-voorbeeld):

```
Onderhoudsuitkering ontvangen door ex     : € 6 000
   80% belastbaar                         : € 4 800
                                          ─────────
Belastbaar als divers inkomen — progressieve tarieven
```

Bij progressieve tarieven valt het bedrag in de belastingschijf van de begunstigde — meestal lager dan die van de schuldenaar.
...
- Kind heeft eigen belastingvrije som
- Eerste schijf onderhoudsuitkeringen telt niet mee voor de bestaansmiddelen-grens van het kind (cijferzakboekje aj. 2026: ~ € 4 200)

**Praktische uitwerking** (vereenvoudigd):

| Onderhoudsbijdrage per maand voor kind | Behandeling |
|---|---|
| Tot ~ € 350 | Doorgaans onder de bestaansmiddelen-grens; kind blijft ten laste van ontvangende ouder, geen eigen aangifte |
| ~ € 350 – € 700 | Op de grens; berekening vereist (cijferzakboekje + andere inkomsten kind) |
| Boven ~ € 700 | Vaak boven grens; kind moet eigen aangifte; ten laste-statuut bij ouder verloren |
...
**Vermijdingsstrategie**: bij echtscheiding wordt vaak gekozen voor periodieke onderhoudsuitkeringen + een aparte **kapitaalbetaling** uit het huwelijksvermogensstelsel (vereffening-verdeling) — die kapitaalbetaling is geen onderhoudsuitkering en valt buiten de fiscale aftrek/belastbaarheid.
...
| Scenario | Voor- en nadeel |
|---|---|
| **Fiscaal co-ouderschap** (toeslag 50/50) | Vaste toeslag bij beide ouders; voordelig voor lage inkomens; **geen** aftrek alimentatie mogelijk |
| **Volledig ten laste bij één ouder** + alimentatie betaald door andere | Aftrek alimentatie bij betaler (80% × marginale tarief); voordelig voor hoge inkomens |

**Beslissingsregel**: voor inkomens boven ~ € 30 000-40 000 marginale schijf 45-50% is de aftrek van alimentatie meestal voordeliger; voor lagere inkomens of bij gelijkaardige inkomens van de beide ouders kan co-ouderschap voordeliger zijn.

> [!info]- In de praktijk
>
> Gescheiden ouders met 1 kind van 12 jaar.
> - Vader: brutoberoepsinkomen € 80 000 (marginale schijf 50%)
> - Moeder: brutoberoepsinkomen € 25 000 (marginale schijf 25%)
> - Onderhoudsuitkering: € 600/maand = € 7 200/jaar
>
> **Optie A — fiscaal co-ouderschap, geen aftrek alimentatie**:
> - Beide ouders: toeslag ½ × ~ € 1 920 = € 960 → voordeel ~ € 240 elk
>
> **Optie B — kind volledig bij moeder ten laste, vader trekt alimentatie af**:
> - Vader: aftrek 80% × € 7 200 = € 5 760 × 50% marginale tarief = € 2 880 fiscale besparing
> - Moeder: belastbaar 80% × € 7 200 = € 5 760 × 25% marginale tarief = € 1 440 belasting + verlies € 240 van toeslag
> - Netto voordeel B − A: € 2 880 − € 1 440 + € 480 (twee keer toeslag in A vs. niet in B) ≈ € 1 200 netto voordeel
>
> → Optie B (klassieke aftrek) is hier voordeliger.
>
> 🤖 *AI-aanvulling*

---

## ⚖️ Cliëntdocumentatie

Voor bewijs bij belastingcontrole zijn volgende documenten essentieel:

1. **Vonnis of EOT-overeenkomst** met vermelding van het bedrag en de begunstigde
2. **Bewijs van werkelijke betaling** (bankafschriften, met vermelding "alimentatie [maand]")
...
Kenniselementen:
- IX.A — Aangifte ontvangen onderhoudsuitkeringen (bij begunstigde)
- IX.B — Belastbaar bedrag (80%-regel)
- XI — Aftrekbare uitgaven: onderhoudsuitkeringen (bij schuldenaar)

### Voorbeeldvragen

> [!question]- Aftrek aan ex-echtgenote
>
> Een gescheiden man betaalt aan zijn ex-echtgenote elke maand € 500 alimentatie + jaarlijks € 1 000 voor specifieke verbouwingen. Hoeveel kan hij aftrekken voor inkomstenjaar 2025?
>
> > [!success]- Antwoord
> >
...
> [!question]- Belastbaarheid bij minderjarig kind
>
> Een vader betaalt € 400/maand alimentatie voor zijn 13-jarige zoon (woont bij de moeder). De moeder geeft de uitkering aan in vak XII van haar aangifte. Klopt dat?
>
> > [!success]- Antwoord
> >
...
> [!question]- Co-ouderschap of alimentatie?
>
> Twee gescheiden ouders met 1 kind: vader (marginale schijf 50%, € 80 000), moeder (marginale schijf 25%, € 25 000), alimentatie € 600/maand. Wat is fiscaal voordeliger: fiscaal co-ouderschap of klassieke aftrek?
>
> > [!success]- Antwoord
> >
> > **Klassieke aftrek alimentatie is meestal voordeliger bij dergelijke inkomensverschillen.**
> >
> > Vader trekt 80% × € 7 200 = € 5 760 af aan zijn marginale 50% → fiscaal voordeel ~ € 2 880. Moeder belast 80% × € 7 200 = € 5 760 aan haar 25% → € 1 440 extra belasting. Netto familievoordeel: ~ € 1 440 + verlies van eenmalige toeslag (~ € 240) ≈ € 1 200 in het voordeel van klassieke aftrek. Bij gelijkere inkomens of beide in lage schijven kan co-ouderschap voordeliger zijn — altijd berekenen.
> >
> > *Zie: [[onderhoudsuitkeringen-fiscaal#-cumul-met-fiscaal-co-ouderschap-uitsluiting|Cumul met fiscaal co-ouderschap]]*
>
> 🤖 *AI-aanvulling*
