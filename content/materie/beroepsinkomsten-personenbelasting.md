...
bouwversie: 2
bronnen:
  - WIB92 art. 23-49, 51-53, 67-69, 78-80, 87-89, 130-150, 154-155, 171
  - KB/WIB92 art. 19, 25-30
---
...
Ontbreekt een van beide, dan valt het inkomen niet onder beroepsinkomsten maar onder roerende of diverse inkomsten.

---

## 📌 Vijf categorieën van beroepsinkomsten
...
| Soort | Voorbeeld |
|---|---|
| **Vast loon** | Maandloon, weekloon |
| **Variabele bezoldigingen** | Commissies, premies, bonussen |
| **Vakantiegeld en eindejaarspremie** | Wettelijk vakantiegeld, dertiende maand |
| **Voordelen alle aard (VAA)** | Firmawagen, gratis woning, kosteloze elektriciteit |
| **Werkgeversbijdrage groepsverzekering** | Belastbaar als VAA, maar latere uitkering als pensioen voordeliger belast |
| **Achterstallen** | Achterbetaalde lonen — afzonderlijk belast aan gemiddelde aanslagvoet |
| **Opzegvergoedingen** | Belastbaar als bezoldiging, met specifieke berekeningsregels |
...
**Inhoud van de categorie** (uitbreidingen van de regel): toegekende [[#-voordelen-alle-aard-vaa|voordelen alle aard]], herkwalificatie van [[inkomsten-onroerende-goederen#-herkwalificatie-van-huurinkomsten-van-bedrijfsleider|huur boven drempel]], rekening-courantintresten boven marktrente, …

**Bron**: loonfiche **281.20** door de vennootschap.

**Toerekeningsregel**: kasprincipe (zoals werknemers).
...
**Toerekeningsregel**: vorderingsprincipe — inkomsten worden belast in het jaar dat de vordering ontstaat (factuurdatum, prestatiedatum), ongeacht datum van werkelijke ontvangst. Dit volgt de boekhoudkundige toerekening.

**Boekhoudplicht**: zelfstandigen vallen onder de [[boekhoudplicht-wer|boekhoudplicht WER]]. Hun winst is in beginsel het saldo van de jaarrekening — fiscaal gecorrigeerd via verworpen uitgaven en specifieke fiscale regels.
...
## 🔢 Berekening belastbaar beroepsinkomen

```
Brutoberoepsinkomen (bezoldiging, winsten, baten, vervangingsinkomsten)
−  Persoonlijke sociale bijdragen (RSZ werknemer of sociale bijdragen zelfstandigen)
−  Beroepskosten (werkelijk OF forfaitair — keuze per kostencategorie)
=  Netto beroepsinkomen
−  Beroepsverliezen vorige jaren (overgedragen)
=  Belastbaar beroepsinkomen
```

**Toepassing**: dit basisscheme geldt voor elke categorie van beroepsinkomsten. Per categorie zijn er specifieke kostencomponenten.
...
**Forfaitaire schalen voor werknemers** (cijferzakboekje — bv. aj. 2026):

| Schijf brutoberoepsinkomen | Forfaitair % |
|---|---|
| Eerste schijf (~ € 0 – € 17 670) | 30% |
| Hogere schijven | Lager (degressief) |
| Maximum forfait per persoon | ~ € 5 580 |

**Voor bedrijfsleiders**: forfait beperkt tot 3% met maximum van ~ € 2 950 (cijferzakboekje aj. 2026) — fors lager dan voor werknemers, omdat bedrijfsleiders meer mogelijkheden hebben om kosten via de vennootschap te boeken.

**Voor zelfstandigen (winsten/baten)**: **geen forfait** — enkel werkelijke kosten worden aanvaard, met bewijsstukken.

> [!warning]- Forfaitaire aftrek is een keuze per persoon, niet per kostensoort
> ❌ *"Een werknemer kan voor zijn woon-werkverplaatsing forfait gebruiken en voor zijn vakliteratuur werkelijke kosten."*
>
> De keuze tussen forfaitaire en werkelijke kosten is een **globale keuze** voor het volledige beroepsinkomen — niet kost-per-kost. Wie werkelijke kosten kiest, moet **alle** beroepskosten bewijzen (woon-werkverkeer, kleding, vakliteratuur, computer, …). Wie forfait kiest, krijgt het forfaitair bedrag voor alle kosten samen — geen aanvulling met werkelijke kosten mogelijk. Strategie: bereken beide scenario's en kies de meest voordelige.
>
> 🤖 *AI-aanvulling*
...
| **Boetes en geldstraffen** | 0% — niet aftrekbaar |
| **Persoonlijke kleding** | 0% (uitzondering: specifieke beroepskleding) |
| **Beroepsmatig deel privégoederen** | Pro rata — bewijs van beroepsgebruik |
| **Werkkledij, gereedschap, vakliteratuur** | 100% indien beroepsmatig |

**Voor bedrijfsleiders**: deze beperkingen gelden **op het niveau van de vennootschap** — niet bij de bedrijfsleider zelf. De bedrijfsleider draagt enkel zijn eigen beroepskosten als hij die persoonlijk maakt.
...
> [!info]- In de praktijk
>
> Een bedrijfsleider krijgt een Tesla Model Y (cataloguswaarde € 52 000, CO₂ = 0 g/km, eerste inschrijving juli 2024) ter beschikking voor onbeperkt gebruik (privé + beroep).
>
> - VAA-formule (vereenvoudigd): € 52 000 × 4% (basistarief 2026 voor elektrische wagens) × 6/7 × leeftijdscoëfficiënt → ~ € 1 720/jaar
...
```
Jaar X-2: zelfstandige verlies               € −15 000
Jaar X-1: zelfstandige verlies               € −10 000
Jaar X  : zelfstandige winst                 € +30 000
                                             ─────────
Resterend te belasten in jaar X = € 30 000 − € 15 000 (X-2) − € 10 000 (X-1) = € 5 000
```
...
| Activatype | Tarief |
|---|---|
| **Materiële vaste activa, gronden, gebouwen** (activiteit > 5 jaar) | 16,5% afzonderlijk |
| **Cliënteel, immateriële activa** (activiteit > 5 jaar) | 33% afzonderlijk |
...
Kenniselementen:
- VI.A — Aangifte beroepsinkomsten van deel 1 en deel 2 van de aangifte
- VI.B — Berekenen van het belastbaar beroepsinkomen
- X — Belastbaar inkomen van deel II van de aangifte (bezoldigingen bedrijfsleiders, winsten, baten)

### Voorbeeldvragen

> [!question]- Forfait of werkelijke kosten
>
> Een werknemer wil voor zijn woon-werkverplaatsing 50 km/dag de forfaitaire kostenaftrek gebruiken, en bovendien zijn vakliteratuur (€ 600) en zijn computer (€ 1 200) in werkelijke kosten aftrekken. Mag dat?
>
> > [!success]- Antwoord
> >
> > **Nee.**
> >
> > De keuze tussen **forfaitaire** en **werkelijke** beroepskosten is een **globale keuze** — niet kost-per-kost. Wie forfait kiest, krijgt het forfaitair bedrag (~ € 5 580 max voor aj. 2026) en kan **niets bijkomends** aftrekken. Wie werkelijke kosten kiest, moet **alle** kosten bewijzen, inclusief de woon-werkverplaatsing (€ 0,15/km of werkelijke autokosten met aftrekbeperking). Strategie: bereken beide scenario's en kies de meest voordelige.
> >
> > *Zie: [[beroepsinkomsten-personenbelasting#-werkelijke-vs-forfaitaire-beroepskosten|Werkelijke vs. forfaitaire beroepskosten]]*
>
> 🤖 *AI-aanvulling*

> [!question]- Aftrekbaarheid restaurantkosten
>
> Een zelfstandige consultant heeft restaurantkosten van € 4 800 voor klantontmoetingen. Hoeveel mag hij aftrekken?
>
> > [!success]- Antwoord
> >
> > **€ 3 312 (= 69% van € 4 800).**
...
> [!question]- Beroepsverlies overdracht
>
> Een zelfstandige boekt sinds 2020 elk jaar een verlies. In 2025 maakt hij voor het eerst winst. Mag hij alle vorige verliezen verrekenen?
>
> > [!success]- Antwoord
> >
...
> [!question]- Bezoldiging zonder bestuursmandaat
>
> Een werknemer zonder bestuursmandaat is tegelijk vennoot voor 60% van een bv. Hij werkt zonder arbeidsovereenkomst en oefent een leidinggevende functie uit. Onder welke categorie valt zijn bezoldiging?
>
> > [!success]- Antwoord
> >
...
> >
> > *Zie: [[beroepsinkomsten-personenbelasting#-bezoldigingen-bedrijfsleiders|Bezoldigingen bedrijfsleiders]]*
>
> 🤖 *AI-aanvulling*

> [!question]- VAA firmawagen elektrisch
>
> Een werknemer krijgt een volledig elektrische bedrijfswagen (€ 50 000, CO₂ = 0 g/km) ter beschikking voor onbeperkt gebruik. Wordt dit als beroepsinkomen belast?
>
> > [!success]- Antwoord
> >
