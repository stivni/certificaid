...
Een afschrijving spreidt de kost van een actief met beperkte gebruiksduur over zijn economische levensduur. Het principe is eenvoudig: een machine die 5 jaar meegaat en € 50.000 kost, vertegenwoordigt elk jaar een kost van € 10.000 — niet eenmalig € 50.000 op het moment van aankoop. Die periodieke kost wordt via een afschrijving ten laste van de resultatenrekening genomen.

---

## 📌 Afschrijving

Een bedrag **ten laste van de resultatenrekening** genomen met betrekking tot oprichtingskosten en tot immateriële en materiële vaste activa met een **beperkte gebruiksduur**, om hun aanschaffingswaarde te spreiden over hun waarschijnlijke nuttigheids- of gebruiksduur (ITAA-LEX XV (KB) · KB WVV 2019 art. 3:23).
...
De gecumuleerde afschrijvingen worden **afgetrokken** van de actiefpost waarop ze betrekking hebben (ITAA-LEX XV (KB) · KB WVV 2019 art. 3:23).

---

## ↔️ Afschrijving vs. waardevermindering

| | **Afschrijving** | **[[waardeverminderingen|Waardevermindering]]** |
|-|-----------------|------------------|
| Reden | Geplande spreiding over gebruiksduur | Incidentele ontwaarding op balansdatum |
| Van toepassing op | Vaste activa met beperkte gebruiksduur | Alle actiefbestanddelen |
| Karakter | Systematisch, jaarlijks | Incidenteel, indien nodig |
| Terugneming | Niet van toepassing | Verplicht als de ontwaarding verdwijnt |

---

## ⚖️ Eisen waaraan afschrijvingen moeten voldoen

**Voorzichtigheid, oprechtheid en goede trouw** (ITAA-LEX XV (KB) · KB WVV 2019 art. 3:24) — afschrijvingen weerspiegelen een eerlijke schatting van de waardedaling, zonder doelgericht te worden ingezet om het resultaat te sturen.

**Specificiteit** — afschrijvingen zijn specifiek voor het actief waarop ze betrekking hebben. Voor activa met volkomen identieke technische of juridische kenmerken mogen globale afschrijvingen worden geacteerd (ITAA-LEX XV (KB) · KB WVV 2019 art. 3:25).

**Stelselmatigheid** — afschrijvingen worden gevormd **stelselmatig** volgens de door de onderneming vastgelegde methoden. Ze mogen **niet afhangen van het resultaat** van het boekjaar (ITAA-LEX XV (KB) · KB WVV 2019 art. 3:26).

> [!info]- In de praktijk
>
> Een onderneming heeft een verlieslatend jaar. Ze mag daarvoor de afschrijvingen **niet** verlagen om een beter resultaat te tonen. Afschrijvingen worden bepaald door het afschrijvingsplan, niet door de winst-en-verliesrekening.
>
> 🤖 *AI-aanvulling*
...
**Degressieve methode**: hogere afschrijving in de eerste jaren, dalend daarna. Fiscaal is de degressieve methode beperkt toegestaan maar boekhoudkundig geldt: zodra de lineaire afschrijving voor dat jaar hoger zou zijn dan de degressieve, schakelt de onderneming over op de lineaire methode.

De terugneming van [[waardeverminderingen|waardeverminderingen]] wanneer een ontwaarding verdwijnt, staat in de [[waardeverminderingen|fiche over waardeverminderingen]] — dat is een ander begrip en een andere wettelijke grondslag.
...
> [!warning]- Grond wordt niet afgeschreven, alleen het gebouw erop
