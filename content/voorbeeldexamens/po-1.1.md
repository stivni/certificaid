---
title: PO 1.1 — Algemene boekhouding
...
**28 unieke vraag-eenheden** uit 7 examens (2003-bibf, 2008-bibf, 2013-1, 2013-2, 2014-1, 2015-1, 2024-1) — 28 met modelantwoord

<a id="2024-1-vr7A"></a>

> [!question]- Voorraadwaarderingsmethoden toegelaten onder IAS/IFRS
> *Examen 2024-1 (uit herinnering gereconstrueerd) · PO 1.1*
>
> Onder IAS/IFRS zijn de volgende voorraadwaarderingsmethoden mogelijk.
> 
...
> > 
> > - **Specifieke identificatie** voor items die niet onderling uitwisselbaar zijn (bv. uniek vastgoed, kunstwerken). 📖
> > - **FIFO** voor onderling uitwisselbare items. 📖
> > - **Gewogen gemiddelde kostprijs** als alternatief voor FIFO. 📖
> > 
> > **Per optie**:
> > - **a** (FIFO, LIFO, gewogen gemiddelde, individueel) → FOUT — bevat LIFO. 🔗
> > - **b** (FIFO, gewogen gemiddelde, individueel) → JUIST — exact de drie IAS 2-methoden. 🔗
> > - **c** (LIFO, gewogen gemiddelde, individueel) → FOUT — bevat LIFO, mist FIFO. 🔗
> > - **d** (FIFO + gewogen gemiddelde) → INCOMPLEET — sluit LIFO terecht uit, maar mist specifieke identificatie die IAS 2 voor niet-uitwisselbare items zelfs verplicht stelt. 🔗
> > 
...
> [!question]- Voorzichtigheidsprincipe — opname en waardering (Richtlijn 2013/34/EU)
> *Examen 2024-1 (uit herinnering gereconstrueerd) · PO 1.1*
>
> Richtlijn 2013/34/EU van 26/06/2013, opname en waardering volgens het voorzichtigheidsprincipe.
> 
> **Welke stellingen zijn juist of fout?**
>
> <span class="jf-badge">Juist of fout?</span><span class="jf-stelling">Winsten mogen slechts opgenomen worden voor zover zij op balansdatum gerealiseerd zijn.</span>
> 
...
> [!question]- IAS/IFRS — stellingen over afschrijvingen, kosten en uitzonderlijke posten
> *Examen 2024-1 (uit herinnering gereconstrueerd) · PO 1.1*
>
> Stellingen met betrekking tot IAS/IFRS.
> 
> **Juist of fout?**
>
> <span class="jf-badge">Juist of fout?</span><span class="jf-stelling">Degressieve afschrijvingen zijn toegestaan onder IAS/IFRS.</span>
> 
> > [!success]- Antwoord (klik om te openen)
> >
> > **Antwoord: Fout**
...
> [!question]- Operationele en financiële leasing — boekhoudkundige verwerking onder IAS/IFRS
> *Examen 2024-1 (uit herinnering gereconstrueerd) · PO 1.1*
>
> **Operationele / financiële leasing — hoe behandelen?**
> 
> > [!success]- Antwoord (klik om te openen)
> >
...
> > 
> > | Aspect | Lessee (single model) | Lessor — financiële lease | Lessor — operationele lease |
> > |---|---|---|---|
> > | **Aanvangsdatum** | Opname ROU-actief + leaseverplichting (alinea 22) 📖 | Derecognitie onderliggend actief; opname **netto-investering in lease** (leasevordering) 🔗 | Onderliggend actief blijft op balans; geen vordering 📖 |
> > | **Initiële waardering** | ROU = leaseverplichting + reeds betaalde canons (− incentives) + initiële directe kosten + ontmantelingskost (alinea 24). Leaseverplichting = contante waarde leasebetalingen tegen de impliciete rente of, indien niet bepaalbaar, de marginale rentevoet van de lessee. 📖 | Netto-investering = bruto-investering (canons + niet-gegarandeerde restwaarde) gedisconteerd tegen impliciete rente 🔗 | n.v.t. — actief blijft gewaardeerd volgens toepasselijke standaard (IAS 16, IAS 40, …) 🔗 |
> > | **Resultatenrekening** | **Twee componenten**: (1) **afschrijving** ROU (doorgaans lineair over kortere van leaseperiode/economische levensduur) — bedrijfskost; (2) **intrest** op de leaseverplichting (effectieve-rente-methode) — financiële kost. EBITDA stijgt t.o.v. IAS 17-operationele lease. 🔗 | Financiële opbrengst op netto-investering (effectieve-rente-methode) 🔗 | **Leaseopbrengst lineair** of op andere systematische basis over de leaseperiode 📖 |
> > | **Vrijstellingen lessee** | Optioneel: **korte-termijn-leases (≤ 12 maanden, geen koopoptie)** en **leases van activa met lage waarde** (richtbedrag ~5.000 USD nieuwwaarde) → lineair als kost boeken, geen ROU/verplichting 📖 | — | — |
> > | **Klassieke koopoptie redelijk zeker uitgeoefend** | Leaseperiode includeert de termijn tot en met de optie; ROU afschrijven over economische levensduur 🔗 | Onderdeel van kwalificatie als financiële lease (alinea 63) 🔗 | n.v.t. | 🔗
> > 
> > **Waarom dit single-lessee-model?** IFRS 16 is een reactie op het off-balance-misbruik onder IAS 17, waar economisch identieke contracten via minieme structuurverschillen buiten de balans werden gehouden. Door élke lease als een financieringsverrichting te behandelen (gebruiksrecht financieren met schuld), wordt de economische werkelijkheid hersteld en worden ratio's (schuldgraad, ROA) vergelijkbaar over ondernemingen heen. 🔗
> > 
> > **Kwalificatie financieel/operationeel — lessor-zijde**. De lessor toetst of in wezen **alle risico's en voordelen verbonden aan het eigendom** worden overgedragen (alinea 63 IFRS 16). Indicatoren (niet-cumulatief, op zich of in combinatie): eigendomsoverdracht aan einde leaseperiode · koopoptie tegen prijs aanzienlijk onder reële waarde (redelijk zeker uitgeoefend) · leaseperiode beslaat groot deel van de economische levensduur · contante waarde minimumcanons benadert reële waarde · gespecialiseerd actief alleen door lessee bruikbaar. 🔗
> > 
...
> > 
> > **Stap 2 — FIFO-aanschaffingswaarde:** 900 × 350 + 500 × 300 = 315.000 + 150.000 = **465.000 EUR** (gemiddeld 332,14 EUR/stuk). 🔗
> > 
> > **Stap 3 — laagstewaarderegel (art. 3:46 KB WVV):** marktwaarde op balansdatum = 280 EUR/stuk < gemiddelde aanschaffingswaarde 332,14 EUR/stuk → voorraad waarderen aan **lagere marktwaarde**. 📖
> > 
> > **Stap 4:** 1.400 × 280 = **392.000 EUR**. Boekhoudkundig: aanschaffingswaarde 465.000 op rekening 340, met geboekte waardevermindering 73.000 op rekening 349 → nettoboekwaarde 392.000. 🔗
> > 
> > **Per optie:**
> > - (a) 465.000 EUR → FOUT: dit is de FIFO-aanschaffingswaarde zonder toepassing van de laagstewaarderegel. ❌
> > - (b) 470.000 EUR → FOUT: geen consistente FIFO-rekening levert dit op.
> > - **(c) 392.000 EUR → JUIST**: 1.400 × 280 (markt < kost). ✓
> > - (d) 420.000 EUR → FOUT: zou 1.400 × 300 zijn (jongste-aankoop-kost, geen wettelijke methode).
> > - (e) 452.000 EUR → FOUT: lijkt op 1.500 × 280 + 32.000 of een gemixte berekening; in elk geval niet de juiste FIFO-stuks of correcte markt-toepassing. 🔗
> > 
...
> > 
> > **Markttoets op de nieuwe balansdatum:** marktwaarde 455 EUR/stuk × 1.400 = 637.000 EUR. Dit ligt **boven** de gemiddelde FIFO-aanschaffingswaarde (332,14 EUR/stuk) én boven beide laag-kostprijzen (350 en 300 EUR). 🔗
> > 
> > **Toepassing laagstewaarderegel:** waardering = min(aanschaffingswaarde; marktwaarde) = min(465.000; 637.000) = **465.000 EUR**. 📖
> > 
> > **Boeking:** de waardevermindering van 73.000 EUR die op 31/12/2013 op rekening 349 werd geboekt, wordt **teruggenomen** (art. 3:46, tweede lid KB WVV: "een waardering tegen lagere marktwaarde mag niet meer behouden blijven indien later de marktwaarde hoger komt te liggen dan de voor de waardering gehanteerde lagere marktwaarde"). 📖
> > 
> > **Per optie:**
> > - **(a) 465.000 EUR → JUIST**: FIFO-aanschaffingswaarde als plafond. ✓
> > - (b) 470.000 EUR → FOUT.
> > - (c) 392.000 EUR → FOUT: dit is de oude lagere marktwaarde van 31/12/2013 (280 EUR), die niet meer geldt nu de markt is hersteld. ❌
> > - (d) 420.000 EUR → FOUT.
> > - (e) 637.000 EUR → FOUT: dit is de actuele marktwaarde (1.400 × 455); de wet **verbiedt** opwaarderen boven aanschaffingswaarde — geen herwaardering voor voorraden. ❌
> > 
...
> > **Per optie**:
> > 
> > - **a (kosten on-the-fly, geen voorziening)** → **FOUT**. Zodra de werkgever een werknemer ontslagen heeft in het kader van SWT ontstaat een **zekere verplichting** waarvan enkel het exacte bedrag schattingsgebonden is (afhankelijk van overleving tot pensioenleeftijd). Het matching-beginsel en art. 3:11 KB/WVV (oud art. 33 KB/W.Venn.) verplichten dan een voorziening; gewoon de kosten lopend boeken miskent de prudentie- en matching-regels. 🔗
> > - **b** → **JUIST** (zie conclusie).
> > - **c (voorziening op 01/03/2014)** → **FOUT op timing**. De voorziening moet gevormd worden op het ogenblik dat de **verbintenis ontstaat**, d.w.z. bij de **betekening van de opzegging** (05/12/2013), niet pas op de dag dat de werknemer effectief stopt met werken. CBN 107/3bis is hier expliciet. Bovendien zwijgt c over wat er met de voorziening gebeurt nadien. 📖
> > - **d (voorziening op 05/12/2013, kosten in mindering brengen van de voorziening)** → **FOUT op verwerking**. De maandelijkse bedrijfstoeslag wordt **wel** als personeelskost geboekt in de resultatenrekening (rekening 62) — zij wordt niet rechtstreeks in mindering gebracht van de voorziening. Het is de **terugneming van de voorziening** (rekening 6350/6360 → 7350/7360) die het resultaat compenseert, parallel met de werkelijke uitbetalingen. 🔗
> > - **e (voorziening op 01/03/2014, terugname bij pensioenleeftijd)** → **FOUT op twee punten**. Foute timing (zie c) én foute terugneming: de voorziening wordt **jaarlijks pro rata** teruggenomen naarmate de bedrijfstoeslagen werkelijk worden uitbetaald, niet pas in één keer bij het bereiken van de pensioenleeftijd (dat zou het matching-beginsel net schenden). 🔗
> > 
...
> > 
> > 1. **Vordering afzonderen naar dubieuze debiteuren** — zodra de inning twijfelachtig wordt, moet de vordering uit 290000 *Handelsdebiteuren op meer dan één jaar* worden overgeboekt naar een dubieuze-rekening (bv. 2907). 📖
> > 2. **Nog niet uitgedrukte rente erkennen** — de contractueel verschuldigde rente (8% zesmaandelijks, lopende tot 30/06/2015) die nog niet via overlopende rekeningen werd geboekt, moet pro rata erkend worden zodat de volledige vordering (kapitaal + verworven rente) in de balans tot uiting komt. 🔗
> > 3. **Waardevermindering op het volledige bedrag** — art. 3:46 KB WVV verplicht een waardevermindering zodra er onzekerheid bestaat over de betaling op de vervaldag; die waardevermindering geldt voor de **vordering én de rente** (beide zijn een vorderingsbestanddeel waarop inning onzeker is). 📖
> > 
> > **Per optie:**
> > - **a** → FOUT: negeert de rente-erkenning, dekt slechts deel van de boekhoudkundige verwerking.
> > - **b** → FOUT: rente wordt erkend maar de waardevermindering wordt alleen op de hoofdsom geboekt, niet op de rente — onvolledig.
> > - **c** → JUIST: rente uitdrukken + waardevermindering op vordering én rente.
> > - **d** → FOUT: overboeking naar *vorderingen op ten hoogste één jaar* is hier prematuur. Op balansdatum 31/12/2013 is de resterende looptijd nog ca. 18 maanden (vervaldag 30/06/2015), dus de vordering blijft op meer dan één jaar; pas op 31/12/2014 zou overboeking aan de orde zijn. 🔗
> > - **e** → Inhoudelijk gelijk aan c maar voegt 'jaarrekening-vermelding inning onzeker' toe; dat is geen boekhoudkundige handeling sensu stricto en niet als zodanig vereist (de waardevermindering en de afzondering als dubieuze debiteur tonen de onzekerheid al). 🤖
> > 
...
> > Analyse per optie:
> > 
> > - **a (enkel rubriek 65)** — **FOUT**. Het KB WVV verplicht niet om interesten als financiële kost te boeken; het laat activering uitdrukkelijk toe. 🔗
> > - **b (moeten op het actief)** — **FOUT**. Activering is een **mogelijkheid** ("mag worden opgenomen"), geen verplichting. 📖
> > - **c (onvoorwaardelijk op het actief)** — **FOUT**. Twee voorwaarden gelden cumulatief: (1) het moet gaan om rente op vreemd vermogen dat de **financiering** van het vast actief betreft, en (2) de rente moet betrekking hebben op de **periode vóór bedrijfsklaarheid** van het actief. 📖
> > - **d (mag, onder voorwaarden)** — **JUIST**. Dekt zowel de keuze-aard (mag) als de voorwaarden (financierings­verband + pre-bedrijfsklaarheid). 🔗
> > 
> > De boekhouder heeft het bedrag terecht op wachtrekening 499 geparkeerd: het bestuursorgaan beslist eerst of de voorwaarden vervuld zijn (was het investerings­krediet aangewend voor de financiering van een welbepaald actief? betreft de 125.000 EUR rente vóór ingebruikname?). Pas daarna wordt het bedrag overgeboekt naar de aanschaffings­waarde van het betrokken actief (rubriek 22/23) of, indien niet voldaan, naar rekening 650 *Kosten van schulden*. 🔗
> > 
...
> > **Per optie**:
> > 
> > - **a — FOUT**: rechtstreeks elke ontvangen schijf op 753 boeken miskent het matching-beginsel; 753 is een resultaatrekening waarop de kapitaalsubsidie alleen *pro rata* het afschrijvingsritme via overboeking vanuit rekening 15 mag terechtkomen. 🔗
> > - **b — FOUT**: boeking op 15 + 1680 is correct, maar de subsidie **behouden** op de balans zolang de investering niet gerealiseerd is, schendt de regel dat de inresultaatname start zodra de afschrijvingen van het gesubsidieerde actief lopen — niet pas na voltooiing. 🔗
> > - **c — FOUT**: ineens op 753 bij toekenning is dubbel mis: zowel verkeerde rekening (rechtstreeks resultaat) als verkeerd ritme (ineens i.p.v. gespreid). 🔗
> > - **d — JUIST**: triggermoment = ontvangst van het toekenningsbericht (recht staat vast, art. 95 §2.VI KB W.Venn. / KB 2018), boeking op 15 met splitsing 1680, inresultaatname gelijkmatig met de afschrijvingen via 753 *Kapitaal- en interestsubsidies*. 📖
> > - **e — FOUT**: het triggermoment is **niet** de creditering op de bankrekening maar het ogenblik dat het recht vaststaat (toekenningsbericht). Vóór ontvangst loopt de tegenboeking via rekening 416 *Te innen opbrengsten* (of 291). 🔗
> > 
...
> > 
> > **Per optie**:
> > - **a / b / e** (crediteren van 61-62): FOUT — de oorspronkelijke kostenrekeningen crediteren maakt de in resultaatneming **onzichtbaar** in de resultatenrekening. Dat is precies wat art. 3:36 KB-WVV verbiedt: de activering moet zichtbaar gebeuren via een afzonderlijke min-rekening, niet door de bedrijfskostenrekeningen zelf neer te halen. 🔗
> > - **d** ("kan" crediteren van 649/669): FOUT in de modaliteit — als de onderneming kiest voor activering, is de techniek (crediteren van 649/669) **dwingend**, geen optie. De keuze betreft of geactiveerd wordt, niet hoe. 🔗
> > - **c** ("moet" crediteren van 649/669): JUIST — combineert de verplichte techniek met de juiste rekeningen. 📖
> > 
...
> > - **B — credit rekening 19** ❌ — rekening 19 is een **actief-corrigerende rekening (-)**: een voorschot doet de eigenvermogenscomponent dalen en wordt dus aan de **debetzijde** opgenomen. 🔗
> > - **C — debet 416 Diverse vorderingen** ❌ — een uitkering aan de vennoten is **geen vordering** op hen (geen terugbetalingsverplichting); rekening 416 is voorbehouden voor andere casussen (bv. inbreng-in-natura met betalingswaarborg, CBN 2019/01). 🔗
> > - **D — credit rekening 101 (Niet-opgevraagd kapitaal)** ❌ — 101 dient enkel voor nog-niet-volgestort kapitaal, niet voor uitkeringen. 🤖
> > - **E — debet rekening 19** ✅ — exact wat CBN 2010/22 en CBN 2019/01 voorschrijven. 📖
> > - **F — debet rekening 48 'zaakvoerder'** ❌ — vennoten zijn geen zaakvoerders; bovendien is een liquidatie-uitkering geen schuld aan een bestuurder. 🤖
> > 
...
> > - **b** FOUT — laat de uitkering ongerealiseerd door beschikbare reserves op 1.800.000 te houden; de bijzondere AV van 20/12/2013 heeft de uitkering bruto 1.000.000 reeds beslist en betaalbaar gesteld op 27/12/2013, dus de reserves moeten dalen naar 800.000. 🔗
> > - **c** FOUT — boekt het volledige bedrag (900.000) als 'Dividenden over het boekjaar' (rek. 471) zonder rekening te houden met CBN-2013/17: voor het gedeelte waarvoor een bewijskrachtig element aanwezig is dat de aandeelhouder zal deelnemen aan de kapitaalverhoging, wordt 471 gedebiteerd en 489X 'Ontvangen voorschotten op kapitaal' gecrediteerd. 📖
> > - **d** JUIST — reflecteert de CBN-2013/17-verwerking: het tot kapitaal bestemde gedeelte (900.000) staat onder 489X 'Ontvangen voorschotten op kapitaal' i.p.v. onder dividenden, vermits de formele kapitaalverhoging pas in januari 2014 plaatsvindt. 🔗
> > 
> > **Eigen vermogen 31/12/2013 (zonder resultaat boekjaar)**:
> > 
> > | Rubriek | Bedrag (EUR) |
> > |---|---:|
> > | Geplaatst kapitaal | 100.000 |
> > | Wettelijke reserve | 10.000 |
> > | Beschikbare reserves (1.800.000 − 1.000.000) | 800.000 |
> > | Overgedragen winst | 1.000 |
> > 
> > **Resultaatverwerking**: 'Vergoeding van het kapitaal' (rek. 694) 1.000.000 EUR.
> > 
> > **Op het passief (schulden)**: 489X 'Ontvangen voorschotten op kapitaal' 900.000 EUR (gedeelte bestemd voor kapitaalverhoging — bewijskrachtig element vóór balansdatum) + 100.000 EUR effectief uit te keren dividend (waarop 10% RV ingehouden conform overgangsregime art. 537 WIB92). 🔗
> > 
...
> > - **b (JUIST)** — Beide rechtstreekse overboekingen tussen eigen-vermogensposten: conform het CBN-beginsel dat interne mutaties die het totaal eigen vermogen niet beïnvloeden rechtstreeks van post naar post moeten worden geboekt. 📖
> > - **c (FOUT)** — Reserves via resultaatverwerking, uitgiftepremie rechtstreeks: inconsistent — voor beide geldt dezelfde regel (rechtstreeks). 🔗
> > - **d (FOUT)** — Reserves rechtstreeks naar kapitaal, maar uitgiftepremie blijft als afzonderlijke rekening: incompatibel met de casus, want de vraag stelt expliciet dat de uitgiftepremie *werd geïncorporeerd* in kapitaal. 🔗
> > 
> > **Kernregel CBN 121/3**: "interne mutaties binnen het eigen vermogen die het totaal eigen vermogen niet beïnvloeden, [moeten] over het algemeen rechtstreeks van de ene betrokken post naar de andere worden overgeboekt. Dat beginsel is niet alleen van toepassing op de toevoeging van reserves aan het kapitaal […], het geldt ook bij toevoeging van uitgiftepremies of meerwaarden aan het kapitaal." 📖
> > 
...
> > 
> > **Per optie**:
> > - **a** → JUIST: behoud op passief is uitdrukkelijk toegelaten door art. 42 KB 12-9-1983 (nu doorvertaald via art. 3:35 KB WVV-overgang). 📖
> > - **b** → FOUT: er bestaat geen verplichting om de pre-1984-meerwaarde af te boeken. 📖
> > - **c** → FOUT: incorporatie in kapitaal is een **mogelijke** bestemming, geen verplichting. 🔗
> > - **d** → FOUT: spreiding over 5 jaar in resultaat is geen bestemming voor herwaarderingsmeerwaarden — dat regime geldt voor gespreide taxatie van gerealiseerde meerwaarden in VenB (art. 47 WIB), niet voor de boekhoudkundige behandeling van de niet-gerealiseerde herwaarderingsreserve. 🔗
> > 
...
> > - §3: NV's, SE's en SCE's mogen de in art. 3:35 bedoelde geboekte meerwaarde **in kapitaal omzetten** (verminderd met de geraamde belasting). 📖
> > - bij **latere minderwaarden / verdwijning** van de meerwaarde: de nog niet afgeschreven, overtollige meerwaarde wordt uitgeboekt door tegengestelde boeking (rek. 120/121 D / activum C). 📖
> > 
> > **Per optie — fouten lokaliseren**:
> > - **a** → FOUT: spreekt over overboeking naar reserves *tot beloop van het nog niet afgeschreven bedrag* (omgekeerd: dat geldt voor uitboeking bij minderwaarde, niet voor overboeking naar reserves). 🔗
> > - **b** → JUIST: alle drie de bestemmingen exact correct geformuleerd. 📖
...
> > 
> > De casus stelt dat het octrooi **volledig is afgeschreven**. De op de geherwaardeerde waarde geboekte afschrijvingen bedragen dus 100% van de meerwaarde:
> > 
> > | Element | Bedrag |
> > |---|---|
> > | Herwaarderingsmeerwaarde (1980) | 25.000 EUR |
> > | Afschrijvingen op die meerwaarde | 25.000 EUR (volledig) |
> > | **Overboekbaar naar reserves** | **25.000 EUR** |
> > 
> > **Per optie**:
> > - **a** (25.000) → JUIST: gelijk aan de afgeschreven meerwaarde. 🔗
> > - **b** (75.000) → FOUT: dit is de oorspronkelijke aanschaffingswaarde van het octrooi, niet de meerwaarde. 🤖
...
> > 
> > Een octrooi behoort tot rubriek 21 *Immateriële vaste activa* (MAR-subrubriek 211 *concessies, octrooien, licenties, know-how, merken en soortgelijke rechten*). 🔗 Een nieuwe herwaardering van 100.000 EUR op 15-12-2013 op dit octrooi is dus **niet toegelaten**.
> > 
> > **Per optie**:
> > - **a** (boeking op credit 120) → FOUT: zou de gewone boeking zijn voor materiële/financiële activa, maar verboden voor immateriële. 🔗
> > - **b** (in resultaat) → FOUT: herwaarderingsmeerwaarden beïnvloeden de resultatenrekening niet bij boeking — én bovendien is de herwaardering hier sowieso verboden. 📖
> > - **c** (verboden) → JUIST. 📖
> > - **d** (facultatief) → FOUT: facultatief impliceert dat het mág; dat klopt niet voor immateriële activa. 🔗
> > 
...
> > 
> > **Per optie**:
> > - **a (5.000.000)** — FOUT: dit is de nominale prijs zonder rentecomponent én vóór actualisatie; negeert het disconto. 🔗
> > - **b (5.600.000)** — FOUT: dit is de nominale waarde *inclusief* contractuele interest (5.000.000 + 600.000); zou de hele financiële component als omzet erkennen. 🔗
> > - **c (4.400.000)** — FOUT: dit is 5.000.000 − 600.000 (interest aftrekken in plaats van disconto), houdt geen rekening met de marktactualisatie. 🔗
> > - **d (4.595.294)** — **JUIST**: actuele waarde = 5.000.000 − 404.706 (disconto). 📖
> > - **e (5.404.706)** — FOUT: voegt het disconto bij de prijs in plaats van het ervan af te trekken. 🔗
> > 
...
> > 
> > Het disconto staat bij de boeking op 5/2/2014 in 493 — Over te dragen opbrengsten en wordt jaarlijks (volgens de actuariële methode aan de oorspronkelijke actualisatievoet) naar 751 overgeboekt. 📖
> > 
> > **Per optie**:
> > - **a** — FOUT: zet disconto op **651 (kost)**; het disconto bij een **vordering** is een **opbrengst** (493 → 751), niet een kost. 🔗
> > - **b** — FOUT: interest in 70 (omzet) hoort niet, en disconto in 651 evenmin. 🔗
> > - **c** — FOUT: interest in 70 (omzet) i.p.v. 751; disconto-ritme is bovendien **niet** vrij door de raad van bestuur te bepalen — het volgt de actuariële methode. 🔗
> > - **d** — **JUIST**: beide op 751 pro rata over 5 jaar. 📖
> > - **e** — FOUT: "niet splitsen, alles in omzet" druist in tegen de **verplichte** actualisatie van art. 3:45 §2 KB WVV. 🔗
> > 
...
> > 
> > Optie a (materiële vaste activa) → **FOUT**: software heeft geen fysieke vorm en valt niet onder MVA. 🔗
> > Optie b → **JUIST**: licentie op standaardsoftware voor eigen gebruik = IVA rubriek 211. 📖
> > 
...
> > 
> > Optie a (handelsgoederen) → **JUIST**: software wordt zonder wijziging doorverkocht = voorraad rubriek 34. 📖
> > Optie b (bestelling in uitvoering) → **FOUT**: bestellingen in uitvoering zijn werken/diensten die op balansdatum nog niet zijn opgeleverd voor een bepaalde klant — niet van toepassing op een doorverkocht handelsproduct. 🔗
> > Optie c (immateriële vaste activa) → **FOUT**: software wordt niet duurzaam in de onderneming gebruikt; ze wordt doorverkocht. Activeren als IVA vereist eigen, duurzaam gebruik. 🔗
> > 
...
> > **Antwoord: ?**
> > 
> > | Optie | Toegelaten? | Verklaring |
> > |---|:---:|---|
> > | **a) 3 jaar** | **JA** | Korter dan 5 jaar — volledig binnen het standaardregime, geen bijzondere verantwoording nodig. 🔗 |
> > | **b) 5 jaar** | **JA** | Vijf jaar is de **referentietermijn**: tot en met 5 jaar mag zonder bijzondere verantwoording in de toelichting. 📖 |
> > | **c) 10 jaar** | **JA, mits verantwoording** | Spreiding **meer dan 5 jaar** is toegestaan in **uitzonderlijke gevallen**, op voorwaarde dat dit in de **toelichting bij de jaarrekening wordt verantwoord** (langere economische gebruiksduur). 📖 | 📖
> > 
> > De wet legt **geen verplichte minimum- of maximumtermijn** op voor de afschrijving van goodwill (art. 61, § 1 KB W.Venn.). Het afschrijvingsplan moet de aanschaffingskosten spreiden over de **waarschijnlijke nuttigheids- of gebruiksduur** van het actief (art. 28, § 1 + art. 45, § 1 KB W.Venn.). 📖 De enige bijzondere regel: gaat de afschrijving over **méér dan vijf jaar**, dan moet dit "in uitzonderlijke gevallen" worden gemotiveerd in de toelichting (art. 61, § 1, lid 4 KB W.Venn.). 📖 Drie en vijf jaar liggen dus binnen het standaardregime; tien jaar vereist een onderbouwde economische rechtvaardiging (bv. duurzaam klantenbestand, langetermijncontracten). 📖
> > 
...
>
> Kan zij in haar jaarrekening hiermee al rekening houden?
> 
> **Op welke manier en voor welk bedrag zal zij dit doen?**
> 
> > [!success]- Antwoord (klik om te openen)
> >
...
> > 
> > Boeking elk boekjaar (jaar 1 t.e.m. 8):
> > 
> > | | Rekening | Omschrijving | Debet | Credit |
> > |---|---|---|---|---|
> > | | 6360 | Voorzieningen voor grote herstellings- en onderhoudswerken: Toevoeging | 5.000 | |
> > | aan | 162 | Voorzieningen voor grote herstellings- en onderhoudswerken | | 5.000 |
> > 
> > Na acht jaar staat er 40.000 EUR op rekening 162, klaar om te worden besteed wanneer de schilderwerken worden uitgevoerd. 🔗
> > 
...
> > 
> > Boeking in jaar 8 — aanwending voor het geraamde bedrag:
> > 
> > | | Rekening | Omschrijving | Debet | Credit |
> > |---|---|---|---|---|
> > | | 162 | Voorzieningen voor grote herstellings- en onderhoudswerken | 40.000 | |
> > | aan | 6361 | Voorzieningen voor grote herstellings- en onderhoudswerken: Besteding en terugneming (-) | | 40.000 |
> > 
> > De werkelijke factuur van de schilder (bv. 45.000 EUR) wordt geboekt op een onderhoudskostenrekening (61) tegen leveranciers (440). Het **verschil** (5.000 EUR meer dan geraamd) blijft per saldo als **bijkomende exploitatiekost** in het resultaat van het jaar van uitvoering — de voorziening neutraliseert enkel het deel dat correct was geraamd. 🔗
> > 
...
> > 
> > - **Optie a** (via resultatenrekening + resultaatverwerking) is **fout**: kapitaalinbreng raakt nooit het resultaat — een leveranciersschuld die in kapitaal wordt ingebracht is geen opbrengst. 🔗
> > - **Optie c** (via resultaatverwerking) is **fout** om dezelfde reden: resultaatverwerking dient voor de bestemming van een reeds gerealiseerd resultaat, niet voor kapitaaltransacties met een derde-schuldeiser. 🔗
> > 
...
> > 
> > - **Optie a** (onmiddellijke uitbetaling) → **fout**: negeert de wachttermijn. 🔗
> > - **Optie b** (via resultaatverwerking) → **fout**: kapitaalvermindering is geen resultaatbestemming maar een rechtstreekse vermindering van het eigen vermogen. 🔗
> > - **Optie d** (twee maanden na de notariële akte) → **fout**: de termijn loopt vanaf **bekendmaking in het Belgisch Staatsblad**, niet vanaf de notariële akte. 📖
> > 
...
> 
> **Welke boekhouding dient zij te voeren?**
> 
...
> > 
> > 1. **Boekhouding** (art. 3:1 ev. WVV + WER, CBN 2022/14) — de in België gevestigde bijkantoren moeten een **Belgische boekhouding** voeren met inventaris en jaarrekening eigen aan het bijkantoor, volgens het Belgisch boekhoudrecht. 📖
> > 2. **Neerlegging** (art. 3:20 WVV) — bij de NBB wordt **niet** de Belgische bijkantoor-jaarrekening neergelegd, maar **de jaarrekening van de buitenlandse vennootschap zelf** (en in voorkomend geval haar geconsolideerde jaarrekening) **in de vorm waarin deze werden opgesteld, gecontroleerd en openbaar gemaakt volgens het recht van de Staat waaronder de vennootschap valt**. 📖
> > 
> > - **Optie a** (geen neerlegging) → **fout**: er is wél neerleggingsplicht (art. 3:20). 📖
> > - **Optie b** (jaarrekening met cijfers van de vaste inrichting) → **fout**: wat wordt neergelegd is de jaarrekening van de **buitenlandse vennootschap**, niet de cijfers van de vaste inrichting. 📖
> > - **Optie c** → **bijna juist**, maar mist het element "**en in voorkomend geval ook een geconsolideerde jaarrekening**" dat art. 3:20 §1 expliciet noemt. 📖
> > - **Optie d** → **volledig**: bevat alle vier de elementen (Belgische boekhouding voor het bijkantoor + statutaire jaarrekening van buitenlandse onderneming in buitenlandse vorm + geconsolideerde jaarrekening in voorkomend geval + sociale balans). 📖
> > 
...
> > 
> > 1. **Nut**: het product of proces draagt bij tot het ondernemingsdoel of tot een verbeterde concurrentiepositie.
> > 2. **Individualiseerbaar**: nauwkeurig gedefinieerd en geïndividualiseerd — kostprijs afzonderlijk vast te stellen.
> > 3. **Technische haalbaarheid + intentie**: voldoende technische uitvoerbaarheid en intentie tot voltooiing/gebruik of verkoop.
> > 4. **Voldoende middelen** om de ontwikkeling tot een goed einde te brengen.
> > 5. **Voorzichtige raming gebruikswaarde**: de kostprijs mag niet hoger zijn dan een voorzichtige raming van de gebruikswaarde of het toekomstig rendement (art. 60 KB W.Venn.). 📖
> > 
> > Voor het prototype-transportmiddel is het gebruik in fabrieken (verplaatsing zware goederen) een afgebakende toepassing met aanwijsbaar economisch nut — activering is dus inhoudelijk verantwoord, mits het bestuursorgaan deze criteria documenteert. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Onder het **regime 2013** (vóór KB 18-12-2015) kunnen **alle vier de kostencategorieën** worden geactiveerd, mits zij rechtstreeks aan het O&O-project zijn toerekenbaar — samen **295.000 EUR**: 🔗
> > 
> > | # | Kostencategorie | Bedrag | Activeerbaar (regime 2013) |
> > |---|-----------------|-------:|:--------------------------:|
> > | 1 | Vooronderzoek door studiebureaus | 20.000 | ✅ Ja (kosten van **onderzoek**) |
> > | 2 | Ontwikkeling door derden | 15.000 | ✅ Ja (kosten van **ontwikkeling** — extern) |
> > | 3 | Aankopen materiaal (voor het prototype) | 180.000 | ✅ Ja (vervaardigingsprijs — direct toerekenbaar) |
> > | 4 | Lonen arbeiders incl. patronale bijdragen | 80.000 | ✅ Ja (vervaardigingsprijs — direct toerekenbaar personeel) |
> > | | **Totaal te activeren** | **295.000** | |
> > 
> > De vervaardigingsprijs omvat de **direct toerekenbare aankoopkosten van grondstoffen, verbruiksgoederen en hulpstoffen** + de **rechtstreeks toerekenbare productiekosten** (lonen + sociale lasten van het personeel dat aan het project werkte) + extern uitbestede O&O. 📖
> > 
...
> > 
> > Het meest verwachte examenantwoord (regime 2013): **5 jaar** — als de gebruiksduur van het prototype niet uitdrukkelijk korter wordt geraamd. 🔗
> > 
...
> > 
> > 1. **Nog niet geactiveerd** (besluit vóór einde boekjaar, geen vaste-activa-boeking gemaakt): de kosten blijven gewoon in de resultatenrekening waar ze al stonden — **60** aankopen materiaal, **62** lonen + sociale lasten. Geen tegenboeking via **72** Geproduceerde vaste activa. Dit is het scenario dat de vraag impliceert ("voortijdig besloten"). 🔗
> > 2. **Reeds geactiveerd in een vorig boekjaar** (en pas later blijkt de onhaalbaarheid): de geactiveerde rekening **210** moet via een **uitzonderlijke afschrijving** of **bijzondere waardevermindering** (rekening **660** uitzonderlijke afschrijvingen op immateriële vaste activa) volledig worden afgeboekt — duurzaam waardeverlies. 📖
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Te voorzien vakantiegeld 2007 = 18,8 % × 102.000 EUR = 19.176,00 EUR** 🔗
> > 
> > | | Rekening | Omschrijving | Debet | Credit |
> > |---|---|---|---|---|
> > | | 623 | Voorzieningen vakantiegeld (Andere personeelskosten) | 19.176,00 | |
> > | aan | 456 | Vakantiegeld | | 19.176,00 | 🔗
> > 
> > Berekeningsgrondslag = brutobezoldigingen bedienden 2007 − eindejaarspremies = 112.000 − 10.000 = **102.000 EUR** 📖. Eindejaarspremies worden uitgesloten omdat zij geen recht op vakantiegeld doen ontstaan. Het forfaitaire percentage **18,8 %** wordt door de Commissie aanvaard als globale schatting van het in 2008 te betalen enkelvoudig + dubbel vakantiegeld op de in 2007 gepresteerde diensten van bedienden 📖. 📖
> > 
...
> > 
> > | Zijde | Rekening | Omschrijving | Bedrag |
> > |---|---|---|---|
> > | D | 640 (of 61) | Reclame- en publiciteitskosten | 1.000,00 |
> > | C | 492 | Toe te rekenen kosten | 1.000,00 |
> > 
> > **01/01/2008 — Tegenboeking** (heropening / tegenboeking overlopende rekening) 🔗
> > 
> > | Zijde | Rekening | Omschrijving | Bedrag |
> > |---|---|---|---|
> > | D | 492 | Toe te rekenen kosten | 1.000,00 |
> > | C | 640 (of 61) | Reclame- en publiciteitskosten | 1.000,00 |
> > 
> > **Januari 2008 — Boeking van de ontvangen factuur in het aankoopdagboek** 📖
> > 
> > | Zijde | Rekening | Omschrijving | Bedrag |
> > |---|---|---|---|
> > | D | 640 (of 61) | Reclame- en publiciteitskosten | 1.000,00 |
> > | D | 411 | Terug te vorderen BTW | 210,00 |
> > | C | 440 | Leveranciers | 1.210,00 | 🔗
> > 
> > **Waarom in 2007?** Het matching-beginsel (art. 3:11 KB WVV / art. 33 KB W.Venn.) vereist dat kosten worden toegerekend aan het boekjaar waarop ze economisch betrekking hebben, ongeacht het tijdstip van betaling of facturatie. De levering heeft in 2007 plaatsgevonden, dus de kost hoort bij 2007. 🔗
> > 
> > **Waarom rekening 492 (en niet 444 Te ontvangen facturen)?** Beide zijn defensief verdedigbaar in de praktijk; klassieke didactische oplossing voor een nog niet ontvangen factuur op afsluitdatum is **492 Toe te rekenen kosten** (passief overlopende rekening). Sommige handboeken gebruiken **444 Te ontvangen facturen** wanneer de leverancier en het bedrag al gekend zijn — beide leiden tot hetzelfde resultaat. 🤖
> > 
> > **Waarom de BTW pas in 2008?** Het recht op aftrek van BTW ontstaat door de uitreiking van een geldige factuur (art. 3 KB nr. 3). Op 31/12/2007 was er nog geen factuur, dus geen aftrekbare BTW; de toerekening in 2007 gebeurt op het netto-bedrag (1.000 EUR). 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Boekingen voorraadwijzigingen 31/12/N** 🔗
> > 
> > | Rekening | Omschrijving | Debet | Credit |
> > |---|---|---:|---:|
> > | 300 | Grondstoffen — aanschaffingswaarde | 5.000,00 | |
> > | 6090 | aan Voorraadwijzigingen van grondstoffen | | 5.000,00 |
> > | 6094 | Voorraadwijzigingen van handelsgoederen | 2.000,00 | |
> > | 340 | aan Handelsgoederen — aanschaffingswaarde | | 2.000,00 |
> > | 712 | Wijzigingen in de voorraad goederen in bewerking | 4.000,00 | |
> > | 320 | aan Goederen in bewerking — aanschaffingswaarde | | 4.000,00 |
> > | 330 | Gereed product — aanschaffingswaarde | 3.000,00 | |
> > | 713 | aan Wijzigingen in de voorraad gereed product | | 3.000,00 | 🔗
> > 
> > **Voorraadverschillen (eind − begin)** 🔗
> > 
> > - Grondstoffen (30): 17.000 − 12.000 = **+5.000** → toename → debet 300 / credit 6090 🔗
> > - Goederen in bewerking (32): 26.000 − 30.000 = **−4.000** → afname → debet 712 / credit 320 🔗
> > - Gereed product (33): 31.000 − 28.000 = **+3.000** → toename → debet 330 / credit 713 🔗
> > - Handelsgoederen (34): 4.000 − 6.000 = **−2.000** → afname → debet 6094 / credit 340 🔗
> > 
> > **Boekingslogica** 📖: bij een **toename** wordt de voorraadrekening gedebiteerd en de voorraadwijziging-rekening gecrediteerd (de wijziging vermindert de kosten of verhoogt de opbrengsten); bij een **afname** omgekeerd. Voor **aangekochte voorraden** (grondstoffen 30, handelsgoederen 34) loopt de tegenboeking via klasse **60 — handelsgoederen, grond- en hulpstoffen** (rekening 6090/6094). Voor **zelf voortgebrachte voorraden** (goederen in bewerking 32, gereed product 33) loopt de tegenboeking via klasse **71 — wijzigingen in de voorraad en in de bestellingen in uitvoering** (rekening 712/713). 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Boeking 1 — Oprichtingskosten (10 maart 2008)** 📖
> > 
> > | Debet | Credit | Bedrag |
> > |---|---|---|
> > | 200 Oprichtingskosten | | 1.200,00 |
> > | | 550 Kredietinstellingen | 1.200,00 |
> > 
> > **Boeking 2 — Aankoop personenwagen (31 maart 2008)** 📖
> > 
> > | Debet | Credit | Bedrag |
> > |---|---|---|
> > | 2410 Rollend materieel - aanschaffingswaarde | | 22.100,00 |
> > | 411 Terug te vorderen BTW | | 2.100,00 |
> > | | 440 Leveranciers | 24.200,00 |
> > 
> > De **aanschaffingswaarde** van de personenwagen bedraagt **22.100 EUR**: nettoprijs 20.000 EUR + 50 % niet-aftrekbare BTW (2.100 EUR). 🔗
> > 
> > **Berekening aanschaffingswaarde personenwagen** 🔗
> > 
> > - Nettoprijs: 20.000,00
> > - BTW 21 % op 20.000 = 4.200,00
> > - Aftrekbare BTW (max. 50 % voor personenwagens, art. 45 §2 BTW-Wb): 2.100,00 → rekening 411
> > - Niet-aftrekbare BTW (50 %): 2.100,00 → geactiveerd in aanschaffingswaarde (rekening 240/241)
> > - **Aanschaffingswaarde geactiveerd**: 20.000 + 2.100 = **22.100,00**
> > - **Totaal te betalen aan leverancier**: 20.000 + 4.200 = **24.200,00** 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Afschrijvingsboeking per 31 december 2008** 📖
> > 
> > | Debet | Credit | Bedrag |
> > |---|---|---|
> > | 6300 Afschrijvingen op oprichtingskosten | | 200,00 |
> > | | 2009 Geboekte afschrijvingen op oprichtingskosten | 200,00 |
> > | 6302 Afschrijvingen op materiële vaste activa | | 3.683,33 |
> > | | 2409 Geboekte afschrijvingen op rollend materieel | 3.683,33 | 📖
> > 
> > **Berekening pro rata temporis — boekjaar 1 maart → 31 december 2008 = 10 maanden** 🔗
> > 
> > **Oprichtingskosten** (max. 5 jaar, art. 3:37 KB-WVV — jaarlijkse tranche ≥ 20 %): 📖
> > - 1.200,00 / 5 jaar = 240,00 / jaar
> > - Pro rata: 240,00 × 10/12 = **200,00**
> > 
> > **Personenwagen** (economische levensduur 5 jaar):
> > - 22.100,00 / 5 jaar = 4.420,00 / jaar
> > - Pro rata: 4.420,00 × 10/12 = **3.683,33**
> > 
> > **Toelichting pro rata**: Hoewel een **kleine vennootschap** in principe een **volledige annuïteit** mag boeken in het jaar van aanschaffing (afwijking op het pro-rata-beginsel), telt het **eerste boekjaar hier slechts 10 maanden** (van 1 maart tot 31 december). Daarom wordt de jaarannuïteit alsnog met **10/12** vermenigvuldigd. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Boeking bij B (aankoop aandelen C):**
> > 
> > | Rek. | Omschrijving | Debet | Credit |
> > |---|---|---:|---:|
> > | 280 | Deelnemingen in verbonden ondernemingen 🔗 | 50.000,00 |  |
> > | 550 / 489 | Kredietinstellingen *of* Te betalen (aankoopprijs) |  | 50.000,00 |
> > 
> > Boekingstekst: aankoop 12 %-pakket in zustervennootschap C voor 50.000,00 EUR. 🔗
> > 
> > De kwalificatie van de deelneming is het scharnierpunt. Vennootschap A controleert zowel B als C; B en C zijn dus **zustervennootschappen** binnen dezelfde groep. Op grond van art. 1:20, 1°, d) WVV zijn vennootschappen die onder de controle staan van eenzelfde moedervennootschap onderling **verbonden vennootschappen** 📖. Bijgevolg moet B het 12 %-belang in C niet boeken als rekening 28**2** (deelneming met deelnemingsverhouding) en zeker niet als rekening 28**4** (andere aandelen) — wat de drempel van 10 %/20 % zou suggereren — maar als rekening **280 Deelnemingen in verbonden ondernemingen** 🔗. De groepsband heeft voorrang op het stempercentage. 🔗
> > 
...
> > 
> > | # | D / C | Rekening | Omschrijving | Bedrag (EUR) |
> > |---|---|---|---|---:|
> > | 1 | D | 416 | Diverse vorderingen — te ontvangen kapitaalsubsidie | 10.000,00 |
> > | 1 | C | 15 | Kapitaalsubsidies (netto) | 6.000,00 |
> > | 1 | C | 168 | Uitgestelde belastingen op kapitaalsubsidies | 4.000,00 |
> > | 2 | D | 6302 | Afschrijvingen op materiële vaste activa | 10.000,00 |
> > | 2 | C | 23x9 | Geboekte afschrijvingen op installaties, machines en uitrusting | 10.000,00 |
> > | 3 | D | 15 | Kapitaalsubsidies (netto) | 600,00 |
> > | 3 | C | 753 | Kapitaal- en interestsubsidies | 600,00 |
> > | 4 | D | 168 | Uitgestelde belastingen op kapitaalsubsidies | 400,00 |
> > | 4 | C | 780 | Onttrekkingen aan de uitgestelde belastingen | 400,00 |
> > 
> > **Afsluitingsboekingen 31/12/2003** (zelfde structuur, geen nieuwe toezegging)
> > 
> > | # | D / C | Rekening | Omschrijving | Bedrag (EUR) |
> > |---|---|---|---|---:|
> > | 1 | D | 6302 | Afschrijvingen op materiële vaste activa | 10.000,00 |
> > | 1 | C | 23x9 | Geboekte afschrijvingen op installaties, machines en uitrusting | 10.000,00 |
> > | 2 | D | 15 | Kapitaalsubsidies (netto) | 600,00 |
> > | 2 | C | 753 | Kapitaal- en interestsubsidies | 600,00 |
> > | 3 | D | 168 | Uitgestelde belastingen op kapitaalsubsidies | 400,00 |
> > | 3 | C | 780 | Onttrekkingen aan de uitgestelde belastingen | 400,00 |
> > 
> > *Boeking 1 van 2002 (toezegging) wordt in de literatuur als boeking-bij-toezegging gepresenteerd en niet als 'afsluitings'-boeking sensu stricto, maar wordt hier meegenomen omdat de toezegging in 2002 plaatsvindt en de jaarrekening 2002 erop moet aansluiten. De kasontvangst in 2003 (550 a/n 416 voor 5.000) is een verrichting in de loop van het boekjaar, geen afsluitingsboeking.* 🔗
> > 
> > **Splitsing kapitaalsubsidie bij toezegging (KB W.Venn. art. 76, §1)**:
> > - Bruto subsidie: 10.000,00
> > - Uitgestelde belastingen (40%): 10.000 × 0,40 = **4.000,00** → rek. 168 📖
> > - Netto kapitaalsubsidie (60%): 10.000 × 0,60 = **6.000,00** → rek. 15 📖
> > 
> > **Jaarlijkse afschrijving machine**: 100.000 × 10% = **10.000,00** → rek. 6302 / 23x9 🔗
> > 
> > **Pro rata inresultaatname (gelijkmatig met afschrijving — art. 76, §2)**:
> > - Op rek. 15: 6.000 × 10% = **600,00** → 15 a/n 753 📖
> > - Op rek. 168: 4.000 × 10% = **400,00** → 168 a/n 780 📖
> > 
> > Boekjaren 2002 en 2003 zijn identiek qua afschrijving en pro rata (10% per jaar gedurende 10 jaar). 🔗
> > 
> > **Vermeldenswaard — splitsing in twee passiefposten** ❓
> > 
> > De **bruto-methode** met opsplitsing van de subsidie in een netto-deel (rek. 15) en een uitgestelde-belastingen-deel (rek. 168) is in 2002 (BIBF-examen) niet de enige praktijk: ze geldt **enkel** wanneer de subsidie effectief belastbaar is volgens de fiscale regels van dat ogenblik. Bij latere wijziging van de fiscaliteit kan het saldo op rek. 168 worden aangepast (art. 76, §3 KB W.Venn., nu art. 3:46 KB WVV). Voor een examen-antwoord uit 2003 is de tweesplitsing met 40% het standaard-schoolvoorbeeld. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Afsluitingsboekingen** (CBN-methode: voorraad eerst op aanschaffingswaarde, dan waardevermindering apart):
> > 
> > | # | Debet | Bedrag (EUR) | Credit | Bedrag (EUR) | Toelichting |
> > |---|---|---:|---|---:|---|
> > | 1 | **71** Wijzigingen voorraad goederen in bewerking | 100,00 | **32** Goederen in bewerking | 100,00 | Voorraadafname GIB: 500 → 400 🔗 |
> > | 2 | **34** Handelsgoederen | 1.500,00 | **6094** Voorraadwijzigingen handelsgoederen | 1.500,00 | Voorraadtoename handelsgoederen: 7.000 → 8.500 (aanschaffingswaarde) 🔗 |
> > | 3 | **6310** Waardeverminderingen op voorraden (toevoegingen) | 325,00 | **349** Op handelsgoederen geboekte waardeverminderingen | 325,00 | WV = 250 (marktwaarde 8.250 < kostprijs 8.500) + 75 (afprijzing) 🔗 |
> > 
> > **Netto boekwaarde handelsgoederen na afsluiting**: 8.500 − 325 = **8.175,00 EUR** 🔗
> > 
> > **Stap 1 — Voorraadwijziging GIB (rekening 32)**: saldo D 500 → inventaris 400 → afname **100**. CBN 132/7 boekt uitgaande voorraad GIB: 71 D / 32 C. 🔗
> > 
> > **Stap 2 — Voorraadwijziging handelsgoederen (rekening 34)**: saldo D 7.000 → inventaris **aan aanschaffingswaarde 8.500** → toename **1.500**. CBN-schema voor inkomende handelsgoederen: 34 D / 6094 C. 🔗
> > 
> > **Stap 3 — Waardevermindering op handelsgoederen (rekening 349)**: artikel 3:43 KB WVV (vroeger art. 69 §1 KB W.Venn.) vereist waardering van handelsgoederen tegen aanschaffingswaarde óf tegen lagere marktwaarde op balansdatum. Berekening:
> > - Verschil kostprijs/marktwaarde: 8.500 − 8.250 = **250** 📖
> > - Bijkomende afprijzing: **75** 📖
> > - **Totaal WV: 325** 🔗
> > Boeking volgens CBN 132/7: 6310 D / 349 (subrekening "3·9 Op voorraden geboekte waardeverminderingen") C. 🔗
> > 
