...
```mermaid
flowchart LR
    A[Balansdatum<br/>31-12] --> B[Opmaak +<br/>voorlegging AV<br/>binnen 6 maanden]
    B --> C[AV keurt<br/>jaarrekening goed]
    C --> D[Neerlegging NBB<br/>binnen 30 dagen na AV<br/>en uiterlijk 7 maanden<br/>na balansdatum]
```
