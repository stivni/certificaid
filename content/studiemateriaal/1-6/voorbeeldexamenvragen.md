---
title: 1.6 Voorbeeldexamenvragen Externe controle
...
# 1.6 Voorbeeldexamenvragen Externe controle
...
> > 
> > **Grond 2 — randvoorwaarden niet vervuld**. ISA 210 (par. 6) eist dat de auditor vooraf vaststelt dat (a) het management een aanvaardbaar stelsel inzake financiele verslaggeving zal hanteren en (b) het management de drie basisverantwoordelijkheden aanvaardt: opstellen van de jaarrekening overeenkomstig dat stelsel, interne beheersing, en het verschaffen van alle informatie en onbeperkte toegang. Ontbreekt een van beide -> de opdracht **mag niet worden aanvaard** ("limitation imposed by management" of onaanvaardbaar stelsel). 📖
> > 
> > Andere geldige voorbeelden die je ook mag aanhalen: bedenkingen bij de **integriteit van het management** (KYC/anti-witwas-signalen), onvoldoende **bekwaamheid of middelen** binnen het kantoor (geen sector-expertise, te beperkte tijd voor degelijke uitvoering), of een te beperkt **scope** dat de auditor verhindert een redelijke mate van zekerheid te bekomen. 🔗
> > 
...
> > 
> > - **Bestaan / rechten** (existence & rights): door het overlijden verdwijnt de oorspronkelijke debiteur; de vraag wordt of de vennootschap juridisch nog een afdwingbare vordering heeft op de nalatenschap of op de erfgenamen (zaakvoerders-aandeelhouders zelf). Zonder bewijsstuk of erkenning kan de vordering economisch fictief zijn. 🔗
> > - **Waardering / inbaarheid** (valuation): zelfs als de vordering bestaat, moet ze tegen realiseerbare waarde worden opgenomen. Bij een overledene zonder voldoende nalatenschap of bij erfgenamen die de nalatenschap onder voorrecht van boedelbeschrijving aanvaarden of verwerpen, dringt een waardevermindering zich op (art. 3:46 KB-WVV — onzekerheid over de inning op vervaldag). 🔗
> > 
> > Andere assertions (volledigheid, presentatie) zijn minder kritisch voor dit specifieke actief — de **twee** die uitspringen zijn bestaan/rechten en waardering. 🤖
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > | # | Controledoelstelling | Techniek / methodiek |
> > |---|---|---|
> > | 1 | **Bestaan en rechten** van de vordering | **Inspectie van onderliggende stukken** + **externe bevestiging**: opvragen van de overeenkomst of erkenning van schuld (leningovereenkomst, R/C-erkenning), inzage in het **nalatenschapsdossier** (notariële akte van bekendheid, aangifte van nalatenschap), en — indien de erfgenamen identificeerbaar zijn (de zaakvoerders-aandeelhouders zelf) — een **schriftelijke bevestiging** van de schuld door hen. Cross-check met de mutaties op de R/C-rekening (oorsprong van het debetsaldo). 🔗 |
> > | 2 | **Waardering / inbaarheid** | **Analyse van de inbaarheid** + **berekening waardevermindering**: opvragen van een **vermogensoverzicht van de nalatenschap** (aangifte successierechten), nagaan of erfgenamen de nalatenschap zuiver aanvaarden, onder voorrecht aanvaarden of verwerpen; nagaan of er een terugbetalingsplan is. Indien inning onzeker → waardevermindering (rekening 416 + 6340) berekenen en voorstellen, of het saldo expliciet als oninbaar aanmerken. Eventueel **schriftelijke bevestiging door het bestuursorgaan** dat zij de vordering opeisbaar achten en plan tot inning hebben. 🔗 | 🔗
> > 
> > Per doelstelling de logica:
> > 
> > - **Bestaan/rechten → inspectie + bevestiging**: de assertion vergt **documentair bewijs** dat de vordering bestaat en juridisch afdwingbaar is. Inspectie van het R/C-grootboek geeft enkel het saldo; je hebt de **titel** (onderliggende overeenkomst) en, bij overlijden, het bewijs van **overgang van de schuld op de nalatenschap of erfgenamen** nodig. Een externe confirmatie bij de erfgenamen is de sterkste vorm van bewijs (ISA 505). 📖
> > - **Waardering → analyse inbaarheid**: hier gaat het om **schatting van de realiseerbare waarde**. De accountant beoordeelt of het bedrag van de nalatenschap (na aftrek van bevoorrechte schulden en successierechten) toelaat de vordering effectief te innen. ISA 540 (herzien) eist dat de accountant management-schattingen kritisch evalueert; concreet hier: vraag een onderbouwde inbaarheidsanalyse en bereken zelf het waardeverminderings-bedrag indien nodig (CBN 2011/15-logica: bij onzekerheid op de vervaldag → waardevermindering tot het inbaar geachte bedrag). 🔗
> > 
> > In het kader van een **omzettingsverslag** is het volstaan met *beperkte mate van zekerheid* (review-niveau): de technieken zijn lichter dan bij een wettelijke controle — vooral **inquiry** bij bestuur, **analytische review** op de R/C-mutaties, en **inspectie** van de belangrijkste onderliggende stukken — maar de twee doelstellingen blijven dezelfde. 🤖
> > 
...
> > |---|---|
> > | 1. **Bestaan / aanwezigheid** op balansdatum 30/09/2014 (roll-back van 23/01/2015-stand) | Aansluiting eindvoorraadlijst 30/09/2014 met de bijgehouden voorraadkaarten + nazicht van alle in- en uitgaande bewegingen tussen 30/09/2014 en 23/01/2015 op basis van ontvangst- en leveringsbonnen (roll-back-procedure). 🔗 |
> > | 2. **Waardering** (juiste aanschaffings- of vervaardigingsprijs, laagstewaarderegel toegepast) | Steekproef op de waarderingsregels: hercalculatie van de eenheidsprijs per artikel op basis van laatste aankoopfacturen (FIFO/gewogen gemiddelde, consistent toegepast) en vergelijking met markt-/realisatiewaarde; toets op slow movers en obsolete voorraad. 📖 | 🔗
> > 
> > De fysieke telling van 30/09/2014 dekt enkel het bestaan en de hoeveelheid op die datum. Op 23/01/2015 moet de accountant nog twee doelstellingen afdekken:
> > 
> > - **Bestaan op balansdatum** — de getelde voorraad 30/09/2014 koppelen aan het balanssaldo. Tussen telling en huidige stand zijn er aankopen, verkopen en eventuele retours; via de bewegingen-administratie (roll-back) toon je aan dat het saldo 30/09/2014 consistent overgaat. Cut-off-toets op aankoop- en verkoopfacturen rond 30/09/2014 vermijdt dat goederen in transit dubbel of niet geteld zijn. 🔗
> > - **Waardering** — een telling zegt niets over de prijs. De accountant verifieert dat de toegepaste kostprijsformule (individualisering / gewogen gemiddelde / FIFO) consistent is en correct uitgerekend, en dat de laagstewaarderegel is toegepast op slow movers of technologisch verouderde voorraad (relevant bij hoogtechnologische gasleidingen). 📖
> > 
> > Alternatieve doelstellingen die evenzeer pertinent zijn: **volledigheid** (geen voorraad onterecht weggelaten — kruislink met aankoopcyclus), **eigendomsrecht** (consignatie-, derde- of doorgangsgoederen mogen niet in eigen voorraad zitten), **presentatie/toelichting** (waarderingsregels conform art. 3:54 KB WVV in de toelichting opgenomen). 🔗
> > 
...
> 
> **Welke actie onderneem je als controlerende accountant: stel een correctieboeking voor, maak een voorbehoud (motiveer) of vraag de correctie te boeken in de heropening van volgend boekjaar?**
> 
> > [!success]- Antwoord (klik om te openen)
> >
...
> > |---|---|---:|---:|
> > | 700 | Verkopen handelsgoederen | 80.000,00 | |
> > | 451 | Te betalen btw (21%) | 16.800,00 | |
> > | 400 | Handelsvorderingen | | 96.800,00 |
> > 
> > Daarnaast: **terugname kostprijs verkochte goederen** door het teruggenomen goed opnieuw in voorraad te nemen (3xx D / 609 Voorraadwijzigingen C voor de vervaardigings- of aanschaffingsprijs). 🔗
> > 
> > Na correctie: vordering op klant = 217.800 − 96.800 = **121.000 EUR**, conform de confirmatie. 🔗
> > 
> > Waarom géén voorbehoud en géén heropeningsboeking volgend boekjaar:
> > 
> > - **Geen voorbehoud** zolang het management bereid is te corrigeren. Voorbehoud is de finale escalatie wanneer de jaarrekening van materieel belang zijnde afwijkingen blíjft bevatten (ITAA-KMO-controlenorm §119; ISA 705). De accountant vraagt eerst de correctie; pas bij weigering volgt voorbehoud. 📖
> > - **Geen heropeningsboeking** in volgend boekjaar omdat de gebeurtenis (retour 29/09/2014) **vóór** balansdatum 30/09/2014 plaatsvond. Het is geen gebeurtenis na balansdatum maar een bevestigde fout in het af te sluiten boekjaar. Bovendien zou uitstel betekenen dat de jaarrekening 30/09/2014 een omzet en vordering vertoont die feitelijk niet bestaan — materieel onjuist. 🔗
> > - **Materialiteit**: 96.800 EUR > 70.000 EUR (balans) én > de 100.000 EUR-resultatenrekening-materialiteit voor het btw-vrije gedeelte van 80.000 EUR is op zich nog onder de drempel, maar de gecombineerde balansafwijking dwingt correctie af. 🔗
> > 
...
> > 
> > - **Volledige populatie afgebakend** — alle openstaande leveranciersrekeningen per balansdatum (inclusief nulsaldi en debetsaldi — die kunnen wijzen op niet-geboekte facturen of vooruitbetalingen). 🔗
> > - **Stratificatie naar risico/omvang** — grote saldi en risicovolle leveranciers worden integraal opgenomen; voor de resterende populatie wordt at random getrokken. Dit voorkomt dat enkel "grote namen" worden bevestigd terwijl kleine of nul-saldi (waar de cut-off-risico's vaak zitten) buiten beeld blijven. 🔗
> > - **Geen bias door de cliënt** — de auditor (niet de cliënt) bepaalt welke leveranciers worden aangeschreven, anders is de selectie niet meer onafhankelijk en dus niet representatief. 📖
> > 
...
> > Praktische stappen:
> > 
> > - **Populatie aftoetsen** — saldilijst leveranciers aansluiten op de balanspost handelsschulden (totaal-controle). 🔗
> > - **Stratificeren** — bv. saldi > materialiteit integraal, saldi tussen X en materialiteit gewogen (MUS), kleine saldi at random. 📖
> > - **Steekproefomvang bepalen** in functie van uitvoeringsmaterialiteit, ingeschat risico en verwachte foutgraad. 📖
...
> > 
> > - **Subsequent payments** — inspectie van bankuittreksels en betalingen ná balansdatum die het openstaande saldo aanzuiveren. 🔗
> > - **Inspectie onderliggende stukken** — leveranciersfacturen, ontvangstbewijzen, bestelbonnen, contracten matchen met het saldo. 🔗
> > - **Cut-off-test op aankopen** — aankopen rond balansdatum aansluiten op ontvangsten en facturen, om volledigheid van schulden te toetsen (het dominante risico bij leveranciers). 🔗
> > - **Reconciliatie met leveranciersuittreksels** die de cliënt zelf in zijn dossier heeft (eventueel onafhankelijk opvragen). 🔗
> > 
...
> > 
> > - **Planning (§2.1 Werkprogramma)**: één werkprogramma per verrichting (niet per vennootschap), met expliciete ruimte om elkaars werkzaamheden over te nemen. De steun is geen blind vertrouwen: de overnemende beroepsbeoefenaar moet eerst de gepastheid van die werkzaamheden hebben kunnen nagaan; bij twijfel kan hij — met inachtneming van de confraterniteit — bijkomende werkzaamheden vragen of zelf bijkomend onderzoek verrichten. 🔗
> > - **Oordeelsvorming (§3 Deontologische aspecten)**: vóór elke beroepsbeoefenaar zijn verslag finaliseert, moeten de conclusies onderling worden uitgewisseld. Doel: vermijden dat twee verslagen over dezelfde verrichting elkaar tegenspreken of onvolledig zijn. 🔗
> > - **Signalering (§6.1 Controle van de overige inlichtingen)**: stelt één beroepsbeoefenaar bij zijn onderzoek van het fusie-/splitsingsvoorstel een onvolledigheid of onnauwkeurigheid vast, dan moet hij niet alleen het bestuursorgaan dat hem aanstelde, maar ook de andere beroepsbeoefenaar daarvan onmiddellijk in kennis stellen. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Twee remediërende acties bij onvoldoende respons:
> > 
> > 1. **Follow-up versturen** — een herinnering (en desnoods een tweede herinnering) sturen aan de niet-reagerende klanten, eventueel telefonisch nagaan dat het verzoek goed is aangekomen en de bestemmeling identificeren. ISA 505 §7(d) noemt follow-upverzoeken expliciet als onderdeel van het beheersen van de bevestigingsprocedure. 📖
> > 2. **Alternatieve controlewerkzaamheden** uitvoeren voor de openstaande non-responsen, typisch:
> >    - nazicht van **subsequent cash receipts** (betalingen ontvangen na balansdatum die de openstaande post afdekken); 🔗
> >    - inspectie van **verkoopfacturen, verzendingsdocumenten en ondertekende bestelbonnen / leveringsbewijzen** om bestaan en juistheid van de vordering te onderbouwen. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Werkwijze na selectie van de te bevestigen klanten — kerngedachte: **de auditor blijft op elk moment in controle van de bevestigingsprocedure** (ISA 505 §7); de cliënt mag de keten niet kunnen onderscheppen of beïnvloeden. 📖
> > 
> > - **Opstellen**: de **auditor** ontwerpt het verzoek (vorm, bedrag, peildatum) en bepaalt de inhoud; hij behoudt steeds de controle over wat gevraagd wordt. 🔗
> > - **Ondertekening**: de brief wordt **door of namens het management van de gecontroleerde onderneming ondertekend** (de klant moet immers de derde partij vrijgeven om informatie te delen met de auditor), maar het is de auditor die de brief opmaakt en het verzendproces beheerst. 🔗
> > - **Adressering van het antwoord**: het verzoek **vermeldt expliciet dat de klant rechtstreeks aan de auditor moet antwoorden** — meestal via een bij de brief gevoegde antwoordenveloppe geadresseerd aan het kantoor van de auditor (niet aan de cliënt). ISA 505 §7(c) vereist dit uitdrukkelijk. 📖
> > - **Verzending**: **de auditor zelf verzendt** de (door de klant ondertekende) brieven — niet de cliënt. Zo wordt vermeden dat brieven onderschept, gewijzigd of selectief verstuurd worden. ISA 505 §7(d). 📖
> > - **Ontvangst en opvolging**: antwoorden komen rechtstreeks bij de auditor binnen; de auditor verifieert bron en inhoud, doet follow-up bij non-respons en evalueert uitzonderingen (§10-§14). 🔗
> > 
...
> > 
> > - **niet** als voorziening in de balans is opgenomen (onderwaardering passief), of
> > - **niet** als voorwaardelijke verplichting in de toelichting is vermeld (onvolledige toelichting), of
> > - **wel** is opgenomen maar foutief gewaardeerd. 🔗
> > 
> > Het controleverslag moet een oordeel uitspreken over het **getrouw beeld** van de jaarrekening — als een materiële voorziening ontbreekt of een belangrijke voorwaardelijke verplichting niet is toegelicht, is een oordeel **met voorbehoud** of zelfs **afkeurend** mogelijk. 🔗
> > 
...
> > 
> > 1. **Detail van de kostenrekening 670 'Erelonen advocaat' opvragen**: facturen, prestatiestaten, omschrijving van de dossiers — om te onderscheiden tussen routine-bijstand en geschillen. 🔗
> > 2. **Inlichtingen inwinnen bij het management** (en in voorkomend geval de juridische dienst) over hangende, dreigende of afgewikkelde rechtszaken. 📖
> > 3. **Notulen** van de algemene vergadering en de raad van bestuur **doornemen** + de **correspondentie met advocaten** opvragen. 📖
> > 4. **Bevestigingsbrief aan de externe advocaat** sturen (door cliënt opgesteld, rechtstreeks aan auditor geadresseerd) met vraag naar: lijst van hangende geschillen, inschatting van de uitkomst en het bedrag, eventuele bijkomende dossiers die de advocaat kent. 📖
> > 5. **Schriftelijke bevestiging van het management** opnemen in de management letter (ISA 580): alle gekende geschillen zijn meegedeeld en correct verwerkt in de jaarrekening. 📖
> > 6. **Evaluatie van het geboekte bedrag** aan voorzieningen / toelichting van voorwaardelijke verplichtingen tegenover de bekomen informatie, en bepalen of het controleoordeel moet worden aangepast. 🔗
> > 
...
> > 
> > - **Aard van het document**: het is een *boekhoudkundige staat* opgesteld door de interne boekhouder, geen door het bestuursorgaan opgestelde en goedgekeurde jaarrekening. De auditor controleert de financiële overzichten zoals door het management opgesteld (ISA 200.A2 — premise of an audit). 🔗
> > - **Volkomen controle nog niet uitgevoerd**: cijfercontroles (substantive procedures) moeten nog gebeuren — de materialiteit is pas berekend en de werkzaamheden ter plaatse starten net. 🔗
> > - **Subsequent events / afloopcontrole**: tussen 31/12/2013 en de datum van het controleverslag moeten gebeurtenissen na balansdatum worden onderzocht (ISA 560). 🔗
> > - **Schriftelijke bevestigingen van de leiding** (ISA 580, *Letter of Representation*) ontbreken nog. 🔗
> > - **Verslag van het bestuursorgaan**: voor een volkomen controle moet ook het jaarverslag worden nagelezen en getoetst aan de jaarrekening (art. 3:75 WVV). 🔗
> > - **Onafhankelijkheid van de informatieverstrekker**: een staat aangeleverd door de *interne* boekhouder zonder formele goedkeuring door het bestuursorgaan biedt geen geschikte basis. 🔗
> > 
...
> > 
> > - **Scope-bepaling**: posten of transactiestromen kleiner dan de materialiteit (en kleiner dan de uitvoeringsmaterialiteit) vragen beperktere of geen substantieve werkzaamheden. 🔗
> > - **Sample-omvang**: hoe lager de materialiteit, hoe groter de te trekken steekproeven (ISA 530). 🔗
> > - **Drempel voor correctievoorstellen**: ongecorrigeerde afwijkingen worden geaccumuleerd (ISA 450) en getoetst aan de materialiteit; pas dan kan beslist worden of het oordeel zuiver, met beperking of afkeurend wordt. 🔗
> > - **Specifieke (lagere) materialiteiten**: voor bepaalde posten (bv. bezoldigingen van bestuurders, transacties met verbonden partijen) kan een lagere drempel worden vastgelegd omdat gebruikers daar gevoeliger voor zijn. 🔗
> > - **Herziening tijdens de opdracht**: ISA 320 §12-13 verplicht herziening van de materialiteit zodra nieuwe informatie de oorspronkelijke berekening achterhaalt. 📖
> > 
...
> > 
> > 1. **Bestaan en eigendomsrecht (existence & rights)**: bestaan de aandelen werkelijk op 31/12/2013 en behoren zij toe aan de vennootschap? 🔗
> > 2. **Waardering (valuation)**: is de boekwaarde van 300.000 EUR correct, rekening houdend met eventuele duurzame minderwaarden (art. 3:42 KB/WVV — waardevermindering bij duurzame minderwaarde)? 🔗
> > 
> > *Bijkomende relevante assertions*: volledigheid (alle aangehouden deelnemingen geboekt) en presentatie/toelichting (toelichting XVIII jaarrekening — staat van financiële vaste activa). 🤖
> > 
> > **Twee controletechnieken** (ISA 500 §A14-A25):
> > 
> > 1. **Inspectie van bewijsstukken (inspection)**: aankoopakte / notariële akte, betalingsbewijzen, aandelenregister van de dochter, eventueel aandeelbewijzen of inschrijving in het effectenregister. Dekt bestaan + eigendomsrecht + initiële waardering aan aanschaffingswaarde. 🔗
> > 2. **Herberekening / analytische review van de waardering**: opvragen van de meest recente jaarrekening van de dochter (eigen vermogen × deelnemingspercentage), vergelijking met boekwaarde, beoordeling van noodzaak tot waardevermindering (art. 3:42 KB/WVV). 🔗
> > 
> > *Alternatieven*: externe confirmatie bij de dochter of bij de notaris (ISA 505), bevraging van het management (inquiry) over wijzigingen in de deelneming. 🤖
> > 
...
> 
> **Hoe voer je zo een controle uit, leg uit of werk een voorbeeld uit?**
> 
> > [!success]- Antwoord (klik om te openen)
> >
...
> > **Stappenplan**:
> > 
> > 1. Opvragen van de **detailbalans van rekening 454/9 per 31/12/2013** (saldo + samenstelling per debiteur/rubriek). 🔗
> > 2. Aansluiten met de onderliggende **loonstaten van december 2013** (bezoldigingen, bedrijfsvoorheffing, RSZ werknemer en werkgever, vakantiegeld, eindejaarspremie). 🔗
> > 3. **Afloopcontrole zelf**: voor elke component nagaan of, en wanneer, ze in 2014 effectief zijn betaald — via bankafschriften (januari-februari 2014), RSZ-aangifte DmfA Q4/2013 en betalingsbewijzen aan de RSZ, betalingsbewijzen bedrijfsvoorheffing (BV 274) aan de fiscus, betalingsbewijzen aan het sociaal secretariaat. 🔗
> > 4. **Vergelijken** van het betaalde bedrag met het geboekte schuldsaldo: aansluiting = bewijs van bestaan en (binnen materialiteit) juistheid van het saldo. 🔗
> > 5. **Verschillen** onderzoeken: ofwel reeds vóór 31/12 betaald (= dubbel geboekt), ofwel niet meer betaald (= geen schuld meer of voorziening nodig), ofwel pas later op te lossen (signaal voor incomplete provisionering). 🔗
> > 
> > Saldo rekening 454/9 per 31/12/2013: **48.500 EUR**, opgesplitst:
> > 
> > | Component | Geboekt saldo 31/12 | Effectief betaald (Jan-Feb 2014) | Bewijsstuk |
> > |---|---:|---:|---|
> > | RSZ Q4/2013 (werkgevers- + werknemersbijdrage) | 22.000 | 22.000 | DmfA Q4 + uittreksel RSZ-betaling 31/01/2014 |
> > | Bedrijfsvoorheffing december | 8.500 | 8.500 | aangifte 274 + bankuittreksel 15/01/2014 |
> > | Vakantiegeld werknemers (voorziening) | 12.000 | 11.800 | berekening conform Bull. CNC 90/3-6 (18,8 % bezoldigingen) — verschil 200 EUR is binnen toleratie |
> > | Eindejaarspremie + sociale lasten | 6.000 | 6.000 | bankuittreksel 31/01/2014 |
> > | **Totaal** | **48.500** | **48.300** | |
> > 
> > Conclusie van het voorbeeld: aansluiting binnen materialiteit (50.000 EUR), restant van 200 EUR op vakantiegeld is verklaarbaar via de forfaitaire berekening — geen verdere bevinding. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Vier soorten auditmethodes (controlewerkzaamheden om controle-informatie te verkrijgen volgens ISA 500):
> > 
> > 1. **Inspectie** — onderzoek van vastleggingen/documenten (intern of extern, op papier of elektronisch) of fysieke inspectie van een actief. 📖
> > 2. **Waarneming (observatie)** — het gadeslaan van een proces of procedure die door anderen wordt uitgevoerd, bv. waarnemen van de voorraadopname. 📖
> > 3. **Verzoek om inlichtingen (bevraging / inquiry)** — het inwinnen van informatie bij goed geïnformeerde personen binnen of buiten de entiteit, mondeling of schriftelijk. 📖
> > 4. **Herberekening** — het controleren van de rekenkundige juistheid van documenten of vastleggingen, manueel of geautomatiseerd. 📖
> > 
...
> > 
> > | Aard van het probleem | Materieel maar niet diepgaand | Materieel én diepgaand (*pervasive*) |
> > |---|---|---|
> > | **Afwijking** van materieel belang in de jaarrekening | Oordeel met voorbehoud | Afkeurend oordeel |
> > | **Reikwijdtebeperking** (onvoldoende geschikte controle-informatie) | Oordeel met voorbehoud | **Onthoudende verklaring** |
> > 
> > De onthoudende verklaring zit dus uitsluitend in de rechter-onderkolom: het probleem is een **scope-beperking** (geen afwijking) waarvan het effect zo doordringend is dat de auditor onmogelijk een onderbouwd oordeel kan vormen. 🔗
> > 
> > **Concrete trigger-situaties** (ISA 705 par. A8-A12, niet-limitatief): 🔗
> > 
> > - Omstandigheden **buiten de wil van de entiteit**: boekhoudkundige bescheiden zijn vernietigd (brand, cyberincident), of in beslag genomen door overheidsinstanties voor onbepaalde duur.
> > - Omstandigheden **eigen aan aard of timing van het werk**: de auditor kon de voorraadopname op balansdatum niet bijwonen en kan langs alternatieve weg de eindvoorraad niet bevestigen; deelneming bij een equity-methode-investee waarover onvoldoende informatie beschikbaar is.
> > - **Door het management opgelegde beperkingen** (par. 13-14): management weigert toegang tot personen, vestigingen, dochters of bescheiden — als deze beperking diepgaand effect kan hebben en niet via alternatieve werkzaamheden te overbruggen is, leidt dit normaliter tot terugtrekking of, bij onmogelijkheid daarvan, een oordeelonthouding.
> > - **Uitzonderlijk: meerdere onzekerheden** (ISA 705 par. 10) — zelfs wanneer voor elke afzonderlijke onzekerheid voldoende controle-informatie verkregen werd, kan de auditor in zeer zeldzame omstandigheden tot oordeelonthouding besluiten als het **cumulatieve effect** van meerdere onzekerheden samen het vormen van een oordeel onmogelijk maakt. 📖
> > 
> > **Onthoudende verklaring ≠ afkeurend oordeel.** Beide zijn *pervasive*-oordelen, maar de bron van het probleem is tegengesteld: 🔗
> > 
> > - **Onthouding**: auditor wéét niet (te weinig informatie → kan geen oordeel vormen). Gebruik bij **reikwijdtebeperking**.
> > - **Afkeurend**: auditor wéét wél, en wat hij ziet is fundamenteel fout (de jaarrekening geeft géén getrouw beeld). Gebruik bij **materiële afwijking** met diepgaand effect.
> > 
...
> > 
> > - **Onafhankelijkheidsbeginsel** — externe controle moet een onafhankelijke beoordeling zijn door iemand buiten de onderneming; de interne boekhouder is per definitie partij en geen externe bevestigingsbron. 🔗
> > - **Bewijswaarde van interne stukken** — controle-informatie uit de cliënt zelf is intern bewijs; ISA 500 geeft hoger gewicht aan extern bewijs (bv. bankbevestigingen, leveranciersbevestigingen) en aan eigen waarnemingen van de auditor (bv. de voorraadtelling van 2/12/2013). 📖
> > - **Sterke IC ≠ vrijstelling van substantieve controles** — een laag inherent en controle-risico verlaagt de omvang van de substantieve werkzaamheden, maar elimineert ze niet. De accountant moet de IC-werking eerst zelf toetsen (test of controls) vooraleer hij erop kan steunen, en blijft daarnaast substantief werken op materiële posten. 🔗
> > 
> > **Praktisch**: de cijfers van de interne boekhouder vormen het startpunt (proefbalans, grootboek), maar de accountant herrekent, herwaardeert en confronteert met onafhankelijke bronnen (bankafschriften, leveranciersbevestigingen, fysieke voorraadtelling, debiteurenconfirmaties). 🔗
> > 
...
> > 
> > - **Waardering** (gekozen) — voor landbouwmachines bijzonder relevant: het zijn duurzame en relatief illiquide goederen waarvan de markt­waarde kan dalen (technische veroudering, modeljaar-wissels, traag-roterende stock). Risico op overwaardering → noodzaak van een waardevermindering.
> > - Alternatieve doelstellingen die hier ook valide zijn: **eigendom** (zijn de machines effectief eigendom of staan ze in consignatie/financiering?), **cut-off** (zijn aan- en verkopen rond 30/11/2013 in de juiste periode geboekt?), **volledigheid** (zit alle voorraad op de lijst, ook machines bij klanten op proef of bij derden?).
> > 
> > **Techniek uitgewerkt** (prijsonderzoek voor waardering):
> > 1. Selecteer een steekproef van getelde machines uit de voorraadlijst.
> > 2. Toets de aanschaffingswaarde aan de meest recente aankoopfactuur (eenheidsprijs × hoeveelheid).
> > 3. Vergelijk die aanschaffingswaarde met de actuele verkoopprijs (catalogus, recente verkoopfacturen) minus eventuele afzetkosten → bepaal of een waardevermindering nodig is.
> > 4. Documenteer in werkdocument met verwijzing naar facturen. 🔗
> > 
...
> > 
> > Over die staat brengt een **commissaris**, of bij gebrek daaraan een door het bestuursorgaan aangewezen **bedrijfsrevisor of externe gecertificeerd accountant**, schriftelijk verslag uit aan de AV. De beroepsbeoefenaar (i) **beoordeelt** of de staat **getrouw, volledig en juist** de toestand van de vennootschap weergeeft conform het toepasselijke boekhoudkundig referentiestelsel en (ii) vermeldt **uitdrukkelijk** of er sprake is van overwaardering van activa of onderwaardering van passiva (art. 2:71, § 2, lid 3 WVV; ITAA-norm ontbinding-vereffening). 🔗
> > 
> > Het is dus geen *audit* in de zin van een wettelijke jaarrekeningcontrole, maar een **specifieke wettelijke controle-opdracht** met een eigen modelverslag (Bijlage 3 van de ITAA-norm). De opdracht **ontslaat het bestuursorgaan niet** van zijn eigen verantwoordelijkheid voor de staat. 📖
> > 
...
> > 
> > **Uitzondering = continuïteit**, maar enkel als het bestuursorgaan dat **uitdrukkelijk motiveert** in zijn verslag bij het ontbindingsvoorstel. Typische gevallen: (i) **overdracht van de bedrijfstak of het handelsfonds** waardoor de economische activiteit bij een derde wordt voortgezet, (ii) een **ontbinding zonder vereffening** (bv. fusie/splitsing wordt overwogen), (iii) een onmiddellijke sluiting (art. 2:80 WVV) waarbij alle schulden betaald of geconsigneerd zijn. 🔗
> > 
> > De ITAA-norm vereist dat de beroepsbeoefenaar in dat geval (i) **kennis neemt** van die motivatie en ze **bespreekt met het bestuursorgaan**, en (ii) inlichtingen inwint of er gebeurtenissen of omstandigheden bestaan die — afzonderlijk of collectief — **significante twijfel** doen ontstaan over de continuïteitsveronderstelling. Is die twijfel er, dan dwingt dat doorgaans terug naar discontinuïteit. 📖
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Drie correcties op de staat in het kader van de ontbinding:
> > 
> > 1. **Waardering machines A** — de herwaarderingsmeerwaarde van € 400.000 (op basis van DCF/nutswaarde € 600.000) is een going-concern-waardering en niet aanvaardbaar in de discontinuïteitsoptiek van een ontbindingsstaat (KB WVV art. 3:6 § 2). De machines moeten naar **realisatiewaarde**: bod leverancier € 450.000 minus de noodzakelijke revisie € 10.000 = **€ 440.000**. De herwaarderingsmeerwaarde van € 400.000 wordt geheel teruggenomen en de boekwaarde naar boven aangepast tot € 440.000. 🔗
> > 2. **Voorzieningen voor sluitings- en vereffeningskosten** ontbreken volledig — bij overgang naar discontinuïteit moeten notariële kosten, kosten van de bedrijfsrevisor/accountant, vereffenaarsvergoedingen, opzegvergoedingen personeel en latente belastingen op gerealiseerde meerwaarden als **voorziening voor risico's en kosten** worden opgenomen (KB WVV art. 3:6 § 2). 🔗
> > 3. **Herklassering van langlopende schulden** — bij discontinuïteit worden alle schulden opeisbaar. De *Schulden > 1 jaar* van € 250.000 moeten worden geherklasseerd naar *Schulden < 1 jaar* (KB WVV art. 3:6 § 2). 🔗
> > 
> > De staat blijft *altijd* in evenwicht ondanks de correcties: het verschil loopt via de **resultatenrekening** (terugname herwaarderingsmeerwaarde, opname voorziening, eventuele waardevermindering). Cijfermatig in deze casus: machines op realisatiewaarde € 440.000 ⇒ totaal actief van € 720.000 zakt naar € 560.000 (terugname HW € 400.000 + opwaartse aanpassing oude boekwaarde € 200.000 → € 440.000). Dit moet aan passiefzijde via een aangepast resultaat van de periode en het verdwijnen van de rubriek **herwaarderingsmeerwaarde** op passief (€ 400.000). 🔗
> > 
...
> > - nagaan of de waarderingsregels (discontinuïteit, art. 3:6 § 2 KB WVV) correct werden toegepast;
> > - inlichtingen inwinnen bij het bestuursorgaan;
...
> > 
> > 1. **Geen vereffenaar aangeduid.** 📖
> > 2. **Alle schulden t.a.v. derden zijn terugbetaald of de nodige gelden zijn geconsigneerd**; de commissaris/bedrijfsrevisor/GA bevestigt dit in de conclusies van zijn verslag. Schulden t.a.v. aandeelhouders die schriftelijk afstand doen of waarvan de schuldvordering in de staat wordt opgenomen, zijn vrijgesteld van die betaling/consignatie. 📖
> > 3. **Alle vennoten/aandeelhouders zijn aanwezig of vertegenwoordigd** op de AV en beslissen **eenparig** tot sluiting. 📖
> > 4. Het resterende actief wordt overgenomen door de vennoten/aandeelhouders zelf. 🔗
> > 
> > **Toepassing op HOLDING RICH**: de derdenschulden (€ 80.000 KT — zonder verdere precisering — en € 250.000 LT) overstijgen ruimschoots de liquide middelen (€ 20.000). Tenzij zaakvoerders/aandeelhouders eerst extra fondsen inbrengen om de schulden te voldoen of te consigneren, **kan de procedure-in-één-akte niet doorgaan** en is een klassieke vereffening met aanstelling van een vereffenaar vereist (art. 2:79 WVV e.v.). 🔗
> > 
...
> > - **Regel**: het **bestuursorgaan** is verantwoordelijk voor het opstellen van de staat van activa en passiva, in overeenstemming met het Belgische boekhoudkundig referentiestelsel, evenals voor het verslag dat het voorstel tot ontbinding toelicht (art. 2:71 § 2 WVV; ITAA-norm ontbinding-vereffening, §§ 1 en § Verantwoordelijkheden van het bestuursorgaan). 📖
> > - **Wat moet er gebeuren**: de zaakvoerder(s) moeten de staat zelf vaststellen en ondertekenen vóór ze aan de accountant wordt overhandigd; een interne boekhouder kan voorbereiden, niet ondertekenen namens het orgaan. De accountant kan zijn opdracht pas correct uitvoeren op een door het bestuursorgaan goedgekeurde staat. 🔗
> > 
> > **Opmerking 2 — Tijdige terbeschikkingstelling van de stukken.**
> > - **Fout**: het controleverslag is opgesteld op 14/04/2013, één dag vóór de AV van 15/04/2013. 📖
> > - **Regel**: het verslag van het bestuursorgaan en het verslag van de beroepsbeoefenaar over de staat van activa en passiva moeten **vijftien dagen vóór de algemene vergadering** ter beschikking liggen van de aandeelhouders, samen met of na de oproeping (art. 2:71 § 2 jo. art. 5:62 en 5:76 WVV; CBN-advies 2022/04). 🔗
> > - **Wat moet er gebeuren**: de AV uitstellen tot de stukken minstens 15 dagen ter beschikking liggen, of — indien alle aandeelhouders aanwezig of vertegenwoordigd zijn en uitdrukkelijk **verzaken** aan de termijn — de verzaking expliciet in de notuliën opnemen. In casu kan niet verzaakt worden: de 10%-vennoot is afwezig. 🔗
> > 
> > **Opmerking 3 — Verzoek tot verdaging door 10%-vennoot.**
> > - **Fout / vraag**: een aandeelhouder met 10% vraagt aan de zaakvoerders om de AV met drie weken te verdagen wegens verblijf in het buitenland. 📖
> > - **Regel**: een individuele 10%-vennoot heeft onder het WVV (BV) **wel** het recht om een **bijeenroeping** te vragen of agendapunten toe te voegen (art. 5:62 § 1 WVV), maar **geen recht op verdaging** van een reeds samengeroepen AV. Het bestuursorgaan kan tijdens de zitting de beslissing over de **goedkeuring van de jaarrekening** drie weken uitstellen (art. 5:78 WVV), maar dat geldt niet voor een ontbindingsbesluit. De verdaging tot vijf weken bij belangrijke deelnemingen (art. 7:118 WVV) is een NV-bepaling die hier niet speelt. 🔗
> > - **Wat moet er gebeuren**: de zaakvoerders **mogen** het verzoek inwilligen — dat is een opportuniteitskeuze, geen verplichting. Weigeren mag: de vennoot kan zich laten vertegenwoordigen door een **schriftelijke volmacht** (art. 5:79 WVV). De vergadering kan geldig doorgaan met de overige aandeelhouders zolang het aanwezigheids- en meerderheidsquorum voor de ontbinding (helft van het kapitaal aanwezig of vertegenwoordigd, en **4/5 van de uitgebrachte stemmen**, art. 5:84 WVV) wordt gehaald. Met 90% aanwezig is dat haalbaar. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Drie elementen die minimaal in de opdrachtbrief moeten voorkomen (ITAA-norm omzetting, par. 19):
> > 
> > 1. **Identificatie van de beroepsbeoefenaar en zijn hoedanigheid** — commissaris, bedrijfsrevisor of gecertificeerd accountant. 📖
> > 2. **Beschrijving van de opdracht** — doelstelling en reikwijdte, opstelling van een schriftelijk verslag over de staat van activa en passiva (al dan niet overgewaardeerd nettoactief), verwijzing naar art. 14:4 of 14:21 WVV en naar de toepasselijke norm. 📖
> > 3. **Verantwoordelijkheden van beide partijen** — die van de beroepsbeoefenaar (nazicht omzettingsvoorstel, verslag over de staat van activa en passiva, oordeel over overwaardering nettoactief) én die van het bestuursorgaan (opstelling van de staat van activa en passiva, ter beschikking stellen van informatie). 📖
> > 
...
> > De keten:
> > 
> > - Het bestuursorgaan beslist tot vrijwillige ontbinding en stelt een **staat van activa en passiva** op, gedateerd **maximaal drie maanden** voor de buitengewone algemene vergadering die over de ontbinding besluit. 📖
> > - De externe accountant (of bedrijfsrevisor / commissaris) **controleert deze staat** en levert een verslag — dit is het door de vennootschapswet opgelegde en openbaar te maken controleverslag bedoeld in de vraag. 📖
> > - Bestuursverslag + accountantsverslag + staat van actief/passief worden meegedeeld aan de aandeelhouders **samen met de oproeping** tot de BAV en zijn vijftien dagen vóór de vergadering ter zetel kosteloos verkrijgbaar (art. 5:83 / 7:128 e.v. WVV; oud art. 269 W.Venn.). 🔗
> > - Voor de **kopie aan het Instituut** (ITAA, vroeger IAB) geldt de algemene plichtenleer-regel voor openbaar te maken controleverslagen: **binnen één maand** na ondertekening van het verslag toezenden. ❓ Deze termijn staat niet expliciet in de geraadpleegde wettekstbundel of ITAA-norm ontbinding/vereffening — verifieer in de actuele ITAA-deontologie / circulaires. ❓
> > 
...
> > De keten:
> > 
> > - Het bestuursorgaan stelt een **staat van activa en passiva** op, vastgesteld op een datum die **niet meer dan drie maanden teruggaat** vóór de algemene vergadering die zich over de omzetting moet uitspreken. 📖
> > - De commissaris, bedrijfsrevisor of gecertificeerd accountant brengt een **verslag uit over deze staat**, waarin hij inzonderheid aangeeft of het nettoactief werd overgewaardeerd (art. 14:3-14:4 WVV; bij omzetting naar VZW: art. 14:32 WVV). 📖
> > - Een **kopie van dit verslag** wordt samen met het bestuursverslag en het ontwerp van statutenwijziging aan de aandeelhouders meegedeeld **samen met de oproeping** tot de AV (art. 14:6 WVV / oud art. 778 W.Venn.). 📖
> > - Voor de **kopie aan het ITAA**: zelfde algemene plichtenleer-regel als bij vereffening — **binnen één maand** na ondertekening van het verslag. ❓ Termijn niet expliciet in de geraadpleegde bronnen — verifieer in ITAA-deontologie. ❓
> > 
