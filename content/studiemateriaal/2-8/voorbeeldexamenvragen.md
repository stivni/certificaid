...
# 2.8 Voorbeeldexamenvragen Europees en internationaal fiscaal recht
...
> [!question]- OESO-modelverdrag: juist/niet waar stellingen over internationale belastingregels
...
> [!question]- EU-fusierichtlijn 2009/133/EG: toepassing op overname door ivzw
> *Examen 2015-1 · PO 2.8*
>
> Ivzw met maatschappelijke zetel in België wenst een caritatieve vzw gevestigd in Spanje (met waardevolle landeigendommen) over te nemen. Na de verrichting: ivzw beschikt naast hoofdzetel in België ook over uitbatingszetel in Spanje. De overname zou in Spanje aanleiding geven tot belastingheffing over meerwaarden op onroerende goederen.
> 
> **Vraag: is toepassing van richtlijn 2009/133/EG mogelijk met vrijstelling van belasting?**
>
> <span class="jf-badge">Juist of fout?</span><span class="jf-stelling">Kan deze transactie met toepassing van richtlijn 2009/133/EG van de Raad van 19 oktober 2009 uitgevoerd worden met vrijstelling van belasting?</span>
> 
> > [!success]- Antwoord (klik om te openen)
> >
> > **Antwoord: Fout**
...
> > 
> > - (a) een **rechtsvorm vermeld in bijlage I, deel A** (lijst van vennootschapsvormen per lidstaat — NV/SA, BV/SRL, CV/SC, SE, SCE, enz.); 📖
> > - (b) fiscale **woonplaats in een lidstaat** (en niet, op grond van een dubbelbelastingverdrag met een derde land, geacht buiten de EU gevestigd te zijn); 📖
> > - (c) **onderworpen aan een vennootschapsbelasting** uit de lijst in bijlage I, deel B (voor België: vennootschapsbelasting / impôt des sociétés; voor Spanje: impuesto sobre sociedades), zonder keuzemogelijkheid en zonder vrijstelling. 📖
> > 
> > **Toepassing op de casus**:
> > 
> > - De **ivzw naar Belgisch recht** is een *vereniging* (boek 10 WVV), geen vennootschap. Haar rechtsvorm staat **niet** in bijlage I, deel A. Bovendien is een ivzw in de regel onderworpen aan de **rechtspersonenbelasting** (art. 220 WIB 92), niet aan de vennootschapsbelasting vermeld in bijlage I, deel B — voorwaarde (c) faalt dus eveneens. 🔗
> > - De **caritatieve vzw naar Spaans recht** is evenmin een in bijlage I, deel A genoemde rechtsvorm en is als non-profit doorgaans niet onderworpen aan de Spaanse impuesto sobre sociedades op de wijze die de richtlijn vereist. 🔗
> > 
> > Doordat aan minstens twee van de drie cumulatieve voorwaarden van art. 3 niet is voldaan, valt de verrichting **buiten het toepassingsgebied** van de richtlijn. De fiscale neutraliteit (uitstel van belastingheffing over meerwaarden op overgedragen activa, zoals de Spaanse onroerende goederen) kan niet op de richtlijn worden gestoeld; de Spaanse interne fiscale wet bepaalt dan of er belasting verschuldigd is. 🔗
> > 
...
> [!question]- Internationaal belastingrecht — vaste inrichting en OESO-modelovereenkomst: verliesaftrek en globale winst
> *Examen 2014-1 · PO 2.8*
>
...
> > | Post | Bedrag |
> > |---|---:|
> > | Belgische winst | +2.000 |
> > | VI Italië verlies | -1.000 |
> > | Globaal (boekhoudkundig) resultaat | 1.000 |
> > | Aanrekening verlies VI (art. 206/4 WIB 92): verlies in verdragsland → eerst op andere landen-winst → bij ontoereiken op Belgische winst | -1.000 op Belgische winst |
> > | **Belgische belastbare grondslag jaar 1** | **1.000** |
> > 
> > Het Italiaanse VI-verlies van 1.000 wordt in jaar 1 fiscaal aangerekend op de Belgische winst, omdat er geen andere verdrags-vrijgestelde winst was om het op te zetten (art. 206/4 WIB 92). 📖
> > 
> > **Jaar 2** — recapture en globalisatie:
> > 
> > | Post | Bedrag |
> > |---|---:|
> > | Belgische winst | +2.000 |
> > | VI Italië winst | +1.000 |
> > | Boekhoudkundige (wereldwijde) winst | 3.000 |
> > | Recapture: het in jaar 1 op de Belgische winst aangerekende VI-verlies wordt nu "teruggehaald" — de VI-winst van jaar 2 wordt eerst aangewend om dat verlies te recupereren en is in die mate **niet vrijgesteld** | +1.000 (niet-bij-verdrag-vrijgestelde winst) |
> > | **Belgische belastbare grondslag jaar 2** | **2.000 + 1.000 = 3.000 belastbaar in BE-tarief**, maar in de globale aangifte wordt de VI-winst eerst toegevoegd (4.000) en pas daarna de bij-verdrag-vrijgestelde fractie afgetrokken |
> > 
> > Mechaniek volgens de Belgische aangifte (art. 206/4 WIB 92 + commentaar): de wereldwijde winst 3.000 wordt globaal aangegeven; daarna wordt de VI-winst van 1.000 die nodig is om het in jaar 1 verrekende verlies te "recupereren" als **niet-vrijgestelde** buitenlandse winst behandeld (geen tweede aftrek toegestaan voor wat reeds in jaar 1 als verlies werd genoten). Pas wanneer in een volgend jaar de VI nog méér winst maakt dan het cumulatieve eerder verrekende verlies, wordt het surplus vrijgesteld. 🔗
> > 
> > Netto-effect over de twee jaren: jaar 1 belast op 1.000 + jaar 2 belast op 3.000 = **4.000** Belgisch belastbaar over twee jaar, terwijl de cumulatieve wereldwijde winst 1.000 + 3.000 = 4.000 bedraagt. De recapture neutraliseert dus enkel het tijdelijke voordeel dat België in jaar 1 verleende. 🔗
> > 
...
> > 
> > 1. **Woonstaatbeginsel + bronstaatuitzondering voor VI's** (art. 7 §1 OESO): ondernemingswinsten zijn principieel belastbaar in de woonstaat (België), tenzij er een vaste inrichting in de bronstaat (Italië) is — dan mag Italië belasten wat aan die VI toerekenbaar is. 📖
> > 
> > 2. **Vrijstellingsmethode (exemption with progression)** — art. 23 A OESO: het verdrag België-Italië volgt de vrijstellingsmethode. België stelt de Italiaanse VI-winst principieel vrij van Belgische vennootschapsbelasting; in ruil belast Italië die VI-winst. Doel: dubbele belasting vermijden. 🔗
> > 
> > 3. **Globale-winst-beginsel van de woonstaat** (intern Belgisch recht, art. 206/4 WIB 92, niet door het verdrag verboden): België vertrekt voor de aangifte altijd van de **wereldwijde winst** (Belgisch + buitenlands) en past pas daarna de toewijzingsregels toe. Verliezen in een verdragsland worden in eerste instantie aangerekend op winst uit andere landen — dit is een **interne** Belgische volgorde die het OESO-verdrag onaangetast laat. 📖
> > 
> > 4. **Recapture-beginsel (terugname van eerder benut verlies)**: omdat het VI-verlies van jaar 1 (1.000) effectief de Belgische belastbare grondslag heeft verlaagd, mag België in een later jaar **niet tweemaal** voordeel laten ontstaan. Wanneer de VI weer winstgevend wordt, wordt het deel van de VI-winst dat overeenkomt met het eerder verrekende verlies **niet vrijgesteld** (1.000 in jaar 2), totdat het verlies volledig gerecupereerd is. Pas surplus daarboven valt opnieuw onder de verdragsvrijstelling. 🔗
> > 
> > **Toepassing op de casus:**
> > - Jaar 1: Italiaanse VI-verlies 1.000 wordt aangerekend op Belgische winst 2.000 → BE belast op 1.000. Italië heft niets (verlies).
> > - Jaar 2: Italiaanse VI-winst 1.000 wordt door Italië belast (art. 7 OESO — bronstaatheffing). België vertrekt van de wereldwijde winst 3.000; van die wereldwijde winst is 1.000 VI-winst **niet vrijgesteld** wegens recapture (cfr. jaar 1) → BE belastbare grondslag = 2.000 (BE) + 1.000 (recapture) + 1.000 (VI-winst die wel in de aangifte komt vóór toepassing van de drie-oorsprongen-aftrek) = 4.000 vóór de definitieve vrijstellingsaftrek. Netto blijft de Belgische heffing beperkt tot 3.000 (2.000 BE + 1.000 recapture), maar in de aangifte verschijnt 4.000 als wereldwijd resultaat vóór vrijstelling. 🔗
> > 
> > Het ogenschijnlijke verschil (boekhoudkundige winst 3.000 versus belastbare aangifte 4.000) is dus geen schending van het verdrag, maar het logische gevolg van de combinatie van: globaal-winst-aangifte (BE) + vrijstellingsmethode (OESO art. 23 A) + recapture van eerder genoten verlies-aftrek (intern recht). 🔗
> > 
...
> [!question]- Fusie-richtlijn — aftrekbaarheid fiscale verliezen Belgische vennootschap na overname door Duitse vennootschap
> *Examen 2014-1 · PO 2.8*
>
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Beoordeling per scenario:
> > 
> > | # | Scenario | Antwoord |
> > |---|---|---|
> > | 1 | Uitsluitend op de in België verwezenlijkte winsten, volgens de Belgische fusieregels | **Ja** 🔗 |
> > | 2 | Op de winsten van de Duitse overnemende vennootschap, ongeacht waar verwezenlijkt (B of D) | **Neen** 🔗 |
> > | 3 | Op de winsten van de Duitse overnemende vennootschap die in Duitsland worden verwezenlijkt | **Neen** 🔗 | 🔗
> > 
> > Kernidee: de Fusierichtlijn dwingt **België als lidstaat van de inbrengende vennootschap** om zijn binnenlandse regels inzake verliesovername toe te passen op de **Belgische vaste inrichting** van de Duitse overnemende vennootschap die na de fusie ontstaat. De verliezen blijven dus 'gevangen' op Belgisch grondgebied — ze kunnen enkel worden afgezet tegen winsten van die Belgische vaste inrichting (Belgisch heffingsbevoegdheidsgebied), volgens de Belgische fusieregels. 🔗
> > 
> > - **Scenario 1 — Ja**: dit is precies het mechanisme van art. 6 Richtlijn 2009/133/EG: de verliesovername gebeurt onder de Belgische regels (art. 206, §2 WIB92 — fusieneutraliteit + verliesbeperking pro rata fiscaal netto-actief), maar enkel ten belope van de winsten gerealiseerd door de Belgische vaste inrichting van de Duitse overnemer. 🔗
> > - **Scenario 2 — Neen**: de Duitse winst van de overnemer valt buiten de Belgische fiscale jurisdictie; België mag haar verliezen niet 'meegeven' naar Duitsland. De richtlijn vereist alleen dat verliezen op Belgisch grondgebied bruikbaar blijven. 🔗
> > - **Scenario 3 — Neen**: idem — Duits-bronwinst kan niet door Belgische verliezen worden afgezet. Duitsland is bovendien niet verplicht deze Belgische verliezen te aanvaarden (territorialiteitsbeginsel). 🔗
> > 
...
> > 
> > **Mechanisme van art. 6** (twee cumulatieve voorwaarden):
> > 1. **België moet voor zuiver-binnenlandse fusies** een verliesovername-regime toelaten (cf. art. 206, §2 WIB92 — herstructureringsneutraliteit met pro-rata-beperking op basis van fiscaal netto-actief). 🔗
> > 2. **Bij grensoverschrijdende fusie** is België verplicht datzelfde regime uit te breiden naar de **Belgische vaste inrichting** van de Duitse overnemende vennootschap — als die hier door de fusie ontstaat. 📖
> > 
> > **Gevolg**: de fiscale verliezen volgen het Belgisch belastbaar substraat, niet de zetel van de overnemer. Ze kunnen dus uitsluitend benut worden tegen Belgische winsten van de Belgische vaste inrichting, volgens de Belgische fusieregels (scenario 1 = Ja). De richtlijn geeft geen aanspraak op verliesoverdracht naar Duitsland (scenario's 2 en 3 = Neen) — Duitsland mag, maar moet niet, deze verliezen toelaten op grond van het eigen recht (in de praktijk doet Duitsland dat niet, want § 8c KStG / territorialiteitsbeginsel). 🔗
> > 
...
> [!question]- Italiaans bijkantoor: verwerking verlies/winst in Belgische Ven.B en dubbelbelastingverdrag
...
> > 
> > 1. Het bijkantoor voldoet aan art. 5, lid 2, b) OESO-MV ("a branch") — voorwaarden vervuld (vaste bedrijfsinrichting met volledige verkoopcyclus). 📖
> > 2. Onder art. 7, lid 1 OESO-MV mogen ondernemingswinsten toerekenbaar aan de vaste inrichting belast worden door de bronstaat (Italië). 📖
> > 3. België vermijdt de dubbele belasting door **vrijstelling met progressievoorbehoud** (art. 23A OESO-MV; in het feitelijke BE-IT-verdrag is dit de gangbare methode). 📖
> > 4. Voor de aangifte VenB 2012: het wereldwijd resultaat (BE-winst min IT-verlies) is positief en kleiner dan de BE-winst alleen → de Belgische belastbare grondslag wordt verminderd ten belope van het Italiaanse verlies. 🔗
> > 
> > **Stappen — boekjaar 2013**:
> > 
> > 1. Italiaans resultaat 2013 = positief; in beginsel vrijgesteld via art. 23A OESO-MV → afzondering bij "bij verdrag vrijgestelde winst" in de driesplitsing (huidige codes 1433/1419/1430 — destijds vak III van de aangifte). 🔗
> > 2. **Recapture (art. 185, § 3 WIB 92)** — voor zover een buitenlands verlies in een vorig belastbaar tijdperk in mindering werd gebracht van de Belgische winst, wordt de latere verdragwinst niet meer vrijgesteld tot dat beloop. 🔗
> > 3. Resultaat: in 2013 wordt de Italiaanse bijkantoor-winst in België belast tot beloop van het 2012-verlies; het saldo (winst 2013 − teruggenomen verlies 2012) blijft vrijgesteld. ❓ — zie nuance hieronder. 🔗
> > 
> > **Tijdslijn art. 185, § 3 WIB 92** — de recapture-regel voor buitenlandse verliezen verbonden aan een via verdrag vrijgestelde vaste inrichting werd op zijn huidige vorm gebracht door de Wet van 11 december 2008 (omzetting Fusierichtlijn) en geldt voor verliezen geleden vanaf aanslagjaar 2010. In 2013 was de regel dus reeds van toepassing — het examen veronderstelt dit kader impliciet. Op verdragniveau steunt de recapture daarnaast op de **Velasquez-doctrine** (HvJ 15 mei 2008, C-414/06, *Lidl Belgium* en HvJ 23 oktober 2008, C-157/07, *Krankenheim Ruhesitz*): de vrijstelling mag worden hersteld wanneer het verlies in de bronstaat alsnog wordt verrekend. ❓
> > 
...
> > 
> > - In 2012 hebben de bestaande VA waarschijnlijk de Belgische **enkelvoudige** winst gedekt; door de verliesimputatie was de werkelijke belasting lager → mogelijk **teveel** betaalde VA (terugbetaalbaar of overdraagbaar). 🔗
> > - In 2013 doet zich het omgekeerde voor: door de recapture van het 2012-verlies wordt het Italiaans winst-aandeel tot dat beloop **belastbaar in België**, **bovenop** de overige Belgische winst. De VA voor 2013, geraamd zonder bijkantoor, zijn dan **structureel ontoereikend**. 🔗
> > - Gevolg zonder bijsturing: **vermeerdering wegens onvoldoende voorafbetalingen** (art. 218 § 1 WIB 92 j° art. 157-168 WIB 92) — de fictieve aanslag wordt verhoogd met een percentage afhankelijk van het tekort en het kwartaal. 🔗
> > 
> > **Toerekening — waarom monitoren?**
> > 
> > - Art. 7, lid 2 OESO-MV legt het **separate enterprise** / arm's length-beginsel op voor de winsttoerekening aan de PE.
> > - Bij divergerende toerekening tussen IT en BE kan een conflict ontstaan over hoeveel winst aan IT wordt toegerekend (en dus in BE vrijgesteld of teruggenomen). Goede transfer-documentatie en consistente analytische boekhouding van het bijkantoor zijn essentieel. 🔗
> > 
...
> [!question]- Woonstaatheffing Luxemburg: aangifte in België en terugbetaling overschot
> *Examen 2013-2 · PO 2.8*
>
...
> > 
> > 1. **Aangifteplicht** — Art. 313 WIB92: een rijksinwoner moet roerende inkomsten enkel níet aangeven wanneer er in België daadwerkelijk bevrijdende RV werd ingehouden. De Luxemburgse bank houdt geen Belgische RV in, dus de bruto-interesten moeten worden opgenomen in de aangifte (vak VII — inkomsten van kapitalen). 📖
> > 2. **Belastingtarief** — De aangegeven buitenlandse interesten worden in 2013 afzonderlijk belast tegen 25 % (art. 171, 2°ter WIB92, tarief inkomsten 2013), te verhogen met de aanvullende gemeentebelasting. 🔗
> > 3. **Verrekening van de woonstaatheffing** — Onder de Spaarrenterichtlijn 2003/48/EG (in voege tot 2015) hield Luxemburg, dat overgangsregeling met bronheffing toepaste, in 2013 een woonstaatheffing van **35 %** in en stortte 75 % daarvan door naar België; voor de spaarder is de heffing volledig verrekenbaar met de Belgische belasting **en bij overschot terugbetaalbaar** (art. 14 Richtlijn 2003/48/EG, omgezet in art. 22ter WIB92). 🔗
> > 
...
> [!question]- Inkomstenbelasting grensoverschrijdende tewerkstelling: OESO-Modelverdrag
...
> > |---|---|---|---|---|
> > | 3 dagen/week | België (woonstaat) | Belgische vennootschap | Art. 15 §1, 1ste zin: arbeid in woonstaat ⇒ uitsluitend woonstaat | **BE** 📖 |
> > | 1 dag/week | Frankrijk | Belgische venn., maar loon doorgerekend aan Franse vaste inrichting | Art. 15 §1, 2de zin + §2 c) niet vervuld (loon gedragen door VI in werkstaat) ⇒ werkstaat mag heffen | **FR** + BE (vrijstelling met progressievoorbehoud) 🔗 |
> > | 1 dag/week | Duitsland | Duitse dochter, aparte arbeidsovereenkomst | Art. 15 §1, 2de zin + §2 b) niet vervuld (werkgever is inwoner van werkstaat) ⇒ werkstaat mag heffen | **DE** + BE (vrijstelling met progressievoorbehoud) 🔗 | 🔗
> > 
> > **Vertrekpunt — woonstaatbeginsel (art. 4 OESO-MV).** De heer B. is fiscaal inwoner van België; België belast hem in principe op zijn wereldwijde inkomen (art. 5 WIB92). 📖
> > 
> > **Art. 15 §1 OESO-MV — basisregel niet-zelfstandige arbeid.** Lonen zijn **uitsluitend belastbaar in de woonstaat**, *tenzij* de dienstbetrekking in de andere verdragsstaat wordt uitgeoefend; in dat geval mag *die andere staat* (de werkstaat) heffen op het loon dat slaat op de daar uitgeoefende arbeid. 📖
> > 
> > **Stap 1 — 3 dagen in België (woonstaat = werkstaat).** Arbeid wordt in de woonstaat uitgeoefend → de uitzondering speelt niet → **enkel BE heft**. 🔗
> > 
> > **Stap 2 — 1 dag in Frankrijk.** De arbeid wordt in FR uitgeoefend, dus FR mag in principe heffen (art. 15 §1, 2de zin). De uitzondering van **art. 15 §2 OESO-MV (183-dagenregel)** geeft de heffing terug aan de woonstaat **enkel als de drie voorwaarden cumulatief vervuld zijn**: (a) ≤ 183 dagen/12 mnd in werkstaat, (b) werkgever is geen inwoner van werkstaat, (c) loon wordt **niet gedragen door een vaste inrichting** van de werkgever in de werkstaat. Hier is voorwaarde (c) geschonden — de Belgische vennootschap rekent het loon door aan haar **Franse vaste inrichting** — dus de §2-uitzondering valt weg en **FR behoudt zijn heffingsbevoegdheid** op 1/5 van het loon. 🔗
> > 
> > **Stap 3 — 1 dag in Duitsland.** Voor de Duitse werkdag sluit B. een **afzonderlijke arbeidsovereenkomst met de Duitse dochtervennootschap**. De werkgever in de zin van art. 15 §2 b) is dan de Duitse dochter (inwoner van DE) — voorwaarde (b) is geschonden — dus §2 speelt niet en **DE belast** 1/5 van het loon. 🔗
> > 
> > **Stap 4 — vermijding dubbele belasting in België.** Onder de DBV's BE-FR (1964, aangepast) en BE-DE (1967) past België voor lonen de **vrijstellingsmethode met progressievoorbehoud** toe: de in FR/DE belastbare loondelen worden in BE vrijgesteld, maar meegerekend om het *tarief* op het overblijvende Belgische loondeel te bepalen. 🔗
> > 
...
> [!question]- Toepasselijkheid Moeder-dochterrichtlijn en Interest-royaltyrichtlijn: Belgisch-Hongaarse situatie
> *Examen 2013-1 · PO 2.8*
>
...
>
> <span class="jf-badge">Juist of fout?</span><span class="jf-stelling">Is de Moeder-dochterrichtlijn van toepassing op de beschreven situatie?</span>
> 
> > [!success]- Antwoord (klik om te openen)
> >
> > **Antwoord: Fout**
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Moeder-dochterrichtlijn (2011/96/EU).** De richtlijn schakelt bronbelasting op grensoverschrijdende dividenden binnen de EU uit, maar enkel binnen een moeder-dochterverhouding zoals omschreven in art. 3. Die verhouding vereist een **minimumdeelneming van 10 % in het kapitaal** (art. 3, lid 1, a), i)). 📖 Bovendien mogen lidstaten een **minimale aanhoudperiode van twee jaar** opleggen (art. 3, lid 2, b)). 📖 De Belgische NV bezit 3 % — onder de drempel — zodat zij niet de hoedanigheid van moedermaatschappij heeft en de vrijstelling van bronbelasting op de in 2012 geïnde dividenden van art. 5 niet kan inroepen. Hongarije mag dus zijn nationale bronheffing toepassen (onverminderd het Belgisch-Hongaars dubbelbelastingverdrag, dat in dit geval de relevante rechtsbron blijft). 🔗
> > 
> > **Interest-royaltyrichtlijn (2003/49/EG).** Deze richtlijn schakelt bronbelasting uit op uitkeringen van interest en royalty's tussen **verbonden ondernemingen** van verschillende lidstaten (art. 1). 📖 De definitie van "verbonden onderneming" in art. 3, b) vereist een **rechtstreekse kapitaaldeelneming van ten minste 25 %** in één van de drie configuraties: top-down, bottom-up of via een gemeenschappelijke moeder-onderneming. 📖 In de casus zijn de twee vennootschappen enkel "verbonden" via natuurlijke personen (de cliënt en zijn schoonbroer zijn schoonbroers — geen verbondenheid van ondernemingen) en via een 3 %-deelneming. Geen van beide volstaat. De richtlijn is dus niet van toepassing op de in 2010 toegestane lening en Hongarije mag op de interesten de nationale bronheffing inhouden. 🔗
> > 
