...
# 1.7 Voorbeeldexamenvragen Interne controle
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Accountingcontrole** (boekhoudkundige controle) bewaakt de **juistheid, volledigheid en tijdigheid van de boekhouding zelf** — alle controles die zorgen dat transacties correct, in de juiste periode en op de juiste rekening in de boeken belanden. **Administratieve controle** bewaakt de **rechtmatigheid, doelmatigheid en betrouwbaarheid van de administratieve processen** rond de transactie — autorisaties, functiescheiding, procedure-naleving — vóór ze de boekhouding bereiken. 🔗
> > 
> > **Voorbeelden**:
> > 
> > - **Accountingcontrole**: maandelijkse **bank-grootboekreconciliatie** — het saldo van rekening 550 wordt afgestemd met het bankuittreksel; verschillen worden opgespoord en gecorrigeerd. Andere voorbeelden: aansluitingscontrole klanten-grootboek met individuele klantenrekeningen, controle op tellingen van dagboeken, periode-afgrenzing (cut-off) bij jaareinde. 🔗
> > - **Administratieve controle**: **drie-weg-match in de inkoopcyclus** — bestelbon, leveringsbon en factuur worden vergeleken op hoeveelheid en prijs vóór betaling wordt vrijgegeven. Andere voorbeelden: autorisatiematrix voor uitgaven boven een grens, functiescheiding tussen wie bestelt, wie ontvangt en wie betaalt, vier-ogen-principe bij contractondertekening. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > **Preventieve controle** stopt fouten of fraude **vóór** ze in de boekhouding of het proces ontstaan — ze staat op het transactiepad en blokkeert. **Repressieve controle** (≈ detecterende controle) ontdekt fouten of fraude **nadat** ze zijn opgetreden, zodat ze kunnen worden gecorrigeerd en de oorzaak weggenomen. 📖
> > 
> > **Voorbeelden**:
> > 
> > - **Preventieve controle**: **functiescheiding in de inkoopcyclus** — de magazijnier ontvangt en boekt de levering, de boekhouder registreert de factuur, de zaakvoerder geeft de betaalopdracht. Geen enkele persoon kan alleen een fictieve aankoop én betaling realiseren. Andere voorbeelden: autorisatie van bestellingen boven € 5.000 door de CEO, ERP-blokkade bij prijs boven 110 % van de standaardlijst, toegangsbeveiliging tot het kasregister. 📖
> > - **Repressieve controle**: **maandelijkse bank-grootboekreconciliatie** — de boekhouder stemt het saldo van rekening 550 af met het bankuittreksel; onverklaarbare verschillen worden onderzocht. Andere voorbeelden: jaarlijkse fysieke voorraadtelling met aansluiting op het magazijnboek, exceptie-rapporten met prijswijzigingen boven 3 %, interne audit-review achteraf. 📖
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Vier controletechnieken op de goederen in het magazijn:
> > 
> > 1. **Fysieke inspectie en bijwonen van de voorraadopname** — de interne controleur woont de fysieke telling bij, inspecteert de goederen (bestaan, conditie, courant/incourant) en voert eigen **tellingen ter toetsing** uit (twee richtingen: van vloer naar voorraadlijst = volledigheid; van voorraadlijst naar vloer = bestaan). 📖
> > 2. **Waarneming (observatie)** — gadeslaan of het magazijnpersoneel de telinstructies en procedures voor ontvangst, uitslag en opslag correct uitvoert (toegangscontrole, scanning, gescheiden zones voor goedgekeurde vs. geblokkeerde voorraad). 📖
> > 3. **Navraag bij magazijn- en logistieke verantwoordelijken**, gecombineerd met **inspectie van documenten** (ontvangstbonnen, uitgaande leveringsbons, magazijnbonnen, voorraadkaarten) en **afgrenzingstest (cut-off)**: laatste ontvangst- en leveringsdocumenten vóór en na de telling worden vergeleken met de voorraadregistratie om periode-juiste boeking te valideren. 🔗
> > 4. **Aansluiting tussen fysieke telling en permanente voorraadadministratie** — herrekening en vergelijking van de getelde hoeveelheden met de continue voorraadregistratie en met historische cijfers per categorie/locatie; significante verschillen worden onderzocht. Eventueel **externe bevestiging** voor voorraad gehouden bij derden (consignatie, douane-entrepot). 📖
> > 
...
> > |---|:---:|:---:|:---:|
> > | 1. Opstellen van een marketingstrategie |  | X |  |
> > | 2. Behoud mogelijkheid tot tijdige levering tegen de laagst mogelijke distributiekost | X | X |  |
> > | 3. Opvolging van marktbehoeften, introductie nieuwe producten en stopzetting van bestaande producten |  | X |  |
> > | 4. Enkel toegestane verkooporders worden verwerkt | X |  | X |
> > | 5. Alle verzonden goederen worden in de juiste periode correct gefactureerd | X |  | X |
> > 
> > 🤖
> > 
> > De drie aspecten van een operationele audit (klassiek COSO/IIA-drieluik):
> > 
> > - **Financieel** — betrouwbaarheid van de financiële verslaggeving: volledigheid en juistheid van omzet, correcte periode-toerekening, bewaking van kosten en marges. 🤖
> > - **Operationeel** — doeltreffendheid en doelmatigheid van de bedrijfsprocessen: strategie, marktpositionering, productinnovatie, logistieke efficiëntie. 🤖
> > - **Conformiteit** — naleving van interne procedures, wetgeving en autorisatieregels. 🤖
> > 
> > **Per doelstelling**:
> > 
> > 1. **Marketingstrategie opstellen** → zuiver **operationeel** (strategische bedrijfsvoering). Geen directe link met financiële verslaggeving of regelgeving. 🔗
> > 2. **Tijdige levering tegen laagste distributiekost** → **operationeel** (logistieke efficiëntie) én **financieel** (kostenbeheersing → impact op marge en resultatenrekening). 🔗
> > 3. **Opvolging marktbehoeften / product-lifecycle** → zuiver **operationeel** (strategisch productbeheer). 🔗
> > 4. **Enkel toegestane verkooporders worden verwerkt** → **conformiteit** (autorisatie- en bevoegdhedenregels) én **financieel** (alleen geautoriseerde transacties leiden tot omzetregistratie — voorkomt fictieve omzet). 🔗
> > 5. **Alle verzonden goederen in juiste periode correct gefactureerd** → **financieel** (volledigheid omzet + cut-off) én **conformiteit** (naleving facturatie- en BTW-procedures). 🔗
> > 
...
>
> <span class="jf-badge">Juist of fout?</span><span class="jf-stelling">Transacties worden uitgevoerd in overeenstemming met de door het management vastgelegde bevoegdheidsverdelingen.</span>
> 
> > [!success]- Antwoord (klik om te openen)
> >
> > **Antwoord: Juist**
...
> > 
> > - **werkelijk bestaan** (realiteit/*occurrence*), en
> > - **de onderneming aangaan** (afbakening van het patrimonium — *entiteit-assertie*).
> > 
> > Dit sluit zowel fictieve transacties als verwarring met het privévermogen van zaakvoerders of vermogen van derden uit. Het correspondeert met de boekhoudkundige assertion **bestaan/voorkomen** en met het beginsel van het **afgescheiden vermogen** van de rechtspersoon. 🔗
> > 
...
> > 
> > 1. **Vergelijken** van de boekhoudkundige saldi met onafhankelijke onderliggende informatie (fysieke inventaris, bankuittreksels, leveranciersbevestigingen).
> > 2. **Onderzoeken en verantwoorden** van elk verschil — en het boeken van de gepaste correctie.
> > 
...
> > 
> > - **R1 — Functiescheiding**: Het aanleggen van master-data (klantenfiche) is een autorisatie-taak; het registreren van transacties (orders, facturen) is een uitvoerings-taak. ISA 315 noemt expliciet als illustratie: *"Een manager die kredietverkopen autoriseert, is bijvoorbeeld niet verantwoordelijk voor het bijhouden van debiteurenrekeningen ... Als één persoon al deze activiteiten kan uitvoeren, zou de persoon bijvoorbeeld een fictieve verkoop kunnen creëren die onopgemerkt kan blijven."* 📖 Door de fiche door verkoop te laten aanmaken ontstaat exact dit fraude-vehikel (ghost customers).
> > - **R2 — Kredietacceptatie**: In een gezonde verkoopcyclus loopt order → kredietcheck (door financiële dienst of credit controller) → orderbevestiging. Hier wordt de klant pas aangemaakt nadat de bestelbon al getekend is — kredietlimiet en blacklist-check komen te laat. Risico op leveringen aan insolvente klanten en stijgende afschrijvingen op handelsvorderingen. 🔗
> > - **R3 — Master-data-kwaliteit**: Klantenfiches bevatten parameters die de hele downstream-cyclus aansturen (BTW-regime, facturatieadres, kortingscategorie, betalingstermijn). Zonder verplichte vier-ogen-validatie of input-controles kan een verkoper bewust of onbewust gunstige condities ingeven (bv. te hoge korting, fout BTW-regime EU/intracommunautair). ISA 315 wijst er ook op dat *"verkopers niet in staat mogen zijn productprijsbestanden of commissietarieven te wijzigen."* 📖 Dezelfde logica geldt voor klant-parameters die de prijszetting beïnvloeden. 🔗
> > 
> > Aanvullende risico's die ook valide antwoorden zijn (drie volstaan, maar de examinator kan variëren):
> > - **GDPR/AVG-risico**: persoonsgegevens worden zonder verwerkingsregister of grondslag-check ingevoerd. 🤖
> > - **Doublures**: dezelfde klant wordt onder lichtjes verschillende benamingen meermaals aangemaakt, wat consolidatie van omzet en kredietlimiet onmogelijk maakt. 🤖
...
> > |---|---|
> > | Akkoord bestelling | **1 — Autorisatie** 🔗 |
> > | Ontvangst van de goederen | **2 — Bewaren van activa** 🔗 |
> > | Ontvangst van de factuur | **3 — Registratie en rapportering** 🔗 |
> > | Verificatie van de factuur | **4 — Controle procedures** 🔗 |
> > | Aanmaak betalingsvoorstel | **3 — Registratie en rapportering** 🔗 |
> > | Controle betalingsvoorstel | **4 — Controle procedures** 🔗 |
> > | Uitvoeren van de betaling | **2 — Bewaren van activa** 🔗 |
> > | Aanmaak en onderhoud basisgegevens leveranciers | **1 — Autorisatie** 🔗 | 🔗
> > 
> > Toepassing van de vier-taken-typologie op de aankoop-/betaalcyclus:
> > 
> > - **Akkoord bestelling** → *Autorisatie*: de bevoegde verantwoordelijke geeft toestemming dat een verbintenis tegenover een leverancier mag worden aangegaan (initiërende beslissing). 🔗
> > - **Ontvangst van de goederen** → *Bewaren van activa*: het magazijn neemt fysieke controle over de goederen — dit is custody. 🔗
> > - **Ontvangst van de factuur** → *Registratie en rapportering*: inboeken van het inkomende document in de boekhouding (aankoopdagboek, schuld leverancier). 🔗
> > - **Verificatie van de factuur** → *Controle procedures*: de 3-way match (bestelbon ↔ ontvangstbon ↔ factuur) is een detecterende controle op prijs, hoeveelheid en geleverdheid. 🔗
> > - **Aanmaak betalingsvoorstel** → *Registratie en rapportering*: het voorstel is een operationele uitvoeringslijst (welke facturen op vervaldag), opgesteld door de AP-functie — geen nieuwe autorisatie en geen custody. 🔗
> > - **Controle betalingsvoorstel** → *Controle procedures*: review door een tweede persoon (vaak vier-ogen-principe) vóór de betalingen worden vrijgegeven. 🔗
> > - **Uitvoeren van de betaling** → *Bewaren van activa*: treasury/kassier beschikt over de bankrekening en geeft de geldmiddelen vrij — dat is custody over liquide middelen. 🔗
> > - **Aanmaak en onderhoud basisgegevens leveranciers** → *Autorisatie*: master-data-onderhoud bepaalt welke tegenpartijen überhaupt mogen worden betaald (bankrekeningnummer, voorwaarden) — een poortwachterstaak. 🔗
> > 
> > Klassieke fraudegevoelige combinaties die door deze indeling worden voorkomen:
> > 
> > 1. **Aanmaak leveranciersgegevens + uitvoeren betaling** (1 + 2) → fictieve leverancier op eigen rekening laten betalen. 🔗
> > 2. **Akkoord bestelling + ontvangst goederen** (1 + 2) → bestelling op naam vennootschap, levering naar privé. 🔗
> > 3. **Aanmaak + controle betalingsvoorstel** (3 + 4) → eigen voorstel zelf goedkeuren — daarom moet controle door iemand anders gebeuren. 🔗
> > 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > Het bestuursorgaan wil via interne controle een redelijke zekerheid bereiken over vier doelstellingen:
> > 
> > 1. **Bescherming van de activa van de onderneming** — vrijwaring van het patrimonium tegen verlies, diefstal, verspilling, fraude of misbruik. 🔗
> > 2. **Betrouwbaarheid van de financiële (en beheers-)informatie** — juistheid, volledigheid en tijdigheid van interne rapportering en externe jaarrekening. 📖
> > 3. **Effectiviteit en efficiëntie van de bedrijfsvoering** — operationele doelstellingen worden gehaald met optimaal gebruik van middelen. 📖
> > 4. **Naleving van de van toepassing zijnde wet- en regelgeving** — externe wetgeving (fiscaal, sociaal, WVV...) én interne richtlijnen/procedures. 📖
> > 
...
> > 
> > - de **gerealiseerde omzet vergelijken met budget** of met dezelfde periode vorig jaar (trendanalyse); 🔗
> > - het **brutomargepercentage per kraan** berekenen en vergelijken met de verwachting (verband tussen verkoopprijs en aankoopkostprijs); 🔗
> > - de **omzet per verkoper / per regio** uitzetten tegen het aantal verkochte eenheden (verband financieel ↔ niet-financieel, vgl. "loonkosten per werknemer"-voorbeeld in ISA 520 A2); 📖
> > - de **voorraadrotatie** (aantal kranen in stock t.o.v. tussentijdse verkopen) toetsen aan een norm-rotatie. 🔗
> > 
> > De test bestaat dus uit: verwachting opstellen → vergelijken met werkelijkheid → afwijking onderzoeken. 🔗
> > 
...
> > 
> > - **Resource-allocatie en planning** — Vertaalt het jaarlijks risicogebaseerd auditplan in concrete mens-dagen, externe expertise (IT-audit, fiscaal, actuarieel) en opleidingsuren; zonder budget blijft het auditplan een wens. 🔗
> > - **Waarborg van onafhankelijkheid en reikwijdte** — Een vooraf door het auditcomite/bestuur goedgekeurd budget voorkomt dat het uitvoerend management de scope feitelijk inperkt door middelen te onthouden; dit sluit aan bij het ISA 610-vereiste dat de interne auditfunctie geen beperkingen krijgt opgelegd. 📖
> > - **Verantwoording en performance-meting** — Realisatie versus budget (bestede uren per opdracht, dekkingsgraad van het auditplan, kost per audit) maakt de functie meetbaar en stuurbaar door de leidinggevende interne auditor en het auditcomite. 🔗
> > - **Prioritering en risico-afstemming** — Een beperkt budget dwingt expliciete keuzes op basis van risico-inschatting (welke entiteiten/processen wel of niet in scope dit jaar) en maakt restrisico zichtbaar voor governance — geen impliciete blinde vlekken. 🔗
> > 
...
> > 
> > - **Volledigheidsrisico (under-statement)**: bij leveranciersschulden is de natuurlijke fout-richting *te weinig boeken* (niet-ontvangen of niet-geregistreerde facturen, cut-off-fouten rond jaareinde). De boekhouding kan dit per definitie niet aan het licht brengen — wat niet geboekt is, staat er niet in. 🔗
> > - **Onafhankelijke bron**: de leverancier heeft geen belang bij dezelfde voorstelling van zaken als de gecontroleerde entiteit; een rechtstreeks antwoord van de derde partij is daarom betrouwbaarder dan een intern document (ISA 500 — controle-informatie is overtuigender naarmate ze uit onafhankelijke externe bron komt). 📖
> > - **Detectie van fraude en collusie**: interne manipulatie van leveranciersrekeningen (fictieve leveranciers, ongeregistreerde verplichtingen om de schuldgraad gunstiger voor te stellen, verduistering via valse facturen) wordt niet zichtbaar in de boekhouding zelf maar wel in een afwijking tussen het door de leverancier bevestigde saldo en het geboekte saldo. 🔗
> > - **Verificatie van saldi, voorwaarden en geschillen**: confirmatie dekt niet alleen het openstaande bedrag maar ook betalingstermijnen, kortingen, waarborgen, lopende geschillen en eventuele off-balance-verplichtingen die in de boekhouding ontbreken of onjuist gerubriceerd zijn. 🔗
> > - **Periodieke werking — preventief effect**: het feit dat de interne controle *systematisch* confirmaties uitstuurt werkt afschrikkend voor manipulatie binnen de aankoop- en betalingscyclus. 🤖
> > 
...
> > |---|---|---|---|
> > | 1 | **Lapping van klantbetalingen via cheque** (~€80.000): cheques van klant A geboekt op saldo van klant B, waardoor de boekhouder zichzelf doorlopend voorschot bezorgt. | Geen **functiescheiding tussen ontvangst van waarden (cheques) en boeking van klantenrekeningen**; geen onafhankelijke matching ontvangst ↔ vordering; geen periodieke saldobevestiging bij klanten. 🔗 | (a) Cheques laten openen/registreren door iemand anders dan de boekhouder (bv. directie-secretariaat) — onmiddellijke pre-list opstellen. (b) Cheques laten **kruisen** ("niet-overdraagbaar") en uitsluitend op bedrijfsrekening laten incasseren. (c) Migreren naar **bankoverschrijvingen / domiciliëringen** in plaats van cheques. (d) **Saldobevestigingen** ten minste jaarlijks door externe partij (accountant). (e) Periodieke **ouderdomsbalans klanten** door iemand anders dan de boekhouder. 🔗 |
> > | 2 | **Verdwenen oude leveranciersschulden** (€200.000) doorgestort naar eigen rekening. | Boekhouder kan zelf **leveranciersrekeningen muteren én betalingen uitvoeren** — geen four-eyes op uitgaande betalingen, geen bewaking van afgeboekte schulden, geen check leverancier-IBAN. 🔗 | (a) **Dual signature / four-eyes** voor alle uitgaande betalingen boven een drempel (bedrijfsleider co-tekent). (b) **Beveiligde leveranciers-masterfile**: aanmaken/wijzigen IBAN enkel door iemand anders dan wie betalingen voorbereidt; logging van wijzigingen. (c) Periodieke **leveranciers-confirmaties** en analyse van **afgeboekte/oude saldi** door externe controle. (d) Bankrekening-uittreksels rechtstreeks aan de bedrijfsleider (niet via boekhouder). 🔗 |
> > | 3 | **Fictieve creditnota's** voor kleine bedragen aan klanten, uitbetaald op rekening van de boekhouder. | Boekhouder kan in zijn eentje creditnota's **opstellen, boeken én laten uitbetalen** — geen autorisatie-drempel, geen check IBAN-begunstigde ↔ klanten-masterfile. 🔗 | (a) **Verplichte autorisatie** van elke creditnota door commercieel verantwoordelijke of bedrijfsleider; bewijs van onderliggende reden (retour, prijscorrectie). (b) **Periodieke analyse** van creditnota-volume per klant / per opsteller (kleine, frequente creditnota's = red flag — ISA 240 Bijlage 1). (c) Terugbetaling enkel op het **oorspronkelijke IBAN van de klant**, automatisch gecontroleerd. (d) Statistische **analytische review**: ratio creditnota's / omzet, evolutie per periode. 🔗 |
> > | 4 | **Aangepaste onkostennota's** van collega's (cijfer toegevoegd) — verschil naar eigen rekening. | Onkostennota's worden **eenzijdig door boekhouder bewerkt en uitbetaald** — geen tegentekening door indiener, geen onafhankelijke goedkeuring, betaling kan naar een ander IBAN dan dat van de werknemer. 🔗 | (a) Werknemer **ondertekent eindbedrag** van eigen onkostennota; kopie blijft bij werknemer. (b) **Goedkeuring door direct leidinggevende** vóór betaling. (c) Betaling **enkel op het persoonlijke loon-IBAN** van de werknemer (gekoppeld aan HR-masterfile, niet wijzigbaar door boekhouding). (d) Periodieke **steekproef** door bedrijfsleider: onkostennota ↔ uitbetaald bedrag ↔ begunstigde-IBAN. 🔗 |
> > | 5 | **Dubbele klantbetaling** (€27.000) doorgestort naar eigen rekening; geen spoor in boekhouding. | Boekhouder kan **inkomende overschotten omleiden** zonder dat dit detecteerbaar is — geen onafhankelijke bankreconciliatie, geen controle op niet-toegewezen ontvangsten ("suspense"-rekening). 🔗 | (a) **Bankreconciliatie maandelijks door iemand anders** dan wie boekingen doet (bedrijfsleider, externe accountant, of collega). (b) **Verplichte suspense-rekening** voor niet-identificeerbare ontvangsten — saldo moet periodiek door derde worden opgehelderd. (c) **Saldobevestigingen** bij klanten met openstaand saldo én bij klanten met saldo nul (om verzwegen overbetalingen te detecteren). (d) **Beveiliging IBAN-bestand** begunstigden — IBAN van de boekhouder mag nooit op een klanten- of leveranciers-masterfile staan. 🔗 | 🔗
> > 
> > De vijf vaststellingen zijn schoolvoorbeelden van **"asset misappropriation"** in de ACFE-typologie (oneigenlijke toe-eigening van activa) — de meest voorkomende, doch financieel doorgaans minst materiële fraudecategorie. De gemene deler is dat **één persoon de drie onverenigbare functies cumuleert**: autoriseren (creditnota's, onkostennota's, betalingen), registreren (boekhouding) en bewaren van waarden (cheques, banktoegang). ISA 315 Bijlage 3 noemt dit expliciet als de kernreden voor functiescheiding: "beperkingen aanbrengen in de mogelijkheden voor wie dan ook om bij de uitoefening van zijn normale taken (...) fraude te plegen en te verhullen". 📖
> > 
