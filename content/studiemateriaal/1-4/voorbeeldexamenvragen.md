---
title: 1.4 Voorbeeldexamenvragen Geconsolideerde jaarrekening en wetgeving betreffende de geconsolideerde jaarrekening
...
# 1.4 Voorbeeldexamenvragen Geconsolideerde jaarrekening en wetgeving betreffende de geconsolideerde jaarrekening
...
> [!question]- Consolidatie — controlepercentage, belangenpercentage en consolidatiemethode bepalen
> *Examen 2014-1 · PO 1.4*
>
> Vul onderstaande tabel aan op basis van volgende gegevens. De groepsstructuur is weergegeven in het schema hieronder; de in te vullen antwoord-tabel staat eronder.
> 
> **Groepsstructuur**
> 
> ```mermaid
...
> ```
> 
> _M staat bovenaan en houdt rechtstreeks 70 % in A en 30 % in C. A houdt 60 % in B; C houdt 20 % in B._
> 
...
> > [!success]- Antwoord (klik om te openen)
> >
> > | Relatie | Controle% | Belang% | Consolidatiemethode |
> > | --- | --- | --- | --- |
...
> [!question]- Vermelding van minderheidsbelangen in de geconsolideerde resultatenrekening
