...
- [[studiemateriaal/1-9/samenvatting|Samenvatting PO 1.9]] — voor herhaling: diagnose-template (data → consistentie → 4 lagen → SWOT → aanbevelingen) plus de 3 rol-perspectieven.
