...
Dit vak gaat over twee belastingen die op cruciale momenten in een mensenleven of een onderneming tussenkomen: bij het sluiten van een akte (registratierechten) en bij overlijden (erfbelasting). Het zijn **indirecte belastingen** die niet op inkomen drukken maar op vermogenstransfers — en juist daardoor doorslaggevend zijn bij vastgoedtransacties, schenkingen, opvolging van een familiebedrijf en estate planning. Voor de cliënt is het verschil tussen "wel of niet vooraf advies vragen" snel tienduizenden euro's waard.

### Hoe past dit in het bredere programma?

| Andere PO | Relatie tot dit vak |
|---|---|
| **PO 2.7 — Regionale en lokale belastingen** | Registratie- en erfbelasting zijn **overgedragen gewestbelastingen** — tarieven en gunstregimes verschillen per gewest. De procedure-laag (bezwaar, controle, dwanginvordering) is daar gedeeld. |
| **PO 2.3 — Vennootschapsbelasting** | Bij inbreng van vastgoed in een vennootschap of bij overdracht van aandelen komen registratierechten en vennootschapsbelasting samen aan tafel — fiscale structurering vereist beide brillen. |
| **PO 3.0 — Vennootschaps- en verenigingsrecht** | Vermogensplanning werkt vaak met vennootschappen (holding, patrimonium-vennootschap, maatschap). De juridische techniek leeft daar; de fiscale gevolgen leven hier. |
| **PO 2.1 — Personenbelasting** | Schenkingen en erfopvolgingen raken inkomstenbelasting via fictiebepalingen, opbrengsten van vruchtgebruik en de fiscale woonplaats. |
| **PO 2.4 — Procedure en fiscale geschillen** | Bezwaar bij Vlabel, rulings over gunstregimes en geschillen over waardering volgen procedureregels die in PO 2.4 systematisch worden behandeld. |
...
Een cliënt wil zijn huis aan zijn kinderen overlaten, een familiebedrijf doorgeven of een verkrotte handelszaak omzetten naar een BV. Elk van die handelingen activeert een eigen heffing — soms federaal, vaker gewestelijk — met eigen tarieven, vrijstellingen en termijnen. Wie de heffing miskent, betaalt boetes of mist gunsttarieven die nooit meer terugkomen. Wie te complex denkt, riskeert herkwalificatie door de fiscus wegens fiscaal misbruik.
...
|---|---|---|
| [[registratie-en-successierechten]] | PO 2.7 (regionaal/lokaal), PO 2.4 (procedure) | Overgedragen gewestbelasting; bezwaar volgt fiscale procedure |
| [[verkooprecht]] | PO 2.7 (regionaal/lokaal) | Klassiek voorbeeld van overgedragen gewestbelasting |
| [[gunstregime-familiale-onderneming]] | PO 3.0 (vennootschapsrecht), PO 2.3 (Ven.B) | Vennootschapsstructuur + fiscale voorwaarden |
| [[inbreng-onroerend-in-vennootschap]] | PO 3.0 (oprichting), PO 2.3 (Ven.B) | Bij inbreng in natura — registratie- én Ven.B-gevolg |
| [[huwelijksvermogensrecht]] | PO 2.1 (PB), PO 3.0 (vennootschapsrecht) | Gezamenlijke aangifte PB + aandelenbezit |
| [[erfrecht]] | PO 3.0 (overdracht onderneming) | Familiale opvolging bedrijf — wettelijke devolutie |
| [[levensverzekering-successieplanning]] | PO 2.1 (PB op uitkeringen) | Verzekeringscontract met fiscale gelaagdheid |
