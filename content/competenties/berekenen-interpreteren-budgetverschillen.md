...
> Verschillenboekhouding (variance analysis) is integraal management-accounting-doctrine zonder Belgische trusted bron. Vereist mens-review wegens praktijk_pct > 70%.
...
> [!example]- Yperse Werkplaats BV — periode-afsluiting met materiaal-verschil € 64.800 ongunstig en arbeidsverschil € 14.550 ongunsti…
> **Conclusie**: Materiaal: inkoop (€ 34.800) + verbruik (€ 30.000); arbeid: tarief (€ 7.050) + efficiëntie (€ 7.500). Acties: leverancierscontract herzien, herwerking-oorzaak onderzoeken, indexerings-impact aanvaarden.
>
> **Grondslag**: [[verschillenboekhouding]] §materiaalverschil, [[prijsverschil-arbeid]] §splitsing
>
> **Redenering**: Splitsing per oorzaak-type maakt de variances stuurbaar; elk verschil heeft een herkenbare eigenaar in de organisatie.


## Gebaseerd op concepten

[[verschillenboekhouding]] · [[prijsverschil-arbeid]] · [[voorbepaalde-kosten]] · [[werkelijke-kostencalculatie]] · [[flexibel-budget]] · [[statisch-budget]] · [[budgetbeheer]] · [[variabele-kosten]] · [[vaste-kosten]]
## Voortkomend uit

- **Taken**: 1.8.taak.1
- **Kenniselementen**: 1.8.VI, 1.8.VI.D, 1.8.III.C
