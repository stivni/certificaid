...
status: voorgesteld
schema_version: '1.1'
gegenereerd_uit: data/concepten/competenties/opzetten-analytisch-rekeningenstelsel.yaml
...
> [!example]- Yperse Werkplaats BV (productie wollen tapijten) wil maandelijks kostprijs per productlijn én voorraadwaardering op bala…
> **Conclusie**: Drie hoofdcentra (Spinnerij, Weverij, Confectie), drie kostendragers (tapijt-standaard, tapijt-luxe, kleed-handgeknoopt), eenvoudige integratie tegenover klasse 6 voor balans, waarderingsneutrale module voor maandsturing.
>
> **Grondslag**: [[analytische-boekhouding]] §implementatie, [[registratiesysteem-waarderingsneutraal]]
>
> **Redenering**: Productieproces met afgebakende afdelingen rechtvaardigt centra. Maandelijkse sturing vraagt aanvullende cijfers (opportuniteitskosten) die waarderingsneutraal kunnen worden ingebracht.


## Gebaseerd op concepten

[[analytische-boekhouding]] · [[doelstellingen-analytische-boekhouding]] · [[rekeningenstelsel-analytisch]] · [[kostensoort]] · [[kostencentrum]] · [[kostendrager]] · [[verdeelsleutel]] · [[registratiesysteem-waarderingsneutraal]] · [[registratiesysteem-eenvoudige-integratie]] · [[registratiesysteem-proportionele-integratie]]
## Voortkomend uit

- **Taken**: 1.8.taak.1
- **Kenniselementen**: 1.8.I, 1.8.I.A, 1.8.IV, 1.8.IV.A, 1.8.IV.B, 1.8.IV.C
