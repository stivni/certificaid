---
title: "Themafiche — EU fiscale richtlijnen"
description: "Themafiche voor sub-cluster EU fiscale richtlijnen (PO 2.8): moeder-dochter, interest-royalty, ATAD, fusierichtlijn + DAC-uitwisselingen"
tags:
  - themafiche
  - po-2.8
...
> **Themafiche — kapstok voor herhaling.** Vier kern-richtlijnen + DAC-administratieve samenwerking + PPT-overlay sinds 2015. Voor verhaal en routekaart: [[leerpaden/2.8|minicursus PO 2.8]].
...
```mermaid
flowchart TD
    A["Grensoverschrijdende EU-situatie"] --> B{Type inkomen / verrichting}
    B -->|Dividend EU-moeder/dochter| MDR["MDR + DBI-aftrek<br/>(10% drempel + taxatievoorw.)"]
    B -->|Interest of royalty EU-verbonden| IRR["IRR<br/>(25% drempel)"]
    B -->|EU-fusie / splitsing| FR["Fusierichtlijn<br/>(neutraliteit voorwaardelijk)"]
    B -->|Anti-misbruik / CFC / interestbeperking| AT["ATAD I/II<br/>(WIB92-bepalingen)"]
    B -->|Info-uitwisseling| DAC["DAC 1-7<br/>(automatische rapportering)"]
    MDR -.->|let op| PPT["PPT-toets<br/>(hoofddoel belastingvoordeel?)"]
    IRR -.->|let op| BO["Beneficial-owner-toets<br/>(substantie ontvanger)"]
    FR -.->|let op| ZR["Zakelijke rationale<br/>(art. 183bis WIB92)"]
```
