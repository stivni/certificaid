---
title: "Themafiche — Gemeentelijke belastingen"
description: "Themafiche voor sub-cluster gemeentebelastingen (PO 2.7): reglement-toets + opcentiemen + sui-generis + provinciale belastingen"
tags:
  - themafiche
  - po-2.7
...
> ⚠️ **Uitgefaseerd — vervangen door PO 2.7 leerlaag-pakket.** Per **ADR-039** + voltooiing PO 2.7 leerpad (2026-06-01): deze themafiche is vervangen door [[studiemateriaal/2-7/samenvatting|Samenvatting PO 2.7]] (geheugen-kapstok) + leerstuk [[gemeente-en-provinciebelastingen]] (didactische uitwerking met wettigheidstoets-4-criteria). Deze fiche blijft beschikbaar als historische bron tot een opkuis-ronde.
...
```mermaid
flowchart TD
    A["Gemeente vestigt aanslag<br/>(kohier of aangifte)"] --> B["Bezwaar bij<br/>College B&S"]
    B --> C["Termijn = reglement<br/>(typisch 3 maanden)"]
    C --> D["Beslissing College"]
    D -->|Afwijzing| E["Rechtbank eerste aanleg<br/>(burgerlijke kamer)"]
    E --> F["Hoger beroep + cassatie"]
    A -.->|Specifiek beroep| G["Sommige reglementen<br/>voorzien bestendige deputatie"]
```
