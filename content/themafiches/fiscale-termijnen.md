---
title: "Themafiche — Fiscale termijnen"
description: "Themafiche voor sub-cluster fiscale termijnen (PO 2.5): aanslag · onderzoek · verjaring · bezwaar — directe belastingen + BTW + invordering"
tags:
  - themafiche
  - po-2.5
...
> **Themafiche — kapstok voor herhaling.** De zes termijn-families samengebracht — vraag altijd: welk aanslagjaar? welke belasting? welke termijn? Voor verhaal en routekaart: [[studiemateriaal/2-5|overzicht PO 2.5]].
...
```mermaid
flowchart TD
    A["Aanslagbiljet verzonden<br/>(bv. 15 mei 2026)"] --> B["Wachten tot 1e dag<br/>3e maand na verzending"]
    B --> C["Startdatum bezwaartermijn:<br/>1 augustus 2026"]
    C --> D["Einddatum bezwaartermijn:<br/>1 augustus 2027 (1 jaar)"]
    D --> E["Bezwaar indienen vóór einddatum<br/>(per aangetekende brief of MyMinfin)"]
```
