---
title: "Themafiche — Bijzondere mandaten"
description: "Themafiche voor sub-cluster bijzondere mandaten (PO 1.6): inbreng natura · quasi-inbreng · fusie · splitsing · omzetting · ontbinding — verslag per verrichting"
tags:
  - themafiche
  - po-1.6
...
> **Themafiche — kapstok voor herhaling.** Bijzondere mandaten per WVV-verrichting + wie mag uitvoeren + verslag-vorm. Voor verhaal en routekaart: [[studiemateriaal/1-6|overzicht PO 1.6]].
...
```mermaid
flowchart TD
    A["Verrichting in opmars<br/>(bv. fusie, inbreng natura)"] --> B["Aanwijzing<br/>commissaris van rechtswege OF<br/>ad-hoc revisor/accountant"]
    B --> C["Opdrachtbrief specifiek voor bijzonder mandaat<br/>(apart van commissaris-mandaat!)"]
    C --> D["Controle-werk<br/>volgens ITAA-norm + ISA waar relevant"]
    D --> E["Verslag — wettelijk voorgeschreven inhoud"]
    E --> F["Deponering / publicatie<br/>(bekendmaking aan derden)"]
    E --> G["Bestuurs- en AV-beslissing<br/>op basis van verslag"]
```
