---
title: "PO 1.6 — Externe controle · minicursus"
description: "Minicursus voor PO 1.6: waarom dit vak, wat je moet kunnen, concept-kaart, leesroute"
tags:
  - minicursus
  - po-1-6
---
...
- **Minicursus PO 1.4 — geconsolideerde jaarrekening** — [[1.4|zie 1.4]] (commissaris-aspect)
- **Minicursus PO 1.7 — interne controle** *(zie minicursus 1.7)*
- **Minicursus PO 1.6 — gerechtelijke en privé-expertise** *(nog te maken)*
...
→ De volledige vragen met uitgewerkte modelantwoorden vind je op de [voorbeeldexamen-pagina PO 1.6](../voorbeeldexamens/po-1.6).
...
*Minicursus afgeleid uit het officiële ITAA-examenprogramma (PO 1.6). Status: voorgesteld — nog niet inhoudelijk gecureerd.*
