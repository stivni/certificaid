...
Drie klassieke spanningen domineren de praktijk. **Eerst** de interpretatie: de fiscus wil de wet ruim lezen, de belastingplichtige restrictief — de rechtspraak hanteert de regel "in dubio contra fiscum" maar enkel als de wet écht onduidelijk is. **Tweedens** de keuze van de minst belaste weg versus simulatie: kiezen voor een legale constructie mag, maar wanneer partijen alle gevolgen aanvaarden van een verrichting *anders dan ze die voorstellen*, slaat de fiscus toe op grond van simulatie. **Derde** de anti-misbruikbepalingen: art. 344 §1 WIB en art. 1 §10 WBTW geven de fiscus een breekijzer tegen constructies die enkel fiscaal voordeel beogen — een geleidelijk uitgebreid arsenaal sinds 1993.
...
- De cliënt voorbereiden op de verschillende fasen van de belastingprocedure (zie PO 2.5 voor de procedurele uitwerking)
...
- WIB92 (Wetboek van de Inkomstenbelastingen) — vooral als bron voor art. 344 §1
- WBTW — art. 1 §10 (anti-misbruik btw)
- Wet 24.12.2002 — voorafgaande beslissingen in fiscale zaken (DVB)
