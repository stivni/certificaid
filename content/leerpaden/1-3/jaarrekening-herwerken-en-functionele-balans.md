...
> **Leerstuk — één vraag, helemaal doorgewerkt.** Lees eerst [[wat-is-jaarrekeninganalyse]] — dat zet het kader: wat je wil weten en waarom. Dit is de eerste pure techniek-stap: de ruwe jaarrekening omzetten naar een vorm waar je werkelijk *mee* kunt analyseren. Voor verhaal en routekaart: [[leerpaden/1-3|minicursus PO 1.3]].
...
- [[leerpaden/1-3/samenvatting|Samenvatting PO 1.3]] — Tabel met BBK ja/nee-rubrieken én de NBK/BBK/NT-formules voor herhaling.
