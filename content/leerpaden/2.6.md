---
title: "PO 2.6 — Registratie- en successierechten · minicursus"
description: "Minicursus voor PO 2.6: waarom dit vak, wat je moet kunnen, concept-kaart, leesroute"
tags:
  - minicursus
  - po-2-6
---
...
- Bezwaar indienen bij Vlabel of FOD Financiën over waardering, gunsttarieven of fictie-toepassing
- Een ruling aanvragen die de fiscale behandeling van een verrichting bevestigt
- Minnelijk overleg voeren bij waarderingsdiscussies
...
- **Minicursus PO 2.7 — Regionale en lokale belastingen** *(nog te maken — overlap voor gewestelijke bevoegdheid en procedure)*
- **Minicursus PO 2.4 — Procedure en fiscale geschillen** *(nog te maken — algemene bezwaar- en geschillenregels)*
- **Minicursus PO 3.0 — Vennootschaps- en verenigingsrecht** *(nog te maken — vennootschap als planningsinstrument)*
...
|---|---|
| `Themafiche registratierechten` *(nog te maken)* | **Kern** — tarieven per gewest, vrijstellingen, abattementen |
| `Themafiche successieplanning` *(nog te maken)* | **Kern** — beslisboom: testament vs schenking vs combinatie |
| `Themafiche erfrecht hervormd` *(nog te maken)* | **Vereist** — wettelijke devolutie + reserve sinds 2018 |
...
→ **De volledige vragen met uitgewerkte modelantwoorden** vind je op de [voorbeeldexamen-pagina PO 2.6](../voorbeeldexamens/po-2.6).
...
*Minicursus afgeleid uit het officiële ITAA-examenprogramma (PO 2.6). Status: voorgesteld — nog niet inhoudelijk gecureerd.*
