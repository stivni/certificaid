...
🏛️ Kader · 🏢 Entiteit · Anchors: `3.0.I` · `3.0.I.A` · `3.0.I.B` · `3.0.I.C` · `3.0.taak.1` · Wave: `cluster-extract-vennootschapsvormen-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: vennootschapsvormen · rechtsvormen · juridische ondernemingsvormen · business entity types · company forms — **Vertalingen**: fr: formes d'entreprise
...
### 💡 Keuze: 2 vennoten starten een ICT-consultancy 🔗
...
### 💡 Keuze: familiale vermogensstructuur ouders + 3 kinderen 🔗
...
### 💡 Verplichte omzetting BVBA → BV (vóór 1 januari 2024) 📖
...
### ⚠️ Denken dat de BV nog een minimumkapitaal heeft
...
### ⚠️ Maatschap = 'gewoon een onderonsje' — geen aansprakelijkheid
...
### ⚠️ VOF en CommV als 'eenvoudige' alternatief voor BV/NV
