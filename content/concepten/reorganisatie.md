...
**Status**: `in-voege` · sinds **2019-05-01** · basis: WVV boek 12 (Wet 23 maart 2019) + WIB92 art. 211 e.v.

**✅ Voor**
- 🔗 Schaalvergroting binnen een groep: twee zusters fuseren tot een werkmaatschappij — vermindert administratie en consolideert resultaat.
- 🔗 Voorbereiding van verkoop: een bedrijfstak wordt eerst ingebracht in een nieuwe vennootschap, zodat de aandelen van die dochter kunnen worden verkocht (share-deal) in plaats van losse activa (asset-deal).
- 🤖 Opzet van een holding-structuur: partiele splitsing of inbreng waarbij vastgoed of intellectuele eigendom in een aparte vennootschap wordt afgezonderd.

**🚫 Niet voor**
- 🔗 Gewone activa-verkoop (asset-deal) of aandelen-verkoop (share-deal) tussen onafhankelijke partijen — daar gelden de gewone regels van koop-verkoop, niet WVV boek 12.
- 📖 Insolventie-situaties: bij staking van betaling gelden de regels van gerechtelijke reorganisatie (boek XX WER) — een totaal ander juridisch regime, ondanks de naam-overlap.

**📋 Voorwaarden**
- 📖 Voorstel tot fusie/splitsing wordt opgesteld door het bestuursorgaan en minstens zes weken voor de algemene vergadering neergelegd bij de griffie.
- 📖 Verslag van een bedrijfsrevisor of externe accountant over de ruilverhouding (uitgezonderd bij vrijstelling op grond van eenparige instemming van alle aandeelhouders).
- 📖 Beslissing van de algemene vergadering met meerderheid vereist voor statutenwijziging (3/4 of 4/5 naargelang de rechtsvorm), in authentieke akte.
- 📖 Voor fiscale neutraliteit: continuiteit van waarderingsregels in de verkrijgende vennootschap en verrichting niet uitsluitend gericht op belastingontwijking.

**👍 Voordeel**
- 📖 Universele overgang van rechten en plichten — alle contracten, vergunningen en arbeidsovereenkomsten gaan automatisch over, zonder individuele instemming van tegenpartijen (behoudens intuitu personae-clausules).
- 📖 Fiscale neutraliteit: latente meerwaarden worden niet gerealiseerd, mits de voorwaarden van WIB92 art. 211 worden nageleefd.

**⚠️ Risico**
- 🔗 Bij gebrek aan correcte ruilverhouding kunnen minderheidsaandeelhouders de fusie aanvechten (nietigheidsvordering) — vandaar het verplichte revisorverslag.
- 📖 Fiscale herkwalificatie als belastingontwijking (art. 183bis WIB92): meerwaarden worden alsnog belast plus belastingverhoging.
- 📖 Schuldeisers van de overgenomen vennootschap kunnen binnen twee maanden na publicatie verzet aantekenen en bijkomende zekerheid eisen.
...
### 🎚️ Modaliteit-keuze bij groep-vereenvoudiging

## Accountant-perspectieven

### Accountant als adviseur bij reorganisatie

_Bij een herstructurering wordt de gecertificeerd accountant typisch ingeschakeld om de client te adviseren over de keuze van modaliteit en de fiscale impact._
...
_Bij fusie en splitsing wordt aan een bedrijfsrevisor (of in een vennootschap zonder commissaris: een externe accountant) een bijzonder mandaat toevertrouwd om de ruilverhouding te controleren._
...
- → Fusie als specifieke modaliteit (procedure, boekingen, voorbeelden) → [[fusie]] _(moet-verwijzen)_
- → Splitsing als specifieke modaliteit → [[splitsing]] _(moet-verwijzen)_
- → Fiscale-fusie-splitsing-regime (WIB92 art. 211-214 voorwaarden + gevolgen) → [[fiscale-fusie-splitsing]] _(moet-verwijzen)_
- → Overdracht-onderneming (share-deal/asset-deal) als alternatieve route → [[overdracht-onderneming]] _(moet-verwijzen)_
- ✂ Gerechtelijke reorganisatie (WER boek XX) naam-overlap maar insolventie-context
...
### `vergelijkbaar_met`
- [[overdracht-onderneming]] — Alternatieve route: bij een share-deal of asset-deal blijft de vennootschapsrechtelijke structuur ongewijzigd; bij een WVV boek 12-reorganisatie wordt de structuur zelf gewijzigd.
    - **Gelijkenissen**:
        - Beide laten een onderneming overgaan van A naar B
        - Beide kunnen worden gestructureerd met fiscale optimalisatie
    - **Verschillen**:
        - Reorganisatie raakt de juridische structuur (fusie/splitsing/inbreng); overdracht-onderneming raakt de eigendomsstructuur (aandelen of activa wisselen van eigenaar)
        - Fiscaal regime: reorganisatie kent fiscale neutraliteit (art. 211 WIB92); overdracht leidt typisch tot realisatie van meerwaarden
        - Procedure: reorganisatie volgt WVV boek 12; overdracht is een gewone koop-verkoop
