...
tags:
  ...
  - cat-regeling
  - status-concept
gegenereerd_uit: "data/concepten/records/vaste-inrichting.json"
---
...
🏢 Entiteit · 📋 Regeling · Anchors: `2.8.V` · Wave: `skeleton-btw-internationaal-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: VI — **Synoniemen**: permanent establishment · PE · permanente vestiging · Belgische inrichting — **Vertalingen**: en: permanent establishment · fr: établissement stable
...
### 💡 Belgische bouwonderneming met werf in Duitsland 🔗
...
{
  "stappen": [
    "Stap 1 — toets klassieke VI: vaste plek? Werfdirectie is een vaste plaats van bedrijfsuitoefening — ja.",
    "Stap 2 — duurzaamheid: 17 maanden > 12 maanden DBV-drempel — ja, bouwwerf-VI in Duitsland.",
    "Stap 3 — gevolg: Duitsland mag de aan de werf-VI toerekenbare winst belasten (art. 7 DBV).",
    "Stap 4 — België vrijstelling met progressievoorbehoud (art. 23 DBV) — Duitse winst telt mee voor het tarief op het Belgische deel.",
    "Stap 5 — administratie: registratie als VI in Duitsland, lokale aangifte, transfer-pricing tussen hoofdkantoor en VI."
  ],
...
### 💡 Commissionair-structuur na BEPS-7 🔗
...
### 💡 Pure logistieke opslag — geen VI (tenzij fragmentatie) 🔗
...
### ⚠️ VI-begrip btw en VI-begrip inkomstenbelasting verwarren
...
### ⚠️ Dochtervennootschap automatisch beschouwen als VI van de moeder
...
### ⚠️ WIB92-30-dagen-drempel voor bouwwerken automatisch toepassen
...
### ⚠️ Voorbereidend/hulpkarakter automatisch aanvinken bij opslag, aankoop, info-verzameling
