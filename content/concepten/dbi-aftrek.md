...
📋 Regeling · Anchors: `2.3.II.B` · Wave: `skeleton-fiscaliteit-klein-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: DBI — **Vertalingen**: fr: RDT (Revenus Définitivement Taxés)
...
### 💡 Dividend uit Luxemburgse dochter naar Belgische moeder 🔗
...
### ⚠️ Participatie-voorwaarde stapelen (10 % AND 2,5 M EUR)
...
### ⚠️ Houdperiode vereist voltooide 12 maanden vóór uitkering
...
### ⚠️ Verschil met Moeder-dochter-richtlijn-vrijstelling
