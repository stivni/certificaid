...
<h3 id="drie-samenhangende-fasen">Drie samenhangende fasen</h3>

> [!tip]- Drie samenhangende fasen
> (1) Planning: doelstellingen + budgetten opmaken. (2) Uitvoering + meting: werkelijke cijfers vastleggen, KPI's volgen. (3) Bijsturing: afwijkingen analyseren en corrigeren. Zonder de derde fase is de cyclus zinloos. 🤖

<h3 id="verhouding-met-interne-controle">Verhouding met interne controle</h3>

> [!tip]- Verhouding met interne controle
> Managementcontrole heeft IC nodig om betrouwbare cijfers te krijgen (anders stuurt het management op verkeerde data). IC heeft managementcontrole nodig om relevant te blijven (KPI's tonen waar IC-procedures versterkt moeten worden). 🤖
