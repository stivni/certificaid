...
📋 Regeling · 📅 Gebeurtenis · Anchors: `2.2.IV` · `2.2.taak.2` · `2.2.taak.4` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: avertissement-extrait de rôle IPP · AB PB — **Vertalingen**: fr: avertissement-extrait de rôle
...
### 💡 Typisch aanslagbiljet werknemer — saldo terug te krijgen 🔗
...
### 💡 Zelfstandige met bijbetaling — termijn + facilitatie 🔗
...
### 💡 Ambtshalve correctie + rechtzettings-bericht 🔗
...
### ⚠️ Bezwaartermijn vanaf 'datum aanslagbiljet' verkeerd berekenen
...
### ⚠️ Aanslagbiljet zien als 'voorstel'
...
### ⚠️ Termijn 30 juni AJ+1 verwarren met aanslagbiljet-termijn
...
### ⚠️ Terugbetaling = automatisch op dezelfde rekening
