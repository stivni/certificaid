...
**Status**: `in-voege` · basis: WIB92 art. 7-16, art. 2-15° (eigen woning)

Stabiel regime. Eigen woning is sinds zesde staatshervorming gewestelijk geregeld (art. 2, 15° WIB92 verwijst naar BFG-wet art. 5/5 §4).

**✅ Voor**
- 📖 Elke natuurlijke persoon-eigenaar, vruchtgebruiker, erfpachter of opstalhouder van Belgisch onroerend goed dat niet beroepsmatig wordt gebruikt — verplichte aangifte in vak III PB van het geïndexeerde KI (of werkelijke huur bij verhuur aan vennootschap).

**🚫 Niet voor**
- 📖 Onroerend goed dat door de eigenaar voor zijn eigen beroepswerkzaamheid wordt gebruikt — KI wordt dan als beroepskost in mindering gebracht en de inkomsten volgen het regime van het beroepsinkomen (art. 37 WIB92). Code 1105-59 in vak III voor enkel-melding van het KI.
- 📖 Eigen woning — KI wordt NIET in vak III aangegeven want federaal vrijgesteld (art. 12 §3 oud / federale uitsluiting na regionalisering). Eventuele intresten/kapitaalaflossingen volgen het gewestelijk regime voor de eigen woning.

**📋 Voorwaarden**
- 📖 Het onroerend goed moet (1) Belgisch of buitenlands zijn (buitenlands KI wordt geschat door fiscus); (2) niet voor het uitoefenen van de beroepswerkzaamheid van de eigenaar worden gebruikt (anders art. 37); (3) niet als eigen woning kwalificeren (anders gewestelijk geregeld).

**👍 Voordeel**
- 🔗 Bij verhuur aan particulier wordt enkel het geïndexeerde KI × 1,40 belast — vaak aanzienlijk lager dan de werkelijke huur. Een woning verhuurd voor €1.000/maand (€12.000/jaar) met KI €1.200 wordt belast op ca. €3.514 (€1.200 × 2,0915 × 1,40 — coëfficiënt 2025 illustratief, Cijferzakboekje voor exact bedrag). Dit is een belangrijke fiscale stimulans voor de particuliere huurmarkt.

**⚠️ Risico**
- 📖 Verhuur aan een vennootschap (zelfs als die het gebouw als woning voor personeel gebruikt) gaat altijd naar rubriek 5 vak III — belast op werkelijke nettohuur indien hoger dan geïndexeerd KI × 1,40. Particuliere verhuurders die menen 'gewoon' KI te kunnen aangeven wanneer de huurder een vennootschap is, krijgen een onverwacht hogere aanslag.
- 📖 Herkwalificatie-risico bedrijfsleider (art. 32 al. 2, 3° WIB92): wanneer een bedrijfsleider vastgoed verhuurt aan zijn eigen vennootschap en de huur overschrijdt 5/3 × niet-geïndexeerd KI × revaloriseringscoëfficiënt (5,46 voor AJ 2025), wordt het overschrijdende deel geherkwalificeerd als bezoldiging — onderworpen aan progressief PB-tarief én RSZ-bijdragen voor zelfstandigen.
...
### Particuliere vastgoedeigenaar (PB-aangifte)

_De accountant die de PB-aangifte voor een cliënt-eigenaar van vastgoed voorbereidt — verhuurd of niet — uitgezonderd de eigen woning._
...
- → Onroerende voorheffing als gewest-belasting met PB-verrekening → [[onroerende-voorheffing]] _(moet-verwijzen)_
- → Eigen-woning vrijstelling + woonbonus + overgangsregimes → [[eigen-woning-fiscaal]] _(moet-verwijzen)_
- ↪ Aankoop/verkoop onroerend goed (registratierechten) → [[registratie-en-successierechten]] _(mag-verwijzen)_
- → Herkwalificatie bovenmatige huur bedrijfsleider → bezoldiging → [[bedrijfsleidersbezoldiging]] _(moet-verwijzen)_
...
- [[personenbelasting]]
### `vereist`
- [[kadastraal-inkomen]] — KI is de basis-grootheid voor 3 van de 4 vak-III-regimes. Zonder KI geen onroerend inkomen.
### `beinvloed_door`
- [[onroerende-voorheffing]] — Onroerende voorheffing (gewestbelasting) is afzonderlijk verschuldigd op KI. Vroeger verrekenbaar met PB; sinds 1991 niet meer voor de woning, wel voor bedrijfsgebouwen onder voorwaarden.
### `vergelijkbaar_met`
- [[roerend-inkomen-pb]]
    - **Gelijkenissen**:
        - Beide zijn inkomstencategorieën in art. 6 WIB92
        - Beide worden globaal belast aan progressief tarief tenzij afzonderlijke aanslag
        - Beide worden 'bruteerd' met voorheffing voor de belastinggrondslag
    - **Verschillen**:
        - Onroerend inkomen: forfaitair via KI (geen werkelijke inkomsten-detectie)
        - Roerend inkomen: werkelijke ontvangen inkomsten, doorgaans afzonderlijk belast aan 30 % RV
        - Onroerend: progressief PB-tarief; Roerend: 30 % bevrijdende RV (vast tarief)
    - ⚠️ **Verwarringsrisico**: Studenten kunnen 'inkomen uit vastgoed' (onroerend) en 'inkomen uit vastgoed-aandelen / vastgoed-bevak' (roerend) verwarren. Aandelen in een vastgoed-vennootschap geven roerende dividenden, geen onroerend inkomen.
### `triggert`
- [[bedrijfsleidersbezoldiging]] — Bij overschrijding 5/3 × niet-geïndexeerd KI × 5,46 wordt de bovenmatige huur geherkwalificeerd als bezoldiging bedrijfsleider (art. 32, 3° WIB92).
