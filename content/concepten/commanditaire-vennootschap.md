...
_Instrument_ · afk: **CommV** · ook: Comm.V (oud) · société en commandite (SComm) · limited partnership
...
> [!example]- CommV familievermogensplanning ouder + 2 kinderen
...
> [!example]- Stille vennoot die zich inmengt — gevolgen
...
> [!example]- Investeringsfonds-structuur via CommV
...
> [!warning]- Commanditaire vennoot laten 'meedoen' in bestuur
...
> [!warning]- CommV verwarren met BV
...
> [!warning]- Enige gecommanditeerde vergeten te vervangen
