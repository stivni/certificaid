---
title: Controleproces in de organisatie
tags:
- concept
- procedure
- po-1-7
...
> Geen wettelijke verplichting; managementinstrument.
...
1. Strategisch doel formuleren.
2. Operationaliseren in concrete KPI's met streefwaarden.
3. Verantwoordelijken aanwijzen.

**Grondslag**: Managementcontrole-doctrine

### 2. Plan + middelen toewijzen
...
Budget per kostencentrum + verantwoordelijke + termijn.
...
Maandelijkse KPI-rapportering uit ERP.

**Grondslag**: Managementcontrole-doctrine

### 4. Vergelijken + analyseren afwijkingen
...
Per KPI: drempel definiëren (bv. >5% afwijking) → root cause analyse.

**Grondslag**: Variantieanalyse
...
Actieplan met termijn + eigenaar + opvolging in volgende periode.

**Grondslag**: PDCA-cyclus
