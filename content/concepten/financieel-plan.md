...
tags:
  ...
  - cat-regeling
  - status-concept
gegenereerd_uit: "data/concepten/records/financieel-plan.json"
---
...
🏢 Entiteit · 📋 Regeling · Anchors: `3.0.I.D` · `3.0.taak.1` · Wave: `skeleton-vennootschapsrecht-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: financial plan · plan financier — **Vertalingen**: fr: plan financier
...
```mermaid
flowchart TD
  A[Faillissement uitgesproken binnen 3 jaar na oprichting] --> B[Curator + rechter-commissaris onderzoeken oorzaken]
  B --> C[Verzoek aan notaris: financieel plan overmaken]
  C --> D[Rechtbank vergelijkt plan met realiteit]
  D --> E{Aanvangsvermogen 'kennelijk ontoereikend'?}
  E -->|Nee| F[Geen oprichtersaansprakelijkheid]
  E -->|Ja: hypothese onrealistisch, kosten onderschat, ...| G[Rechter beslist hoofdelijke aansprakelijkheid]
  G --> H[Bepaling verhouding aansprakelijk bedrag - art. 5:15/7:17]
  H --> I[Oprichters betalen schulden van vennootschap pro rata]
```
...
### 💡 BV TechStart — voorbeeld financieel plan (verkort) 🔗
...
### 💡 Case: financieel plan dat niet voldoet — oprichtersaansprakelijkheid 🔗
...
### 💡 Vergelijking VZW-begroting vs BV-financieel-plan

**Weergave** `vergelijkingstabel`:

```json
{
  "titel": "Financieel plan (BV/NV/CV) vs jaarlijkse begroting (VZW)",
  "kolommen": [
    "Aspect",
    "Financieel plan (WVV art. 5:4)",
    "Begroting VZW (WVV art. 9:23)"
  ],
  "rijen": [
    [
      "Wanneer opstellen?",
      "Eenmalig vóór oprichting",
      "Jaarlijks vóór AV (binnen 6 mnd na balansdatum)"
    ],
    [
      "Periode",
      "Min. 2 jaar (BV/NV), 3 jaar (CV)",
      "1 jaar"
    ],
    [
      "Wettelijke vorm",
      "7 minimumelementen",
      "Vrije vorm; vaak in JR-formaat"
    ],
    [
      "Bewaring",
      "Bij notaris 5 jaar",
      "Bij vereniging/AV-stukken"
    ],
    [
      "Sanctie ontbreken",
      "Oprichtersaansprakelijkheid (3 jaar)",
      "AV kan weigeren te decharge"
    ],
    [
      "Externe controle?",
      "Geen verplichte tussenkomst",
      "Verkort overzicht naar AV"
    ]
  ]
}
```
...
### ⚠️ Financieel plan = formaliteit zonder reëel belang
...
### ⚠️ Plan moet de werkelijkheid voorspellen
