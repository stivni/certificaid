...
**Status**: `in-voege` · basis: WIB92 art. 38 — 25° + art. 38/1 §3

Plafond 100 EUR/jaar nominaal in art. 38/1 §3 — niet jaarlijks geïndexeerd. Geldigheidsduur 15 maanden (langer dan maaltijdcheques, korter dan ecocheques).

**✅ Voor**
- 📖 Elke werkgever die werknemers of bedrijfsleiders een aanvullende welzijns-/cultuurgerichte vergoeding wil bieden, vaak als jaarlijkse extra naar aanleiding van een welzijnsbeleid of als 'attentie' (bv. begin schooljaar voor school-gerelateerde activiteiten).

**📋 Voorwaarden**
- 📖 Cumulatief (art. 38/1 §3): (1) toekenning in CAO sectoraal/ondernemingsvlak OF in een geschreven individuele overeenkomst (gelijke regeling werknemers en bedrijfsleiders); (2) cheque op naam; (3) geldigheidsduur max 15 maanden vanaf terbeschikkingstelling; (4) jaartotaal per werknemer max 100 EUR; (5) niet omruilbaar voor geld, geheel of gedeeltelijk.

**👍 Voordeel**
- 🔗 Volledig PB-vrij en RSZ-vrij voor de werknemer — 100 EUR netto extra. Bevordert deelname aan sportieve/culturele activiteiten — vaak gewaardeerd door personeel als 'menselijk' signaal.

**⚠️ Risico**
- 📖 Bij overschrijding van één voorwaarde vervalt de PB-vrijstelling voor het VOLLEDIGE bedrag. Voor de werkgever: zoals ecocheques is de werkgevers-tussenkomst ALTIJD volledig verworpen uitgave — vergeten in te vullen in code 1215 leidt tot onjuiste VenB-aangifte. Beperkt absolute voordeel: door het lage jaarplafond (100 EUR) is de impact op het loonpakket klein.
...
- [[maaltijdcheques]]
    ...
    - **Verschillen**:
        - Sport-cultuur-cheques: max 100 EUR/jaar · 15 maanden geldig · enkel erkende sport-/cultuurinstellingen · VOLLEDIG verworpen uitgave werkgever · geen werknemersbijdrage vereist
        - Maaltijdcheques: max 6,91 EUR/cheque werkgevers-tussenkomst + min 1,09 EUR werknemersbijdrage · 12 maanden geldig · 2 EUR/cheque aftrekbaar werkgever
    - ⚠️ **Verwarringsrisico**: Drie geldigheidsduren in dezelfde wettekst (12/15/24 maanden voor maaltijd/sport-cultuur/eco) zijn een klassiek examenvalkuil.
- [[ecocheques]]
    - **Gelijkenissen**:
        - Beide cheques uitsluitend besteedbaar in een specifiek domein (sport/cultuur of ecologie)
        - Beide volledig verworpen uitgave werkgever (code 1215)
        - Beide niet omruilbaar voor geld
    - **Verschillen**:
        - Sport-cultuur-cheques: 100 EUR/jaar · 15 maanden geldig · erkende instellingen
        - Ecocheques: 250 EUR/jaar · 24 maanden geldig · CAO 98-lijst NAR producten/diensten
    - ⚠️ **Verwarringsrisico**: Plafonds en geldigheidsduren wisselen.
