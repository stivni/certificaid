...
🏛️ Kader · Anchors: `1.4.I.D` · `1.4.I.E` · `1.4.II.C` · Wave: `skeleton-cross-cutting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: consolidatietechnieken — **Vertalingen**: fr: méthodes de consolidation · en: consolidation methods
...
### 💡 Cijferillustratie vermogensmutatie 🔗
...
### ⚠️ Methode-keuze 'optimaliseren' los van controle-realiteit
...
### ⚠️ Vermogensmutatie verwarren met deelnemings-waardering in enkelvoudige jaarrekening
...
### ⚠️ Consortium-leden = enkel integrale consolidatie
