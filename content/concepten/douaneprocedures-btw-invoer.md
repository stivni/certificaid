...
# Douaneprocedures BTW-invoer

_Procedure_

📋 Regeling · Anchors: `2.4.IX` · `2.4.X` · Wave: `skeleton-btw-internationaal-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: invoer-BTW · BTW bij import uit derde landen · ET 14.000
...
### 💡 Invoer container Chinese kleding — met ET 14.000 🔗
...
### ⚠️ ET 14.000-verlegging vergeten in de BTW-aangifte
...
### ⚠️ DAU als handelsfactuur behandelen
...
### ⚠️ Indirecte vertegenwoordiging gelijkstellen met directe
