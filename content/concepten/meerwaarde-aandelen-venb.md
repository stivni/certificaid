...
# Meerwaarde op aandelen — vennootschapsbelasting

_Regime_

📋 Regeling · Anchors: `2.3.II.I` · `2.3.II.J` · Wave: `fiscale-voordelen-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: meerwaarde aandelen VenB · art. 192 WIB92
...
### 💡 Aurelia Holding NV verkoopt 100 % Zelena Bio NV 🔗
...
### ⚠️ Vrijstelling toepassen op handelsportefeuille
...
### ⚠️ Vrijstelling i.p.v. correctie bij beperkte vrijstelling toepassen
...
### ⚠️ Confusie tussen PB-regime en VenB-regime meerwaarde aandelen
