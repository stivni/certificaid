...
_Procedure_ · ook: afronding van de opdracht · audit completion · opdrachtafronding · eindfase audit · audit closing
...
> [!warning]- Subsequent events = ‘nog snel even checken’
...
> [!warning]- Going concern = boekhoudprobleem van management
...
> [!warning]- Niet-gecorrigeerde fout < materialiteit = OK
...
- **Eind feb / begin mrt jaar T+1** — Definitieve jaarrekening beschikbaar · subsequent events review start

- **Maart** — Overall analytical review · misstatements-evaluatie · going-concern-toetsing

- **Maart-april** — Communicatie naar governance (memo significante bevindingen) · management letter opgesteld

- **Vóór datum verklaring** — Engagement quality review (indien PIE) · LOR ontvangen ondertekend

- **Datum verklaring** — Bestuur goedkeurt jaarrekening · auditor dateert en ondertekent verklaring

- **Daarna** — Subsequent events alert tot uitgifte aan derden (ISA 560 par. 10-13)
...
- → Going-concern-principe + diepe inhoud → [[continuiteit]] _(moet-verwijzen)_
