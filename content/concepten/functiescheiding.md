...
🏛️ Kader · Anchors: `1.7.VII` · `1.7.VIII.B` · `1.7.X.C` · Wave: `cluster-extract-controle-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: segregation of duties · separation of duties · functie-onverenigbaarheid · rolscheiding · taakverdeling — **Vertalingen**: fr: séparation des fonctions
...
### 💡 Functiescheiding aankoopcyclus bij Zelena Bio NV 🔗
...
### ⚠️ Pseudo-functiescheiding via gedeelde paswoorden
...
### ⚠️ Functiescheiding eisen in een te kleine entiteit
...
### ⚠️ Functiescheiding als magic bullet zien
