...
📋 Regeling · Anchors: `1.8.III.C` · Wave: `cluster-extract-management-accounting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: standard costing · voorafbepaalde kostenmethode · norm-kostenmethode — **Vertalingen**: fr: méthode des coûts standards
...
### 💡 Zelena Bio NV — standaardkost tafel + variantie 🔗
...
### ⚠️ Variantie altijd in resultaat schrijven, ongeacht materialiteit
...
### ⚠️ Ideale standaard gebruiken voor variantieanalyse
