...
📋 Regeling · 📅 Gebeurtenis · Anchors: `2.3.III` · `2.3.IV` · `2.3.taak.1` · `2.3.taak.2` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: Aangifte VenB — **Synoniemen**: VenB-aangifte · Biztax-aangifte · déclaration ISoc · formulier 275.1 — **Vertalingen**: fr: déclaration à l'impôt des sociétés
...
### 💡 BV met boekjaar = kalenderjaar — workflow AJ 2026 🔗
...
### 💡 NV met gebroken boekjaar 1-7 → 30-6 — andere termijn 📖
...
### 💡 Multinational met TP-verplichtingen — Local File + Master File 🔗
...
### ⚠️ AJ-conventie verwarren bij gebroken boekjaar
...
### ⚠️ Aangifte indienen vóór AV-goedkeuring
...
### ⚠️ TP-drempels op groepsniveau interpreteren
...
### ⚠️ Bijlagen vergeten = aangifte 'volledig'
