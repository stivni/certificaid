...
📅 Gebeurtenis · Anchors: `1.4.I.D` · `1.4.I.E` · `1.4.II.C` · Wave: `skeleton-cross-cutting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: proportional consolidation · proportionele integratie — **Vertalingen**: fr: consolidation proportionnelle · en: proportional consolidation
...
### 💡 Aurelia heeft 50 % van Vermeer Logistics SRL (joint venture) 🔗
...
### ⚠️ Evenredige consolidatie toepassen op een joint venture onder IFRS
...
### ⚠️ Intercompany op 100 % elimineren bij evenredige opname
...
### ⚠️ 'Belangen van derden' toevoegen bij evenredige consolidatie
