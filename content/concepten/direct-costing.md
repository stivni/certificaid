...
# Direct costing (variabele-kost-aanpak)

_Procedure_

📋 Regeling · Anchors: `1.8.III.B` · Wave: `cluster-extract-management-accounting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: variable costing · marginal costing · variabele-kostencalculatie — **Vertalingen**: fr: méthode du coût variable (direct costing)
...
### 💡 Zelena Bio NV — direct costing vs full costing bij voorraadwijziging 🔗
...
```json
{
  ...
  "rijen": [
    ...
    [
      "min Variabele productiekost verkocht",
      "800 × 250 = 200.000",
      "—"
    ],
    [
    ...
    [
      "min Cost of goods sold (variabel + vast pro rata)",
      "—",
      "800 × (250 + 100) = 280.000"
    ],
    [
    ...
    [
      "min Vaste productiekost in resultaat",
      "100.000 (volledig)",
      "20.000 (alleen idle-deel + niet-toegerekend)"
    ],
    [
      "= Bedrijfsresultaat",
      "100.000",
...
### ⚠️ Direct costing-prijs als langetermijn-prijs gebruiken
...
### ⚠️ Direct costing gebruiken in de gepubliceerde jaarrekening
