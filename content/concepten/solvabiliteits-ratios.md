...
🏛️ Kader · Anchors: `1.3.II.C` · `1.9.V.C` · Wave: `cluster-extract-financiele-analyse-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: solvabiliteitsindicatoren · langetermijn-ratio's — **Vertalingen**: en: solvency ratios · fr: ratios de solvabilité
...
#### 💡 Schuldgraad — Zelena Bio NV (20X4) 🔗
...
### ⚠️ Eigen vermogen ongecorrigeerd nemen
...
### ⚠️ Achtergestelde leningen verkeerd classificeren
...
### ⚠️ Off-balance financiering negeren
...
### ⚠️ ICR uit netto-resultaat berekenen
