...
_Instrument_ · afk: **SHA** · ook: shareholders agreement · SHA · syndicaatsovereenkomst · aandeelhoudersovereenkomst
...
> [!example]- Start-up SHA — founders + VC-investeerder
...
> [!example]- Familievennootschap — stand-stillclausule bij overdracht
...
> [!example]- Voorkooprecht (ROFR) — concrete uitwerking
...
> [!warning]- Voorkooprecht SHA = voorkeurrecht WVV
...
> [!warning]- Stemovereenkomst altijd geldig
