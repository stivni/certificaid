---
title: "Kapitaalverhoging in natura"
...
tags:
  ...
  - cat-regeling
  - status-concept
gegenereerd_uit: "data/concepten/records/kapitaalverhoging-in-natura.json"
---

_Verrichting_ · ook: inbreng in natura bij kapitaalverhoging · natura-inbreng
...
```mermaid
flowchart TD
  A[Bestuursorgaan: ontwerp-verslag waarom inbreng van belang is + beschrijving + waardering] --> B[Aanwijzing bedrijfsrevisor]
  B --> C[Revisor onderzoekt waarderings-methodes]
  C --> D[Revisor verklaart of waardering minstens = aantal x fractiewaarde + uitgiftepremie]
  D --> E{Revisor: redelijk?}
  E -->|Ja| F[Definitief bestuurdersverslag + revisorverslag]
  E -->|Afwijking| G[Bestuur motiveert afwijking]
  G --> F
  F --> H[Voorleggen aan AV - agenda vermeldt verslagen]
  H --> I[AV beslist 75 procent meerderheid]
  I --> J[Notariële akte + neerlegging + bekendmaking]
```
...
> [!example]- BV ProdCo — inbreng machine vanuit eenmanszaak
...
>
> **📒 Boeking in BV ProdCo — Inbreng machine**
>
...
>
> **📋 Fiscale impact bij Tom (eenmanszaak PB)**
>
...
>
> → **Bij inbreng in BV: spreiding lastig want machine zit nu IN de BV. Daarom vaak voorkeur voor art. 46 inbreng-bedrijfstak als de hele eenmanszaak wordt overgedragen.**
>
> <small>🔗 WVV — art. 5:112 — _wettekst_ · WIB92 — art. 47 — _wettekst_</small>

> [!example]- BV Vastgoed Pro — inbreng commercieel pand (art. 115bis)
...
>
> **📒 Boeking BV — Inbreng onroerend**
>
> **📋 Registratierechten — inbreng vs verkoop**
>
> | Scenario | Wettelijke basis | Tarief / vast recht | Bedrag op €500.000 |
>
> | --- | --- | --- | --- |
>
> | Inbreng zuiver in vennootschap (art. 115bis) | Wb Reg art. 115bis | €50 algemeen vast recht | €50 |
>
> | Verkoop aan vennootschap | Wb Reg gewoon verkooprecht | 12% Vlaams / 12,5% Brussel | €60.000 / €62.500 |
>
> | Gemengde inbreng (deels schuld overgenomen) | 115bis + gewoon recht op geld-deel | Pro rata 12% | Afhankelijk van geld-deel |
>
> → **Vrijstelling 115bis = ca. €60.000 besparing t.o.v. verkoop. Voorwaarde: zuivere inbreng (alleen aandelen als tegenprestatie).**
>
> <small>🔗 Wb Reg — art. 115bis — _wettekst_ · WVV — art. 5:112 — _wettekst_</small>

> [!example]- Holding-structurering — inbreng aandelen werkmaatschappij
...
>
> **📒 Boeking HoldCo — Inbreng aandelen WerkCo**
>
...
> [!warning]- Revisor bepaalt de waardering
...
> [!warning]- Art. 115bis vrijstelling = altijd toepasselijk
...
> [!warning]- Inbreng = belastingneutraal
