...
# Full costing (volledige kostencalculatie)

_Procedure_

📋 Regeling · Anchors: `1.8.III.A` · Wave: `cluster-extract-management-accounting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: absorptie-methode · full absorption costing · volledige kostencalculatie — **Vertalingen**: fr: méthode du coût complet
...
### 💡 Zelena Bio NV — full costing met idle capacity 🔗
...
### ⚠️ Vaste overhead 'gewoon' delen door werkelijke productie
...
### ⚠️ Verkoopkosten in productkost meenemen
