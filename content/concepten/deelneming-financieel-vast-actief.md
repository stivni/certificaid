...
# Deelneming als financieel vast actief

_Balanspost_

🏢 Entiteit · Anchors: `1.1.II.C` · Wave: `cluster-extract-balansposten-activa-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: deelneming · financial fixed asset — **Vertalingen**: en: participation as financial fixed asset · fr: participation — immobilisation financière
...
#### 💡 Aurelia Holding koopt 60% Zelena Bio voor 1.500.000 EUR 🔗
...
### ⚠️ Inter-companylening renteloos boeken
...
### ⚠️ Waardevermindering = automatisch fiscaal aftrekbaar
