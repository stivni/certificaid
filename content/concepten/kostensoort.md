...
<h3 id="drie-hoofdcategorieen-in-management-accounting">Drie hoofdcategorieën in management-accounting</h3>

> [!tip]- Drie hoofdcategorieën in management-accounting
> Voor analytische doeleinden worden kostensoorten typisch samengevoegd tot drie blokken: (1) materialen, (2) arbeid, (3) overige kosten (huur, energie, afschrijvingen, externe diensten). Deze drie-deling stuurt de bundle-structuur van het ITAA-programmaonderdeel 1.8.II.B/C/D. 🤖


> [!info]- Niet verwarren met [[kostencentrum]]
> Kostensoort = WAT (aard van de kost). Kostencentrum = WAAR (afdeling die de kost maakt). Kostendrager = VOOR WIE (product/klant/order dat de kost veroorzaakt).
>
