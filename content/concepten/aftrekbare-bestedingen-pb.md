...
📋 Regeling · Anchors: `2.2.XI` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

> [!warning] **Uitdovend regime** — wordt afgebouwd; check sinds-/tot-data.

**Synoniemen**: aftrek van het totale netto-inkomen · art. 104 WIB-aftrek — **Vertalingen**: fr: dépenses déductibles
...
### 💡 Aftrek 70%-alimentatie aan ex-echtgenoot — AJ 2025 🔗
...
### 💡 Zelfde casus AJ 2028 (vanaf 1/1/2027) — afbouw naar 50% 📖
...
### 💡 Co-ouderschap → aftrek alimentatie keuze-cascade 🔗
...
### ⚠️ 80%-percentage uit oude cursussen klakkeloos gebruiken
...
### ⚠️ Aftrek verwarren met belastingvermindering
...
### ⚠️ Onderhoudsuitkering aan persoon BUITEN EER aftrekken
...
### ⚠️ Vrijwillige geldelijke steun zonder wettelijke onderhoudsplicht aftrekken
