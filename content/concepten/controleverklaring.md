...
_Instrument_ · ook: auditverslag · controleverslag · audit report · audit opinion · commissarisverslag
...
> [!warning]- ‘Emphasis of Matter’ als compromis voor moeilijk oordeel
...
> [!warning]- Going-concern-onzekerheid = altijd voorbehoud
...
> [!warning]- KAM beperkt zich tot wat er fout liep
...
| Oordeel | Trigger | Mate (materieel?) | Diepgaand? |
| --- | --- | --- | --- |
| Zonder voorbehoud | Voldoende bewijs + getrouw beeld | — | — |
| Met voorbehoud — afwijking | Bewijs van materiële afwijking aanwezig | Ja | Nee |
| Met voorbehoud — beperking | Onvoldoende bewijs voor specifiek punt | Ja (mogelijk) | Nee |
| Afkeurend | Bewijs van afwijking | Ja | Ja |
| Onthouding | Onvoldoende bewijs | Ja (mogelijk) | Ja |
