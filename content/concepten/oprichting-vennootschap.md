---
title: "Oprichting van een vennootschap"
...
tags:
  ...
  - cat-regeling
  - status-concept
gegenereerd_uit: "data/concepten/records/oprichting-vennootschap.json"
---
...
📅 Gebeurtenis · 📋 Regeling · Anchors: `3.0.I.C` · `3.0.taak.1` · Wave: `skeleton-vennootschapsrecht-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: vennootschapsoprichting · incorporation · start-up vennootschap — **Vertalingen**: fr: constitution d'une société
...
```mermaid
flowchart TD
  A[Keuze rechtsvorm + statuten-ontwerp] --> B[Financieel plan opstellen]
  B --> C{Inbreng?}
  C -->|Geld| D[Geblokkeerde rekening bank — bewijs storting]
  C -->|Natura| E[Oprichtersverslag + revisorverslag]
  D --> F[Notariële akte verlijden]
  E --> F
  F --> G[Notaris bezorgt financieel plan + verslagen]
  G --> H[Neerlegging uittreksel bij griffie ondernemingsrechtbank]
  H --> I[Inschrijving KBO + ondernemingsnummer]
  I --> J[BTW-identificatie KB 10 art. 7]
  J --> K[Bekendmaking Bijlagen Belgisch Staatsblad]
  K --> L[Vennootschap operationeel]
```
...
### 💡 BV Nova — oprichting met inbreng in geld, oprichtingskosten geactiveerd 🔗
...
**Balans-snapshot**: `Eigen vermogen €50.000 (volledig onbeschikbare inbreng, BV-statuut). Activa zijn volledig liquide na aftrek oprichtingskosten.`

```json
{
  "titel": "Beginbalans BV Nova op 15-03-2026 (na akte + boeking kosten)",
  "activa": {
  ...
  "toelichting": "Eigen vermogen €50.000 (volledig onbeschikbare inbreng, BV-statuut). Activa zijn volledig liquide na aftrek oprichtingskosten."
}
```

<small>📚 WVV — art. 5:3 — _wettekst_ · KB 29-04-2019 WVV — art. 3:36 — _kb_</small>

### 💡 NV Atelier — oprichting met inbreng in natura (machine) + geld 🔗
...
**Balans-snapshot**: `Eigen vermogen netto = €75.000 − €22.500 − €3.500 = €49.000. Geplaatst kapitaal €75.000 voldoet aan €61.500-minimum (ook al is niet alles volstort). Verlies €3.500 = oprichtingskosten direct ten laste.`

```json
{
  "titel": "Beginbalans NV Atelier op 01-06-2026",
  "activa": {
  ...
  "toelichting": "Eigen vermogen netto = €75.000 − €22.500 − €3.500 = €49.000. Geplaatst kapitaal €75.000 voldoet aan €61.500-minimum (ook al is niet alles volstort). Verlies €3.500 = oprichtingskosten direct ten laste."
}
```

<small>📚 WVV — art. 7:2 — _wettekst_ · WVV — art. 7:7 — _wettekst_ · WVV — art. 7:13 — _wettekst_</small>

### 💡 Vergelijking — Oprichtingskosten activeren vs direct ten laste (impact 5 jaar) 🔗
...
```json
{
  "titel": "Resultaat over 5 jaar — scenario A (activeren 20%/jaar) vs scenario B (direct ten laste)",
  "kolommen": [
    "Jaar",
    "Scenario A — activeren (afschr. €1.000)",
    "Scenario B — direct ten laste"
  ],
  "rijen": [
    [
      "1",
      "€19.000 (resultaat na €1.000 afschr.)",
      "€15.000 (resultaat na €5.000 kost)"
    ],
    [
      "2",
      "€19.000",
...
### ⚠️ BV heeft 'geen kapitaal' — verwarring
...
### ⚠️ Oprichtingskosten ineens afschrijven = altijd OK
...
### ⚠️ Notariële akte = oprichtingsmoment
