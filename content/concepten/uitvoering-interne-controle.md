---
title: Uitvoering van interne controle — aanpak
tags:
- concept
- procedure
- po-1-7
...
> Geen wettelijke verplichting voor KMO's; voor organisaties van openbaar belang en grote NV's deels via WVV, Corporate Governance Code en sectorale toezichtsregels.

> [!info] Behoort tot: [[interne-controle]]

Geen wettelijke verplichting voor KMO's; voor organisaties van openbaar belang en grote NV's deels via WVV, Corporate Governance Code en sectorale toezichtsregels. Voor wettelijke commissaris-controle: ITAA-norm-kmo-controlenorm verplicht de beroepsbeoefenaar de IC te begrijpen.


## Stappen

### 1. Doelstellingen + risico's identificeren
...
1. Lijst de strategische doelstellingen op (uit ondernemingsplan).
...
**Grondslag**: COSO ERM-doctrine

### 2. Bestaande controles in kaart brengen
...
1. Interview per proces de uitvoerder.
...
**Grondslag**: COSO-doctrine + audit-walkthrough-practice

### 3. Taakverdeling vastleggen
...
1. Voor elk kernproces: lijst de vier functies op.
...
**Grondslag**: Vier-functies-doctrine

### 4. Opvolging en monitoring inrichten
...
1. Definieer indicatoren per controle (bv. % facturen met dubbele handtekening).
...
**Grondslag**: COSO monitoring-component
...
1. Jaarlijkse formele evaluatie door management.
...
**Grondslag**: COSO continuous improvement-cyclus
