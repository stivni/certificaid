...
🏛️ Kader · Anchors: `1.4.I.D` · Wave: `skeleton-consolidatie-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: belangen van derden · non-controlling interests · NCI · minority interests
...
### 💡 Minderheidsbelang in CBN 2022/09 voorbeeld 10 (80%-dochter) 📖
...
```json
{
  "titel": "Geconsolideerde balans X + X1 — EV-deel",
...
### ⚠️ Verwarring met minderheidsvordering (WVV)
