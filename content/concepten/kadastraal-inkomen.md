...
📋 Regeling · Anchors: `2.2.V` · `2.2.V.A` · `2.7.II.A` · `2.7.II.B` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: KI — **Synoniemen**: revenu cadastral · kadastraal inkomen onroerend goed — **Vertalingen**: fr: revenu cadastral
...
### 💡 Vaststelling KI bij nieuwbouw — vrijstaande woning 🔗
...
### 💡 Aanzienlijke wijziging — kelderverdieping omgevormd tot praktijkruimte 🔗
...
### 💡 Indexering KI — illustratie indexcoëfficiënt AJ 2025 🔗
...
### ⚠️ Geïndexeerd KI verwarren met niet-geïndexeerd basis-KI
...
### ⚠️ Vergeten dat bezwaartermijn KI maar 2 maanden is
...
### ⚠️ Bouwen-zonder-aangifte denken te ontsnappen
