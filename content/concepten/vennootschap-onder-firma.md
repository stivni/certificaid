...
_Instrument_ · afk: **VOF** · ook: société en nom collectif (SNC) · general partnership
...
> [!example]- VOF familie-restaurant (3 broers)
...
> [!example]- Aansprakelijkheid bij faillissement VOF
...
> [!example]- Omzetting VOF → BV bij groei
...
> [!warning]- VOF en maatschap door elkaar halen
...
> [!warning]- VOF kiezen omdat 'geen kapitaal nodig'
...
> [!warning]- Subsidiariteit van vennootschapsvermogen overschatten
