...
_Kader_ · ook: internationale dividenden interest royalty's · cross-border RV-regime · DBV-tarieven roerend
...
> [!example]- Belgische moeder ontvangt dividend van Franse dochter
> _Aurelia Holding NV (BE, 25 %-belang sinds 5 jaar) ontvangt bruto-dividend 1.000.000 EUR van Bordeaux SAS (FR-dochter)._
>
> 1. Stap 1 — uitkerende kant (FR): moeder-dochterrichtlijn → 0 % bronheffing (≥ 10 % + ≥ 1 jaar).
> 2. Stap 2 — ontvangende kant (BE): dividend opgenomen in resultaat 1.000.000 EUR.
> 3. Stap 3 — DBI-aftrek art. 202 WIB92: 100 % aftrek mits taxatievoorwaarde (FR VenB) + bezitsduur + 10 %-minimum vervuld.
> 4. Stap 4 — effectief belastbaar in BE: 0 EUR (volledige DBI-aftrek).
> 5. Stap 5 — totale belastingdruk: enkel FR VenB op de winst waarmee het dividend werd uitgekeerd (geen bronheffing, geen BE-VenB).
>
...
> [!example]- Belgische particulier ontvangt portfolio-dividend uit Duitsland
...
> [!warning]- Moeder-dochterrichtlijn ook op niet-EU-dochter toepassen
...
> [!warning]- Bezitsduur-eis voor moeder-dochter vergeten
...
> [!warning]- Beneficial-owner-vereiste onderschatten
