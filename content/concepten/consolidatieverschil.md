...
_Kader_ · ook: consolidatieverschil-goodwill · goodwill · badwill
...
```
Consolidatieverschil = Koopprijs − ( % belang × Fair-value-NA dochter )
...
| Aspect | B-GAAP (KB-WVV art. 3:131) | IFRS (IFRS 3 + IAS 36) |
|---|---|---|
...
> [!example]- Aurelia koopt Zelena Bio — positieve goodwill
...
>
> Boeking eerste consolidatie (B-GAAP, vereenvoudigd):
> - Debet  211 Goodwill (consolidatieverschil)     300.000
> - Debet  diverse activa Zelena (fair value)    1.500.000
> - Credit diverse passiva Zelena (fair value)    300.000
> - Credit 28 Deelneming Zelena                  1.500.000
>
> <small>🔗 KB-WVV — art. 3:130-3:131 — _wettekst_ · claude-sonnet-4-5 — _ai_model_ — (2026-05-28)</small>

> [!example]- Reorganisatie-overname met badwill
...
> [!warning]- Boekwaarde gebruiken in plaats van fair value
...
> [!warning]- Goodwill afschrijven onder IFRS
...
> [!warning]- Badwill direct als winst boeken zonder hertoetsing
