...
🏛️ Kader · Anchors: `1.8.III.E` · Wave: `cluster-extract-management-accounting-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: marginal analysis · relevant cost analysis · incrementele kostenanalyse — **Vertalingen**: fr: analyse marginale
...
### 💡 Zelena Bio NV — special order met vrije capaciteit 🔗
...
### 💡 Make-or-buy — Aurelia Holding NV en sub-component 🔗
...
### ⚠️ Vaste overhead-allocatie als relevant beschouwen
...
### ⚠️ Sunk cost gebruiken als argument om door te gaan
...
### ⚠️ Special-order-prijs als reguliere prijs
