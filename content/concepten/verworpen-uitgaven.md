...
**Status**: `in-voege` · basis: WIB92 art. 52-66 (algemene niet-aftrekbaarheid) + art. 198-198/1 + art. 219 (afzonderlijke aanslag)

Stabiel kader; periodieke uitbreidingen (Pijler 2 sinds 2024, EBITDA-regel sinds 2019 ATAD, hybridemismatch ATAD II 2020) en aanpassingen van plafonds. Specifieke afbouw aangekondigd in komende hervormingen (bv. nieuwe aanpak autokosten 2030).

**✅ Voor**
- 📖 Vennootschappen die de VenB-aangifte voorbereiden: voor elke boekhoudkundige kost moet worden nagegaan of die fiscaal volledig, gedeeltelijk of niet aftrekbaar is — en het verworpen deel toegevoegd worden aan de belastbare grondslag.

**📋 Voorwaarden**
- 📖 Boekhoudkundige verwerking: kost geboekt als beroepskost (klasse 6) → boekhoudkundig resultaat verlaagd. Fiscaal: per categorie (art. 53, 66, 198, etc.) bepalen welk deel verworpen wordt → toevoeging aan belastbare grondslag (Bewerking 2). Bewijslast (art. 49 + art. 340 WIB): belastingplichtige toont aftrekbaarheid + bedrag van de kost.

**⚠️ Risico**
- 🔗 Verzuim VU correct te coderen → fiscus voegt zelf toe (bij controle) + nalatigheidsintrest + mogelijk belastingverhoging. · Niet-verantwoorde kosten verkeerd boeken → triggert afzonderlijke aanslag art. 219 (100% verhoogd, 50% verminderd). · Restaurant + receptiekosten samen boeken in één rekening 6135 → onmogelijke uitsplitsing voor 31% vs 50%-aftrekbaarheid.
...
### Vennootschap — VenB-aangifte

_De accountant die de VenB-aangifte van een vennootschap voorbereidt of nakijkt — VU is de kern van de fiscale aanpassingen op de boekhoudkundige winst._
...
- → Beroepskosten in PB-context (generieke aftrekbaarheidstest art. 49 WIB) → [[beroepskosten]] _(moet-verwijzen)_
- → Autokosten-CO2-aftrekbeperking (VenB-detailregeling) → [[autokosten]] _(moet-verwijzen)_
- → Bijzondere aanslagen VenB (cross: niet-verantwoorde kosten → art. 219) → [[bijzondere-aanslagen-venb]] _(moet-verwijzen)_
- → Abnormale of goedgunstige voordelen (sub-categorie art. 26) → [[abnormale-goedgunstige-voordelen]] _(moet-verwijzen)_
- → EBITDA-aftrekbeperking (sub-categorie financieringskostensurplus) → [[ebitda-aftrekbeperking]] _(moet-verwijzen)_
...
- [[belastbare-grondslag-vennootschapsbelasting]] — VU = Bewerking 2 (KB-WIB art. 76): toevoeging aan belastbare gereserveerde winst.
### `vergelijkbaar_met`
- [[beroepskosten]]
    - **Gelijkenissen**:
        - Beide werken op zelfde uitgaven (kostenstroom uit klasse 6)
        - Beide vereisen bewijslast (art. 49 + art. 340)
        - Beide hanteren aftrekpercentages voor specifieke categorieën (auto, restaurant, receptie)
    - **Verschillen**:
        - Beroepskosten (art. 49) = PB-context: aftrek van bruto-inkomen → belastingbesparing aan marginaal tarief
        - Verworpen uitgaven = VenB-context: add-back op boekhoudkundige winst → extra VenB
        - VU heeft eigen aangifte-codes (1201-1265); beroepskosten heeft eigen rubrieken in PB-aangifte
    - ⚠️ **Verwarringsrisico**: Studenten verwarren 'beroepskosten' (PB-fenomeen) met 'verworpen uitgaven' (VenB-fenomeen) — terwijl het inhoudelijk hetzelfde soort uitgaven betreft met andere fiscale techniek.
### `bevat`
- [[abnormale-goedgunstige-voordelen]] — Code 1212 — abnormale/goedgunstige voordelen art. 26 zijn sub-categorie binnen VU.
- [[ebitda-aftrekbeperking]] — Code 1262 — financieringskostensurplus boven 30%-EBITDA-drempel (art. 198/1) is sub-categorie binnen VU.
### `triggert`
- [[bijzondere-aanslagen-venb]] — Code 1225 — niet-verantwoorde kosten + verdoken meerwinsten triggeren afzonderlijke aanslag art. 219 bovenop gewone VU.
