...
_Principe_ · ook: geactiveerde interest · capitalized borrowing costs
...
> [!example]- Bouw machine 24 maanden — rente 100.000 EUR geactiveerd
> _Zelena Bio NV bouwt productie-installatie (1.000.000 EUR) over 24 maanden met bouwlening 5% rente._
>
> **📒 Rente tijdens bouwjaar 1 (geactiveerd 50.000 EUR)**
>
> | Rekening | Debet | Credit |
> | --- | --- | --- |
> | 650 — Rente op leningen | 50.000 |  |
> | 550 — Bank |  | 50.000 |
>
> **📒 Activering rente (compensatie)**
>
> | Rekening | Debet | Credit |
> | --- | --- | --- |
> | 27 — Vaste activa in aanbouw | 50.000 |  |
> | 651 — Geactiveerde financieringskosten (-) |  | 50.000 |
>
> <small>🔗 cluster-extract-agent (opus-4.7-1M) — _ai_model_ — (2026-05-28)</small>

## Valkuilen

> [!warning]- Rente activeren na ingebruikname
...
> [!warning]- Activering niet vermeld in toelichting
...
> [!warning]- IFRS-keuze verwarren met Be-GAAP-keuze
