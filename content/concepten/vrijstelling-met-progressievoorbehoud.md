...
_Regime_ · ook: exemption with progression · vrijstelling onder progressievoorbehoud · exonération sous réserve de progressivité
...
> [!example]- Belgische gepensioneerde met tweede verblijf in Frankrijk
...
> [!example]- Detachering werknemer naar Duitsland (>183 dagen)
...
> [!example]- Afzonderlijk belastbaar buitenlands inkomen (Circ. 2022/C/106)
...
> [!warning]- Denken dat 'vrijgesteld' = geen impact op Belgische belasting
...
> [!warning]- Vrijstelling toepassen zonder DBV te controleren
...
> [!warning]- Buitenlands inkomen niet aangeven omdat het 'toch vrijgesteld is'
