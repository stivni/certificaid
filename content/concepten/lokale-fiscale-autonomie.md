---
title: "Lokale fiscale autonomie"
concept_type: "kader"
schema_version: "2.2"
status: "concept"
categorieen:
...
**Status**: `in-voege` · basis: Grondwet art. 41, 162, 165, 170 §4, 172, 173 + Decreet Lokaal Bestuur (Vlaanderen) / Code de la démocratie locale (Wallonië) / Brusselse Gemeentewet

**✅ Voor**
- 🔗 Bij elke gemeentebelasting eerst controleren: (1) bestaat een geldig belastingreglement, gestemd door de raad, gepubliceerd en zonder schorsing door de toezichthoudende overheid? (2) valt het belastbaar feit niet onder een wettelijk verbod (bv. WIB92 art. 464)? (3) is het tarief en de grondslag niet kennelijk onredelijk of discriminerend?

**⛔ Uitsluitingen**
- 📖 Verboden lokale belastingen (WIB92 art. 464): opcentiemen op PB, VenB, RPB, BNI of gelijkaardige belastingen op grondslag of bedrag van deze belastingen; belastingen op vee. Uitzondering: aanvullende gemeentebelasting op PB en gemeentelijke opcentiemen op onroerende voorheffing zijn uitdrukkelijk wel toegelaten. VCF art. 2.3.4.2.2 verbiedt lokale opcentiemen op BIV.
...
_De accountant adviseert of vertegenwoordigt de cliënt bij betwisting van een gemeentebelasting._
...
- → Gewestelijke fiscale autonomie → [[gewestelijke-fiscale-autonomie]] _(moet-verwijzen)_
...
- [[gewestelijke-fiscale-autonomie]]
    - **Gelijkenissen**:
        - Beide vormen sub-federale fiscale bevoegdheid binnen art. 170 GW
        - Beide moeten gelijkheidsbeginsel en non-bis-in-idem respecteren
    - **Verschillen**:
        - Lokaal: niveau gemeente/provincie; instrument = belastingreglement van de raad; geen delegatie aan college mogelijk
        - Gewestelijk: niveau Vlaanderen/Wallonië/Brussel; instrument = decreet/ordonnantie; gewestregering kan binnen decreet uitvoeringsregels stellen
        - Lokaal mag GEEN opcentiemen op PB/VenB/BNI (WIB92 art. 464); gewest wel
    - ⚠️ **Verwarringsrisico**: In de praktijk worden beide door practici en cliënten verward — 'het Vlaamse Gewest heft' wordt soms verkeerd toegepast op een gemeentebelasting binnen Vlaanderen.
