...
_Regime_ · ook: persoonlijke RSZ-bijdrage · sociale zekerheidsbijdragen werknemer · ingehouden RSZ
...
> [!example]- Inhouding RSZ-werknemer op brutoloon 3.000 EUR
...
>
> **📒 Vereenvoudigde loonboeking — werknemers-kant (focus inhouding)**
>
> | Rekening | Debet | Credit |
> | --- | --- | --- |
> | 620 — Bezoldigingen | 3.000 |  |
> | 454 — RSZ (werknemer-deel) |  | 392 |
> | 453 — Ingehouden BV |  | 500 |
> | 455 — Bezoldigingen |  | 2.108 |
>
> <small>🔗 cluster-extract-agent (opus-4.7-1M) — _ai_model_ — (2026-05-28)</small>

## Valkuilen

> [!warning]- RSZ-werknemer dubbel opnemen — als kost én als inhouding
...
> [!warning]- Werkbonus vergeten bij lage lonen
...
> [!warning]- BBSZ op kwartaal- in plaats van gezinsbasis berekenen
