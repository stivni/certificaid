...
_Procedure_ · ook: controleplanning · engagement planning · planningsfase · audit planning
...
> [!warning]- Planning = standaard checklist invullen
...
> [!warning]- Materialiteit = 5% van winst — altijd
...
> [!warning]- Risico = kans op fout — vergeten van impact
...
- **Sept-okt jaar T** — Cliëntcontinuering · update inzicht entiteit (gesprekken management, nieuwsmonitoring sector)

- **Okt-nov jaar T** — Walk-through significante cycli · evaluatie interne beheersing · IT-audit-input

- **Nov jaar T** — Materialiteit bepalen op basis van interim-cijfers · team-bespreking fraude (ISA 240)

- **Nov-dec jaar T** — Risico-inschatting per assertion · significant risks identificeren · werkprogramma opstellen

- **Dec jaar T** — Communicatie planning naar management/governance — geplande timing, materialiteit (in algemene termen), aandachtsgebieden
