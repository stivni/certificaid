...
**Status**: `in-voege` · sinds **2019-03-01** · basis: Wet van 17 maart 2019 betreffende de invoering van een mobiliteitsbudget (BS 29-03-2019); diverse wijzigingen (wet 25-11-2021) breidden Pijler 2 uit en versoepelden de toegangsvoorwaarden.

Sinds de afschaffing van cash-for-car voor nieuwe gevallen is het mobiliteitsbudget het enige actieve federale 'wagen-inruil'-regime.

**✅ Voor**
- 🤖 Werknemers die al ≥12 maanden over een bedrijfswagen beschikken (of er recht op hebben gehad) bij hun huidige werkgever, en die hun wagen-recht willen inruilen voor een flexibel mobiliteitspakket.
- 🤖 Werkgevers die ten minste 36 maanden ononderbroken een of meerdere bedrijfswagens ter beschikking stelden vóór invoering van het mobiliteitsbudget-systeem (toegangsvoorwaarde werkgever).

**📋 Voorwaarden**
- 🤖 Schriftelijke aanvraag door werknemer + schriftelijk akkoord werkgever; werkgever bepaalt vrij of hij het systeem aanbiedt.
- 📖 Niet-cumuleerbaar met de fiscale vrijstellingen voor woon-werkverplaatsing met openbaar vervoer (WIB92 art. 38 §1, eerste lid, 9°) en met de fiscale fietsvergoeding (WIB92 art. 38 §1, eerste lid, 14°), TENZIJ het geval bedoeld in art. 10, §3 van de wet 17-03-2019.

**👍 Voordeel**
- 🔗 Werknemer wint keuzevrijheid (multimodaal vervoer) zonder loonverlies in koopkracht — pijler 2-bestedingen zijn fiscaal volledig vrijgesteld.
- 🤖 Werkgever vermijdt CO2-solidariteitsbijdrage voor het deel dat in pijler 2 of 3 belandt; HR-imago en duurzaamheidsobjectief profiteren.

**⚠️ Risico**
- 🤖 Onjuiste TCO-berekening (referentiewagen vs. werkelijke kost) kan budget structureel te laag of te hoog zetten — administratieve revisie nodig bij verandering van wagen-categorie of bij wijziging fiscale spelregels.
- 📖 Cumul-verbod met vrijstellingen 9° en 14° (WIB92 art. 38) — een werknemer die mobiliteitsbudget krijgt én tegelijk klassieke woon-werkvergoeding ontvangt, verliest die laatste vrijstelling tenzij uitzondering art. 10 §3.
...
### Werkgever-vennootschap die mobiliteitsbudget aanbiedt

_De accountant adviseert de werkgever bij invoering, helpt de TCO bepalen en zorgt voor correcte boekhoudkundige + fiscale verwerking._
...
_De accountant adviseert de werknemer over de keuze tussen wagen-behoud en mobiliteitsbudget, en over optimale verdeling over de 3 pijlers._
...
- → Reguliere bedrijfswagen + autokosten → [[autokosten]] _(moet-verwijzen)_
- → Cash-for-car (alternatief, uitdovend) → [[cash-for-car]] _(moet-verwijzen)_
- ↪ Woon-werkverkeer + km-vergoeding (overlap pijler 2) → [[woon-werkverkeer-en-km-vergoeding]] _(mag-verwijzen)_

## Relaties

### `vergelijkbaar_met`
- [[autokosten]] — Pijler 1 van het mobiliteitsbudget volgt de gewone bedrijfswagen-fiscaliteit (autokosten-regime).
    - **Gelijkenissen**:
        - Beide gebruiken WIB92 art. 36 §2 VAA-formule voor de wagen
        - Beide vallen onder de aftrekbeperking WIB92 art. 66
    - **Verschillen**:
        - Mobiliteitsbudget heeft een TCO-plafond + keuzevrijheid; klassieke bedrijfswagen niet
        - Mobiliteitsbudget kent een cumul-verbod met km-vergoeding; klassieke wagen niet automatisch
    - ⚠️ **Verwarringsrisico**: Stagiairs verwarren soms 'mobiliteitsbudget' met 'mobiliteitsvergoeding' — de eerste is het 3-pijlerssysteem; de tweede (cash-for-car) is de uitdovende geldsom-variant.
- [[cash-for-car]] — Beide regimes zetten een bedrijfswagen-recht om in iets anders, maar het mobiliteitsbudget heeft 3 keuze-pijlers waar cash-for-car enkel een geldsom voorzag.
    - **Gelijkenissen**:
        - Beide vereisen anciënniteit bij werkgever
        - Beide veronderstellen werknemer ruilt bedrijfswagen-recht in
        - Beide hebben gunstig fiscaal regime t.o.v. klassiek loon
    - **Verschillen**:
        - Cash-for-car: één forfaitair belastbaar voordeel; mobiliteitsbudget: 3 pijlers met eigen fiscaal regime
        - Cash-for-car is uitdovend (geen nieuwe gevallen); mobiliteitsbudget is de actieve regeling
    - ⚠️ **Verwarringsrisico**: Naamovereenkomst (beide 'mobiliteit') — let op: cash-for-car is officieel 'mobiliteitsvergoeding', mobiliteitsbudget is een 3-pijlersysteem.
### `niet_combineerbaar_met`
- [[woon-werkverkeer-en-km-vergoeding]] — WIB92 art. 38 sluit cumulatie met de vrijstellingen voor openbaar-vervoer (9°) en fietsvergoeding (14°) uit, behalve onder art. 10 §3 wet 17-03-2019.
### `gedocumenteerd_in`
- [[autokosten]] — Voor TCO-bepaling pijler 1 en VAA-mechaniek bedrijfswagen: zie record autokosten.
