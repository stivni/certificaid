...
📅 Gebeurtenis · Anchors: `1.4.I.D` · `1.4.II.C` · Wave: `skeleton-consolidatie-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: foreign currency translation · valuta-omrekening · currency translation
...
### 💡 Bijkantoor in vreemde valuta — CBN-advies 172/1 📖
...
```json
{
  "titel": "Balans zetel na opneming bijkantoor in EUR (periode x+1) — temporal-methode",
...
### ⚠️ Niet-monetair zien als monetair (omgekeerd ook)
...
### ⚠️ CTA niet recycleren bij verkoop
...
### ⚠️ Functionele munt = lokale munt (automatisch)
