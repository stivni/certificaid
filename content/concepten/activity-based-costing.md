...
_Procedure_ · afk: **ABC** · ook: activity-based-costing · abc-methode
...
> [!example]- Zelena Bio NV — traditioneel vs ABC bij twee productlijnen
...
>
> | Aanpak | Standaard-tafel | Luxe-tafel | Inzicht |
>
> | --- | --- | --- | --- |
>
> | Traditioneel (overhead/arbeidsuren = 20.000/150 = 133 EUR/u) | 250 + 1 u × 133 = 383 EUR | 250 + 5 u × 133 = 915 EUR | Luxe lijkt 'duur' maar redelijk |
>
> | ABC (set-up-pool 10.000 EUR; productie-pool 10.000 EUR — drivers: set-ups + arbeidsuren) | 250 + (10.000/11 × 1) + (10.000/150 × 1) = 250 + 909 + 67 = 1.226 EUR | Wacht — bereken opnieuw | Zie hieronder |
>
> **🧮 Correcte ABC-berekening — set-ups als driver**
>
...
> [!warning]- ABC implementeren zonder management-buy-in
...
> [!warning]- Te veel activiteiten — verlamming
