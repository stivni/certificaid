...
**Status**: `in-voege` · sinds **2019-03-17** · basis: Wet 17 maart 2019 (ITAA-wet) art. 37 + IESBA-code Part 4A + 4B + Wet 7 december 2016 (revisorenwet) voor commissaris-opdrachten

Onafhankelijkheid is verankerd in art. 37 ITAA-wet ('volledige onafhankelijkheid'); concrete uitwerking via IESBA-code Section 400-940 die door ITAA als bindend is overgenomen. Voor commissaris-opdrachten gelden bovendien de strengere bepalingen van de revisorenwet en EU-richtlijn 2014/56.

**✅ Voor**
- 📖 Verplicht bij audit-, review- en andere assurance-opdrachten — bv. commissaris-mandaat, review (ISRE 2400), agreed-upon-procedures (ISRS 4400), isae-opdracht (ISAE 3000/3402), bijzondere wettelijke opdrachten zoals inbreng in natura (art. 7:7 WVV), ontbinding-vereffening (art. 2:71 WVV).

**🚫 Niet voor**
- 📖 Niet-assurance-opdrachten (gewone boekhouding, fiscale aangifte, advies). Hier geldt objectiviteit (Section 110), maar niet de volledige onafhankelijkheidsstandaard. Wel: voor een kantoor dat zowel niet-assurance- als assurance-diensten levert aan dezelfde cliënt: de assurance-poot moet onafhankelijk blijven, wat scope-beperkingen op niet-assurance-diensten kan inhouden (self-review threat).

**📋 Voorwaarden**
- 📖 Voor elke assurance-opdracht: (1) toepassing conceptueel kader (identificeer, evalueer, pak aan); (2) geen verboden financiële belangen tussen audit-team en cliënt (Section 510); (3) geen verboden zakelijke relaties of familiebanden (Section 520-521); (4) geen verboden niet-assurance-diensten gecombineerd met de assurance (Section 600); (5) langtijdige relaties evalueren en eventueel rotatie toepassen (Section 540 voor PIE; Section 940 generiek); (6) onafhankelijkheidsverklaring documenteren in opdrachtdossier.

**⚠️ Risico**
- 🔗 Schending genereert (a) tuchtprocedure ITAA — sancties tot schrapping; (b) burgerrechtelijke aansprakelijkheid jegens derden die afgegaan zijn op het audit-oordeel; (c) bij commissaris-opdracht: nietigheid van het verslag mogelijk; (d) administratieve sancties via de FSMA voor PIE-audits. Reputatieschade voor het hele kantoor.
...
### Eigen kantoor — onafhankelijkheid borgen bij assurance-opdrachten

_De gecertificeerd accountant in een ITAA-kantoor die assurance-opdrachten uitvoert._
...
- → Generiek objectiviteits-beginsel (parent) → [[deontologie]] _(moet-verwijzen)_
- → Onafhankelijkheidsverklaring bij opdrachtaanvaarding → [[opdrachtaanvaarding-en-opdrachtbrief]] _(moet-verwijzen)_
- → Commissaris-specifieke onafhankelijkheidsregels → [[commissaris]] _(moet-verwijzen)_
- → Auditcomité-toezicht op onafhankelijkheid → [[auditcomite]] _(moet-verwijzen)_
- → Tuchtsanctie bij schending → [[tuchtprocedure-itaa]] _(moet-verwijzen)_

## Relaties

### `valt_onder`
- [[deontologie]] — Onafhankelijkheid is een strengere afgeleide van het objectiviteits-beginsel uit de deontologie.
### `vereist`
- [[opdrachtaanvaarding-en-opdrachtbrief]] — Bij opdrachtaanvaarding van assurance-opdrachten moet de onafhankelijkheid expliciet bevestigd en gedocumenteerd worden.
- [[commissaris]] — Voor commissaris-opdrachten gelden bovenop de IESBA-code de strengere bepalingen van de revisorenwet en de EU-richtlijn 2014/56.
### `gecontroleerd_door`
- [[auditcomite]] — Bij PIE: het auditcomité is verantwoordelijk voor toezicht op de onafhankelijkheid van de commissaris.
### `triggert`
- [[tuchtprocedure-itaa]] — Schending van onafhankelijkheidsregels triggert de ITAA-tuchtprocedure.
### `vergelijkbaar_met`
- [[beroepsgeheim]]
    - **Gelijkenissen**:
        - Beide zijn pijlers van de geloofwaardigheid van het beroep
        - Beide kennen strikt geïnterpreteerde uitzonderingen
    - **Verschillen**:
        - Onafhankelijkheid = geen ongepaste beïnvloeding van het oordeel; geldt voor assurance-opdrachten
        - Beroepsgeheim = geheimhoudingsplicht; geldt voor alle opdrachten
        - Onafhankelijkheid = preventief (vooraf afgetoetst); beroepsgeheim = doorlopend
