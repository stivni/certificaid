---
title: "Concept-archief (schema 2.0 legacy)"
tags:
  - catalogus
  - archief
...
> [!warning] Legacy-set — niet meer onderhouden
> Deze 635 concept-fiches zijn gerenderd uit **schema 2.0** records die intussen vervangen worden door schema 2.1 (zie [`data/concepten/schema-2.1.schema.json`](https://github.com/stivni/certificaid/blob/main/data/concepten/schema-2.1.schema.json)).
>
> De bijhorende JSON-records staan in `data/concepten/_archive/`. De nieuwe set wordt gerenderd in [Concepten (schema 2.1)](../).
>
> Wikilinks tussen archief-fiches blijven werken; links vanuit de nieuwe set verwijzen NIET hierheen.

# Concept-archief

Alle concept-records uit de oude schema 2.0-extractie, gegroepeerd per programmaonderdeel. Een concept kon in meerdere PO's voorkomen via `linked_anchors`.

**Totaal**: 674 concept-records over 10 programmaonderdelen — bewaard voor referentie, geen actief studiemateriaal meer.
