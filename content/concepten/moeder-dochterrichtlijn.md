...
tags:
  ...
  - cat-regeling
  - status-concept
gegenereerd_uit: "data/concepten/records/moeder-dochterrichtlijn.json"
---

_Regime_ · afk: **MDR** · ook: parent-subsidiary directive · PSD · moeder-dochter-richtlijn
...
> [!example]- Belgische dochter — Franse moeder
...
> [!example]- PPT-aandachtspunt — kunstmatige Nederlandse tussenholding
...
> ```mermaid
> flowchart TD
>   A[BE NV keert dividend uit] --> B{NL HoldCo: substantie?}
>   B -->|geen personeel, geen functies| C[PPT-toets faalt]
>   B -->|reële economische activiteit| D[Richtlijnvoordelen behouden]
>   C --> E[BE fiscus weigert RV-vrijstelling]
>   C --> F[Belast als rechtstreekse uitkering aan Rusland]
>   D --> G[RV-vrijstelling + DBI in NL]
> ```
>
...
> [!warning]- 10 %-drempel verwarren met de 5 %-drempel voor de Belgische DBI-aftrek
...
> [!warning]- Richtlijn toepassen op derde-land-dividenden
...
> [!warning]- PPT als 'losse' bepaling vergeten
