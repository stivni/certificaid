...
🏢 Entiteit · 📋 Regeling · Anchors: `2.4.III` · Wave: `skeleton-btw-internationaal-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: BTW-E — **Synoniemen**: groepsbtw · VAT group · btw-groep — **Vertalingen**: fr: unité TVA
...
### 💡 Aurelia Group — IT-shared-services tussen moeder en dochter 🔗
...
### 💡 Zelena Vastgoed — herziening bij uittreding 🔗
...
### ⚠️ Drie criteria vergeten — vermoeden bij 50 %+ is geen volwaardige test
...
### ⚠️ Btw-eenheid verwarren met fiscale consolidatie (VenB)
...
### ⚠️ Hoofdelijke aansprakelijkheid onderschatten
...
### ⚠️ Externe facturatie verwarren met intra-eenheid
