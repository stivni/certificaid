...
Universeel toepasbaar in elke geautomatiseerde omgeving. Kader: ISA 315 + ISA 330 + COBIT (ISACA, IT-governance-framework).

**✅ Voor**
- 🔗 Elke onderneming met een boekhoudpakket, ERP of e-commerce-platform. Schaalbaar: voor een kmo enkele key controls in het standaardpakket, voor een grote onderneming een volledig ITGC-framework met onafhankelijke IT-audit-functie.

**⚠️ Risico**
- 📖 Specifieke risico's in informatica-omgevingen (ISA 315 par. A165): ongeautoriseerde toegang tot data en programma's, ongeautoriseerde wijzigingen aan data of programma's, gebruik van ongeautoriseerde of niet-getoetste programma-versies, manipulatie van geautomatiseerde verwerking, verlies van data door systeemfalen of cyberaanval, gebrek aan audit trail.
...
### Externe auditor toetst IT-controles bij cliente

_De auditor die het IT-aspect van interne controle moet beoordelen voor zijn risico-inschatting (ISA 315) en eventuele steun (ISA 330)._
...
_De ITAA-beroepsbeoefenaar die zijn eigen kantoor moet beveiligen - beroepsgeheim + GDPR + AWW._
...
- → Informatica-functiescheiding via RBAC → [[functiescheiding]] _(moet-verwijzen)_
- → IT-bewijs verzamelen door auditor → [[audit-bewijs]] _(moet-verwijzen)_
...
- [[interne-controle]]
### `vereist`
- [[functiescheiding]] — Informatica-functiescheiding via Role-Based Access Control is een van de kerntoepassingen van het functiescheiding-principe.
