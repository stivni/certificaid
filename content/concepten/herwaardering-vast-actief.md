...
# Herwaardering van vast actief

_Verrichting_

📅 Gebeurtenis · 📋 Regeling · Anchors: `1.1.II.B` · Wave: `cluster-extract-balansposten-activa-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: herwaarderingsmeerwaarde — **Vertalingen**: en: revaluation of fixed assets · fr: réévaluation d'immobilisations
...
#### 💡 Herwaardering gebouw: boekwaarde 200.000 → marktwaarde 350.000 🔗
...
### ⚠️ Herwaarderingsmeerwaarde als winst boeken
...
### ⚠️ Herwaardering op IMA, voorraden of vorderingen
