...
🏢 Entiteit · Anchors: `1.1.II.M` · Wave: `cluster-extract-balansposten-activa-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: operationele kosten · operating expenses — **Vertalingen**: en: operating expenses · fr: charges d'exploitation
...
#### 💡 Aankoop handelsgoederen 1.000 EUR + 21% btw 🔗
...
#### 💡 Ereloon accountant 2.500 EUR + 21% btw 🔗
...
#### 💡 Jaarlijkse afschrijving machine 10.000 EUR / 10 jaar = 1.000 EUR 🔗
...
### ⚠️ Niet-aftrekbare btw vergeten
...
### ⚠️ Herstructureringskosten = uitzonderlijk?
