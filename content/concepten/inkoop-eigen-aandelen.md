...
_Verrichting_ · ook: verkrijging van eigen aandelen · share buyback · treasury shares acquisition
...
> [!example]- BV ExitCo — inkoop aandelen vertrekkende aandeelhouder
...
>
> **📒 Boekingen — Inkoop 200 eigen aandelen tegen €300**
>
> **📊 Eigen vermogen — VOOR vs NA inkoop**
>
> ```json
> {
>   "kolommen": [
...
> ```
>
> **🧮 Fiscale impact bij Cindy (PB) — pro-rata fiscaal kapitaal vs reserves**
>
...
> [!example]- Vernietiging van ingekochte eigen aandelen — vervolg ExitCo
...
>
> **📒 Boeking — Vernietiging eigen aandelen**
>
...
> [!example]- Niet-naleving voorwaarden — integrale herkwalificatie
...
>
> **📋 Correct vs niet-conform — fiscale impact**
>
> | Scenario | Belastbaar bedrag dividend | RV 30% | Netto-uitkering aandeelhouder |
>
> | --- | --- | --- | --- |
>
> | Correct (WVV-voorwaarden voldaan): kapitaal-deel €20.000 vrij + dividend-deel €80.000 | €80.000 | €24.000 | €76.000 |
>
> | Niet-conform (geen AV-machtiging): integrale herkwalificatie €100.000 dividend | €100.000 | €30.000 | €70.000 |
>
> → **Niet-naleving = €6.000 méér belasting op €100.000 (= 6% extra). Eenmalige notariskosten + AV-bijeenroeping (~€2.000) is ruim goedmaakkost voor correcte procedure.**
>
> <small>🔗 WIB92 — art. 18, 2°bis — _wettekst_</small>

## Valkuilen

> [!warning]- 20%-limiet bestaat nog
...
> [!warning]- Stemrecht eigen aandelen telt nog
