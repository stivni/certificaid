...
🏛️ Kader · Anchors: `1.9.IV.C` · Wave: `cluster-extract-financiele-analyse-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: FCF — **Synoniemen**: free cash flow · vrije kasstroom · beschikbare cash flow — **Vertalingen**: en: free cash flow · fr: flux de trésorerie disponible
...
### 💡 FCF-berekening — Zelena Bio NV (20X4) 🔗
...
### ⚠️ Onderhoudscapex en groeicapex niet onderscheiden
...
### ⚠️ Operationele kasstroom als FCF gebruiken
