...
**Status**: `in-voege` · basis: WIB92 art. 90, 3° (belastbaarheid ontvanger) + art. 99 (80 %-regel) + art. 100 (achterstallen) + art. 104, 1° (aftrekbaarheid betaler) + art. 105 (achterstallen aftrek) + BW art. 203-209 (burgerrechtelijke onderhoudsplicht)

Structureel stabiel regime sinds WIB92-invoering. Achterstallen-regime gemoderniseerd in 2007.

**✅ Voor**
- 📖 Elke natuurlijk persoon die op grond van een burgerrechtelijke onderhoudsplicht (BW art. 203 ouders-kinderen, art. 205 ascendenten/descendenten in de rechte lijn, art. 213 huwelijksonderhoudsplicht, art. 301 alimentatie tussen ex-echtgenoten) periodiek of eenmalig betalingen doet aan een familielid. Vereiste: schriftelijk vastgelegd in gerechtelijk vonnis, EOT-akkoord of notariële akte.

**🚫 Niet voor**
- 📖 VRIJWILLIGE betalingen tussen familieleden zonder schriftelijke verplichting → niet aftrekbaar bij betaler, niet belastbaar bij ontvanger (vrijwillige schenking; eventueel schenkbelasting bij hoge bedragen). Ook: betalingen aan SAMENWONENDE persoon (zelfde verblijfplaats fiscaal) → onderhoudsuitkeringregime sluit dat uit (art. 104, 1° in fine).

**📋 Voorwaarden**
- 📖 Cumulatief voor fiscaal regime: (1) er bestaat een onderhoudsplicht op grond van BW of een gelijkwaardige buitenlandse wet; (2) een schriftelijke titel (gerechtelijk vonnis, EOT-akkoord, notariële akte); (3) effectieve betaling in het belastbaar tijdperk; (4) betaler en ontvanger zijn NIET DEEL VAN HETZELFDE GEZIN (verschillende fiscale woonplaats per 1 januari); (5) betaling in geld of in natura met aantoonbare waarde; (6) bewijsstukken: vonnis/akte + betalingsbewijzen + identiteit ontvanger.

**👍 Voordeel**
- 🔗 Tariefarbitrage tussen betaler en ontvanger: indien marginaal PB-tarief van betaler hoger ligt dan van ontvanger, levert het regime een NETTO-besparing voor het 'gespleten' gezin op. Voorbeeld: betaler werkt 50 % marginaal, ontvanger heeft enkel inkomen onder belastingvrije som → besparing voor gezin = 0,80 × 50 % × bedrag − 0 = 40 % van betaalde onderhoudsuitkering. Voor €12.000/jaar onderhoudsuitkering = €4.800 belastingbesparing.

**⚠️ Risico**
- 🔗 Verzuim bewijsvoering bij fiscale controle: zonder gerechtelijk vonnis/notariële akte + betalingsbewijzen verliest betaler de aftrek (80 % × bedrag × marginaal tarief verloren). Voor €12.000 jaar × 80 % × 50 % = €4.800 belasting bijkomend. Stagiair moet bij EOT- of vonnis-cliënten ALTIJD de schriftelijke titel + bankafschriften bewaren in dossier 5 jaar.
- 📖 Achterstallen-progressie-effect: indien betaler in één keer een groot bedrag aan achterstallen betaalt (bv. vonnis met 2 jaar terugwerkende kracht), wordt ontvanger geconfronteerd met sterke progressie-druk. Art. 100 + 105 WIB92 voorzien echter een GESPREIDE belasting/aftrek over de jaren waarop de achterstallen betrekking hebben — moet expliciet worden geclaimd in aangifte.
...
### Cliënt-betaler van onderhoudsuitkering (PB-perspectief)

_De accountant die de PB-aangifte voor een gescheiden cliënt-betaler verzorgt en optimalisatie-advies geeft bij EOT- en alimentatievonnissen._
...
- → Aftrekbare bestedingen-overzicht (Vak XI PB) — betalingskant → [[aftrekbare-bestedingen-pb]] _(moet-verwijzen)_
- → Diverse inkomsten-overzicht — ontvangstkant → [[diverse-inkomsten-pb]] _(moet-verwijzen)_
- ↪ Huwelijksvermogensrecht + scheidings-procedure (burgerrechtelijk) → [[huwelijksvermogensrecht]] _(mag-verwijzen)_

## Relaties

### `valt_onder`
- [[personenbelasting]]
- [[diverse-inkomsten-pb]] — Onderhoudsuitkering ontvangen valt onder diverse inkomsten art. 90, 3° WIB92.
- [[aftrekbare-bestedingen-pb]] — Onderhoudsuitkering betaald valt onder aftrekbare bestedingen art. 104, 1° WIB92.
### `vereist`
- [[gezinssituatie]] — Regime vereist 'niet-samenwoning' tussen betaler en ontvanger — fiscale gezinsstatus is determinant.
