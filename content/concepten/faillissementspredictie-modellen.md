...
# Faillissementspredictie-modellen

_Kader_

🏛️ Kader · Anchors: `1.9.VI.B` · Wave: `cluster-extract-financiele-analyse-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: Z-score-modellen · bankruptcy prediction models · discontinuïteits-modellen — **Vertalingen**: en: bankruptcy prediction models · fr: modèles de prédiction de faillite
...
### 💡 Altman Z''-score — Zelena Bio NV (20X4) 🔗
...
### ⚠️ Z-score als enig criterium gebruiken
...
### ⚠️ Distressed-score 'zelfvervullende profetie' negeren
