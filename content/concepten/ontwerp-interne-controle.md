...
# Ontwerp van interne controle

_Procedure_

🏛️ Kader · Anchors: `1.7.VIII` · `1.7.VIII.A` · Wave: `cluster-extract-controle-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: control design · interne-controle-implementatie · control framework design · uitwerking interne controle — **Vertalingen**: fr: conception du contrôle interne
...
### ⚠️ Ontwerp door auditor in plaats van door management
...
### ⚠️ Eenmalig ontwerp zonder updates
...
### ⚠️ Geen prioritering: alle risico's evenwaardig behandelen
