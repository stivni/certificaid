...
_Kader_ · ook: verrekeningen vennootschapsbelasting · VenB-verrekeningen
...
> [!example]- Saldo-berekening VenB — Zelena Bio NV (AJ 2025)
...
>
> **📋 Saldo-cascade aangifte VenB (EUR, AJ 2025)**
>
> - ['Belastbare grondslag (na cascade)', '334.500']
>
> - ['VenB-tarief 25 %', '83.625']
>
> - ['VERMINDERINGEN/VERREKENINGEN (vakken 1830-1843):', '']
>
> - ['  − Voorafbetalingen (vak 1830)', '−85.000']
>
> - ['  − RV verrekenbaar (vak 1840)', '−30.000']
>
> - ['  − FBB (vak 1841)', '0']
>
> - ['= SALDO (negatief = teruggave)', '−31.375']
>
> - ['Vermeerderings-bijdrage (geen — voldoende voorafbetaald)', '0']
>
> - ['TE RECUPEREREN', '31.375 EUR']
>
> _VenB 83,6 KEUR wordt volledig gedekt door voorafbetalingen + RV-verrekening (115 KEUR totaal). Overschot van 31,4 KEUR krijgt Zelena Bio terug van de fiscus. Geen vermeerderings-bijdrage want voorafbetalingen ruim voldoende. Belangrijk: RV is verrekenbaar EN het dividend kan eventueel onder DBI-aftrek vallen (als deelneming > 10 % én > 2,5 MEUR aanschaffingswaarde) — dubbele begunstiging._
>
> <small>🔗 cluster-extract-agent (opus-4.7-1M) — _ai_model_ — (2026-05-28)</small>

## Valkuilen

> [!warning]- Bedrijfsvoorheffing voor VenB rekenen
...
> [!warning]- RV verrekenen op DBI-vrijgesteld dividend vergeten
...
> [!warning]- FBB als terugbetaalbaar krediet behandelen
...
> [!warning]- Vermeerderings-bijdrage onderschatten bij groeiende vennootschap
