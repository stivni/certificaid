...
📋 Regeling · Anchors: `2.2.III` · `2.2.IV` · `2.2.taak.1` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: BB PB — **Synoniemen**: PB-berekening · calcul de l'impôt IPP — **Vertalingen**: fr: calcul de l'impôt des personnes physiques
...
### 💡 Werknemer alleenstaande — illustratieve cascade AJ 2026 🔗
...
### 💡 Tweeverdieners-gezin — huwelijksquotient + samenvoeging 🔗
...
### 💡 Zelfstandige stopzetting + meerwaarde — afzonderlijk tarief 16,5 % 🔗
...
### ⚠️ Marginaal tarief = effectief tarief verwarring
...
### ⚠️ Vermindering op afzonderlijke aanslag toepassen
...
### ⚠️ Niet-geïndexeerde bedragen uit WIB92 gebruiken in berekening
...
### ⚠️ Vrijstelling DBV verwarren met aftrek
