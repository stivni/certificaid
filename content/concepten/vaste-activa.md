...
🏢 Entiteit · Anchors: `1.1.II.B` · `1.1.II.A` · Wave: `cluster-extract-balansposten-activa-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: immobilisaties · non-current assets — **Vertalingen**: en: non-current assets / fixed assets · fr: actifs immobilisés
...
#### 💡 Aankoop machine 10.000 EUR + 500 transport + 100 installatie 🔗
...
### ⚠️ Bijkomende kosten niet activeren
...
### ⚠️ Klasse 25 leasing-verwarring
