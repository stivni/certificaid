...
🏛️ Kader · 📋 Regeling · Anchors: `2.4.I` · `2.4.II` · `2.4.III` · `2.4.IV` · `2.4.V` · `2.4.VI` · Wave: `skeleton-btw-internationaal-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Afk.**: BTW — **Synoniemen**: BTW-stelsel · value-added tax · VAT · TVA — **Vertalingen**: fr: taxe sur la valeur ajoutée · en: value-added tax
...
#### 💡 Cascade-voorbeeld: van houtkapper tot consument (tarief 21 %) 🔗
...
#### ⚠️ Btw is geen kostprijs voor de ondernemer
...
### ⚠️ Btw is geen Belgische belasting
...
### ⚠️ Btw op factuur ≠ btw aftrekbaar
