...
🏛️ Kader · Anchors: `1.6.I` · `1.6.I.A` · `1.6.I.B` · `1.6.II` · `1.6.taak.1` · Wave: `skeleton-controle-beroep-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: assurance-opdracht · audit-cyclus · audit-aanpak · opdracht-uitvoering · engagement lifecycle — **Vertalingen**: fr: mission d'audit · en: audit engagement
...
### ⚠️ Planning één keer in januari afvinken
...
### ⚠️ Onthouding als ‘veilige optie’
