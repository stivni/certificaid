...
🏛️ Kader · 📋 Regeling · Anchors: `2.2.VI` · `2.2.VI.A` · `2.2.VI.B` · `2.2.X` · Wave: `skeleton-pb-venb-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: revenu professionnel · beroepsinkomsten — **Vertalingen**: fr: revenu professionnel
...
### 💡 Werknemer met bruto € 45.000 — netto beroepsinkomen via forfait 🔗
...
### 💡 Bedrijfsleider met bruto € 60.000 — netto beroepsinkomen + bedrijfsvoorheffing 🔗
...
### 💡 Vrij beroep — baten arts € 80.000, forfait-cascade 🔗
...
### ⚠️ Bezoldiging meewerkende echtgenoot ≠ huwelijksquotient
...
### ⚠️ Forfaitair plafond wordt vaak niet bereikt — werkelijke kosten kunnen gunstig zijn
