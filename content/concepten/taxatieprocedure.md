...
📅 Gebeurtenis · Anchors: `2.5.I` · `2.5.II` · Wave: `skeleton-fiscaliteit-klein-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: vestigingsprocedure · vestiging van de aanslag — **Vertalingen**: fr: procédure de taxation
...
### 💡 Aurelia Holding NV — bericht van wijziging op autokostenaftrek 🔗
...
### ⚠️ Antwoordtermijn BvW = 1 maand, niet 6 maanden
...
### ⚠️ Ambtshalve aanslag is niet 'pakken wat je krijgt'
