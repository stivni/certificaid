...
_Procedure_ · ook: BTW-onderzoek · fiscale controle BTW
...
> [!example]- BTW-controle ter plaatse — verloop
...
>
> 1. Stap 1 — Aanmelding: controleur toont aanstellingsbewijs (art. 61 WBTW); medewerker brengt zaakvoerder.
> 2. Stap 2 — Voorlegging boekhouding: aankoopdagboek + verkoopdagboek + facturen + bankuittreksels 2023-2025 (10-jaar-bewaartermijn art. 60).
> 3. Stap 3 — Onderzoek: controleur steekproeft inkomende facturen op aftrek-uitsluitingen (autokosten, onthaal) en uitgaande op tarief-juistheid + factuurvermeldingen.
> 4. Stap 4 — Vaststelling: 2024 — receptiekost 8.000 EUR + 1.680 EUR BTW ten onrechte volledig afgetrokken (= uitsluiting art. 45 §3, 4°).
> 5. Stap 5 — Kennisgeving rechtzetting: 1.680 EUR terug te storten + boete 10 % (= 168 EUR) + nalatigheidsinteresten.
> 6. Stap 6 — Reactie binnen 1 maand: Zelena stuurt opmerkingen of akkoord.
>
...
> [!example]- Spontane regularisatie vóór controle — boete-effect
...
>
> | Scenario | Boete (KB nr. 41 Tabel B/H) | Totaal |
>
> | --- | --- | --- |
>
> | Spontane regularisatie via aangifte (rooster 61) + brief aan controleur | 5 % (overtreding > 1.250 EUR — Tabel H, kolom 'spontaan') | 500 EUR + nalatigheidsinteresten |
>
> | Pas bij controle (2027) geregulariseerd | 10 % (overtreding > 1.250 EUR — Tabel H, kolom 'bij controle') | 1.000 EUR + boete + interesten |
>
> <small>📖 KB nr. 41 — Tabel H — _kb_</small>

## Valkuilen

> [!warning]- BTW-controle gelijkstellen met fiscale controle (inkomstenbelasting)
...
> [!warning]- Niet-antwoord op vraag om inlichtingen onschadelijk vinden
