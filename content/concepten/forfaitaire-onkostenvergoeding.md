...
_Regime_ · ook: kostenforfait · onkostenvergoeding · kosten eigen aan de werkgever · KEW
...
> [!example]- Thuiskantoor-vergoeding bij Zelena Bio NV
...
> [!example]- Mislukte loonomzetting — Aurelia Holding NV
...
> [!warning]- 'Het is forfaitair, dus geen bewijs nodig' — fout
...
> [!warning]- Forfait gebruiken om netto-loon op te krikken
...
> [!warning]- Vergeten dat forfait + werkelijke kostenvergoeding niet cumulatief is voor dezelfde kost
