...
_Regime_ · ook: elektronische maaltijdcheques · lunch-cheques
...
> [!example]- Maandelijkse boeking maaltijdcheques bij Zelena Bio NV
...
>
> **📒 Boeking aankoop + uitkering maaltijdcheques**
>
> | Rekening | Debet | Credit | Omschrijving |
> | --- | --- | --- | --- |
> | 623 Andere personeelskosten — maaltijdcheques (werkgevers-tussenkomst) | 7.601 |  | Tussenkomst werkgever 1.100 × 6,91 EUR |
> | 455 Bezoldigingen schuldig | 1.199 |  | Netto-inhouding werknemersbijdrage 1.100 × 1,09 EUR |
> | 440 Leveranciers (Edenred / Pluxee / Monizze) |  | 8.800 | Factuur uitgever cheques 1.100 × 8 EUR |
>
> <small>🔗 WIB92 — art. 38/1 §2 — _wettekst_ · cluster-extract-agent (opus-4.7-1M) — _ai_model_ — (2026-05-28)</small>

> [!example]- Werknemersperspectief — Jan, bediende met 220 werkdagen/jaar
...
> [!warning]- Maandelijkse 'forfait' in plaats van per werkdag toekennen
...
> [!warning]- Vergeten dat 'PB-vrij' niet betekent 'volledig aftrekbaar werkgever'
...
> [!warning]- Werknemersbijdrage 'achterhouden' — niet inhouden
