...
<h3 id="verhouding-met-interne-controle">Verhouding met interne controle</h3>

> [!tip]- Verhouding met interne controle
> Externe controle steunt zoveel mogelijk op de interne controle van de cliënt — als die betrouwbaar is, kan de externe auditor minder substantieve testen doen (zie [[toetsing-interne-beheersing]]). Zonder IC wordt elke controle duurder en uitgebreider. ⚖️

<h3 id="onafhankelijkheid">Onafhankelijkheid</h3>

> [!tip]- Onafhankelijkheid
> De externe controleur mag geen functie van bestuurder of leidinggevende met invloed op de boekhouding hebben gehad in de cliëntonderneming in de voorbije twee jaar (KB plichtenleer art. 13). Onafhankelijkheid is de kern van de externe controle — zonder die voorwaarde verliest de verklaring haar waarde. ⚖️
