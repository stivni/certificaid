...
📋 Regeling · Anchors: `3.0.taak.2` · `3.0.taak.3` · `2.3.III.B` · Wave: `skeleton-vennootschapsrecht-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: fiscale neutraliteit fusie/splitsing · fiscaal-neutraal regime herstructurering · rollover-regime
...
### 💡 Latente meerwaarde op gebouw bij fusie Aurelia-Zelena 🔗
...
### ⚠️ Neutraliteit verwarren met definitieve vrijstelling
...
### ⚠️ Verliesoverdracht volledig achten
...
### ⚠️ Onaantastbaarheidsvoorwaarde vergeten bij vrijgestelde reserves
