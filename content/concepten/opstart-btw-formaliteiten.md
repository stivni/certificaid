...
_Procedure_ · ook: aanvangsaangifte btw · 604A-procedure · btw-identificatie
...
> [!example]- Startup SaaS — BV-oprichting + btw-opstart
...
>
> 1. 1. Notaris richt BV op (10 dagen voor 1 sept) — KBO-nummer toegekend.
> 2. 2. Boekhouder dient 604A in op 25 augustus, met startdatum 1 september. Keuze: gewoon regime (niet KO, want B2B), kwartaalaangifte (omzet < 2,5 mio), bankrekening voor terugbetalingen.
> 3. 3. 1 september: btw-nummer toegekend (BE 0123.456.789).
> 4. 4. Eerste investeringsfacturen (software-ontwikkeling): 10.500 EUR input-btw aftrekbaar — eerste kwartaalaangifte (oktober) genereert btw-tegoed.
> 5. 5. Vraag versnelde terugbetaling (vak 72 = ja). Cashflow-voordeel: 10.500 EUR teruggekregen ~6 weken na kwartaalaangifte i.p.v. wachten tot saldo positief wordt.
>
...
> [!example]- Yoga-coach particulier — KO-regime
...
>
> 1. 1. KBO-inschrijving + ondernemingsnummer.
> 2. 2. 604A indienen — keuze KO-regime (omzet ≤ 25.000 EUR + B2C).
> 3. 3. Btw-nummer toegekend maar geen periodieke aangiften.
> 4. 4. Sarah factureert zonder btw aan klanten (verplichte vermelding 'Vrijgesteld van btw — bijzondere regeling kleine ondernemingen, art. 56bis W.BTW').
> 5. 5. Op 31 maart elk jaar: jaarlijkse klantenlisting indienen (jaaromzet boven 250 EUR per btw-plichtige klant).
>
...
> [!warning]- 604A indienen na de eerste aankoop
...
> [!warning]- KO blindelings kiezen omdat omzet laag is
...
> [!warning]- Forfaitaire regeling kiezen voor nieuwe inschrijvingen
