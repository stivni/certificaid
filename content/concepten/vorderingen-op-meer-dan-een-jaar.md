...
🏢 Entiteit · Anchors: `1.1.II.D` · Wave: `cluster-extract-balansposten-activa-2026-05-28`

> [!info] 📝 **Concept** — content gevuld door cluster-extract; niet door mens-verify gegaan.

**Synoniemen**: LT-vorderingen · langetermijn-vorderingen — **Vertalingen**: en: non-current receivables · fr: créances à plus d'un an
...
#### 💡 Renteloze lening 10.000 EUR aan personeelslid over 5 jaar (marktrente 4%) 🔗
...
### ⚠️ Discontering vergeten bij renteloze LT-vordering
...
### ⚠️ Klasse 29 vs klasse 28 verwarren
