...
_Kader_ · ook: gewest-belastingvermindering personenbelasting · réductions d'impôt régionales
...
> [!example]- Vlaamse geïntegreerde woonbonus — overgangsregime lopende lening uit 2018
...
> [!example]- Waalse chèque habitat — lening 2019
...
> [!example]- Aanrekenings-volgorde art. 178/1 — federaal eerst
...
> [!warning]- Vergeten dat woonbonus is uitgedoofd voor nieuwe leningen
...
> [!warning]- Verkeerde gewest-toewijzing bij verhuizing einde december
...
> [!warning]- Federale en gewestelijke verminderingen voor zelfde uitgave cumuleren
...
| Gewest | Regime nieuwe lening | Tarief vermindering | Plafond | Uitdovings-datum |
| --- | --- | --- | --- | --- |
| Vlaanderen | Geen woonbonus meer (uitgedoofd) | Overgang: 30% | 2.280 EUR/echtgenoot + verhogingen | 1/1/2020 |
| Wallonië | Chèque habitat (forfaitair) | Forfait per gezinscoëfficiënt | ~1.520 EUR/jaar + 125 per kind | Lening vanaf 1/1/2016 — chèque |
| Brussel | Geen PB-vermindering meer | — | — | 1/1/2017 |
