...
├── autoriteiten-boekhoudrecht           [K — uit PO 1.2.II]   FSMA · NBB · CBN · ITAA · IBR · CRB · griffies
├── boekhoudplicht                       [K — rename `boekhoudplichtige-onderneming` + absorbeert vereenvoudigde-boekhouding]   art III.82-95 WER · #vereenvoudigde-boekhouding
├── groottecategorie-vereniging          [K — uit PO 1.2.IV + absorbeert vzw-stichting-boekhoudregime]   art 1:28-29 WVV-VZW · #vzw-stichting-regime
...
├── jaarrekening [Σ — absorbeert 6 PO 1.2-records als sub-secties: #waarderingsregels-vastlegging · #jaarverslag · #sociale-balans · #openbaarmaking · #wettelijke-controle · #consolidatie-verwijzing] · eindejaarsverrichtingen [absorbeert #wettelijke-inventaris-art-III-89]   [jaarcyclus II.S + taak.1 + PO 1.2.III.E + IV.C-F + V]
...
│   ▸ #overgedragen-verliezen (absorbed `overgedragen-verliezen` — splits-test 2026-05-26): art 206/207 WIB · 1M€-korf · 30%-aftrekbeperking >1M · anti-misbruik 207§7 · controle-wijziging cross `fiscale-fusie-splitsing`
...
├── (overgedragen-verliezen)               [→ absorbed als #overgedragen-verliezen sub-sectie in `belastbare-grondslag-vennootschapsbelasting`-procedure-Σ; cross naar `fiscale-fusie-splitsing` voor controle-wijziging-impact (art 206§2). Splits-rechtvaardiging-test 2026-05-26: geen keuze-as · niet shared · geen pendant · inherent cascade-deel.]
│
...
Thema: `boekhouding`. *Diepe PO 1.1 + PO 1.2-uitwerking (2026-05-27). Fundament-cluster voor de hele boekhouding-discipline (52 anchors gecombineerd · 58 records → ~28 cluster-eigen + ~15 cross). MAR-volgorde-structuur: basis (I) → boekhoudplicht-scope (I-bis) → groottecategorieën (I-ter) → activa-passiva (II.B-L) → resultaten (II.M-P) → winstbestemming (II.Q) → niet-balans (II.R) → jaarcyclus + synthesedocumenten (II.S) → specifieke regimes (II.U-X). Veel cross-records (kapitaalstructuur · schuldfinanciering · reorganisatie · insolventie · winstuitkering al diep uitgewerkt). NIEUW `boekhouding`-Σ-hoofdrecord. 1 Σ-rename (`bgaap` → `belgisch-boekhoudrecht`). 3 splits + 2 paraplu-renames + 2 `-categorie`-strips (PO 1.1). PO 1.2 integreert via 7 absorpties in bestaande records (`vereenvoudigde-boekhouding-regime` · `vzw-stichting-boekhoudregime` · `jaarlijkse-inventaris` · `openbaarmaking-jaarrekening` · `wettelijke-controle-jaarrekening` · `waarderingsregels-vastlegging` · `jaarverslag-bestuursorgaan` · `sociale-balans`) + 1 rename (`boekhoudplichtige-onderneming` → `boekhoudplicht`). PO 1.2 krijgt geen eigen cluster.*
...
├── autoriteiten-boekhoudrecht            [K — uit PO 1.2.II]   FSMA · NBB · CBN · ITAA · IBR · CRB · griffies — instituten + rollen
...
│
├── --- I-bis. BOEKHOUDPLICHT-SCOPE (PO 1.2.III.A) ---
├── boekhoudplicht                        [K — rename `boekhoudplichtige-onderneming`, focus op verplichting]
│   ▸ art III.82-III.95 WER · wie moet boekhouden · handelaar vs onderneming vs niet-handelaar
│   ▸ #vereenvoudigde-boekhouding (absorbed `vereenvoudigde-boekhouding-regime`): art III.85 · natuurlijke personen + bep. vennootschappen onder drempel · alternatief voor dubbele
│   ▸ cross naar `ondernemingsvormen`-cluster voor juridische-vormkeuze (gerelateerd maar andere test-as)
│
├── --- I-ter. GROOTTECATEGORIEËN (PO 1.2.IV.A-B) ---
├── (groottecategorie-vennootschap)        [→ primair `ondernemingsvormen`-cluster, cross boekhouding voor gevolgen-cascade naar jaarrekening-Σ#wettelijke-controle + jaarrekening-schema-keuze]
├── groottecategorie-vereniging           [K]   art 1:28-29 WVV-VZW · drempels VZW/stichting · gevolgen-cascade boekhoudregime
│   ▸ #vzw-stichting-regime (absorbed `vzw-stichting-boekhoudregime`): vereenvoudigd vs dubbel-boekhouden per categorie · KB 26-06-2003 toepassing
│
├── --- II. ACTIVA (II.B-G) ---
...
│
├── --- VII. JAARCYCLUS + SYNTHESEDOCUMENTEN (II.S + taak.1 + PO 1.2.III.E + IV.C-F + V) ---
├── jaarrekening                           [Σ]   synthesedocumenten-overzicht + balanspresentatie + ROW + WBA-bijlage + levensloop-procedure
│   ▸ #balansschema (volledig · verkort · micro) · #ROW-volledig-verkort · #toelichting
│   ▸ #waarderingsregels-vastlegging (absorbed `waarderingsregels-vastlegging` — PO 1.2.V.A-B): vastleggings-procedure waarderingsregels in toelichting
│   ▸ #jaarverslag (absorbed `jaarverslag-bestuursorgaan` — PO 1.2.IV.D): art 3:6 WVV · bestuursverslag · niet-financiële info · KAM-vereisten
│   ▸ #sociale-balans (absorbed `sociale-balans` — PO 1.2.IV.C): KB sociale-balans · personeels-cijfers · jaarrekening-bijlage [voorlopig absorbed; bij content-uitwerking herzien — OP-JR.A]
│   ▸ #openbaarmaking (absorbed `openbaarmaking-jaarrekening` — PO 1.2.IV.F): NBB-neerlegging · 30-dagen-termijn · publicatie-taksen · late-fee
│   ▸ #wettelijke-controle (absorbed `wettelijke-controle-jaarrekening` — PO 1.2.IV.E + rationale-log 2026-05-26 herzien): art 3:72 WVV · commissaris-verplicht-trigger · KMO-norm-toepasselijkheid · jaarrekening-schema-keuze — cross `groottecategorie-vennootschap` voor gevolgen-cascade-trigger
│   ▸ #consolidatie-verwijzing: kruisverwijzing naar `geconsolideerde-jaarrekening` (primair PO 1.4 consolidatie-cluster ⏳) — vermeld + verwijs
...
│   ▸ #wettelijke-inventaris-art-III-89 (absorbed `jaarlijkse-inventaris` — PO 1.2.III.E): art III.89 WER · volledige waarderingsoefening op balansdatum (omvat voorraad-inventaris + activa + vorderingen + voorzieningen)
│
...
│
├── ratio-interpretatie                   [K-techniek — NIEUW, PO 1.9.V.E bekwaamheid-niveau]
│   ▸ overkoepelend hoe ratios te interpreteren (cross-categorie): vergelijking in tijd + sector-benchmark + valkuilen + signaalwaarde
│   ▸ #DuPont-decomposition (rentabiliteit-uitsplitsing) · #cash-conversion-cycle-cross (activiteits ↔ liquiditeits-ratios) · #sector-benchmarking-bronnen (NBB · Companyweb · sector-rapporten) · #valkuilen (window-dressing · niet-recurrente · seizoens-effect)
│   ▸ shared thema met `financiele-diagnose` (= ratio-interpretatie toegepast op geheel)
│
├── --- III. KASSTROOM ---
├── kasstroom-analyse                     [Σ — gepromoveerd na PO 1.9-grondige-doorloop 2026-05-27]
│   ▸ overkoepelend: IAS 7 (geconsolideerd) · indirecte vs directe methode · cash-flow-statement-opbouw
│   ▸ #bedrijfscyclus-en-kasstroom: operating cycle-link · cross `cyclus-analyse` (controle-cluster · shared thema)
│   ▸ #tabel-waardemutaties: voorstellingsvorm kasstromen — geen apart record (werkveld-denken: het is presentatie, geen fenomeen)
│   ▸ #cash-flow-definitie + #free-cash-flow-verbijzondering (absorbed `free-cash-flow`? óf behoud apart wegens DCF-context — zie hieronder)
│   ▸ #behoefte-bedrijfskapitaal: cross `activiteits-ratios`#werkkapitaalbehoefte (zelfde fenomeen, andere as)
│   ▸ #derdenkapitaal-financiering: cross `schuldfinanciering`-cluster (kasstroom-impact financierings-keuze)
│   ▸ #eigen-vermogen-financiering: cross `kapitaalstructuur`-cluster (kasstroom-impact EV-mutaties)
│   ▸ #3-categorieën-IAS7: bedrijfsvoering · investering · financiering — keuze-as bij classificatie
│   ▸ #toepassing-praktisch: case-study-niveau (PO 1.9.IV.H bekwaamheid)
├── free-cash-flow                        [K — behoud apart wegens DCF-waarderings-context]
│   ▸ FCF · FCFE (to Equity) · FCFF (to Firm) · waarderings-input voor DCF-model · niet hetzelfde als kasstroom-statement-bedrijfsvoering
│
...
- controle-opdracht: `cyclus-analyse` (shared thema — cross naar `kasstroom-analyse`-Σ#bedrijfscyclus-en-kasstroom: operating cycle in beide contexten)
- schuldfinanciering: cross van `kasstroom-analyse`-Σ#derdenkapitaal-financiering (kasstroom-impact financierings-keuze)
- kapitaalstructuur: cross van `kasstroom-analyse`-Σ#eigen-vermogen-financiering (kasstroom-impact EV-mutaties)
...
- ~~OP-AN.B~~ ✅ **opgelost 2026-05-27**: `kasstroom-analyse` Σ-promotie uitgevoerd met 8 sub-secties (PO 1.9.IV.A-H). Cross-links naar `cyclus-analyse` (controle), `activiteits-ratios`#werkkapitaalbehoefte, `schuldfinanciering`-cluster, `kapitaalstructuur`-cluster.
