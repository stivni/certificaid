...
| [ADR-032](ADR-032-examen-vragen-render-per-programmaonderdeel.md) | Voorbeeldexamenvragen renderen per programmaonderdeel i.p.v. per bronbestand. Multi-PO vragen verschijnen in alle relevante pagina's. Per-examen pagina's vervallen. *(Output-locatie gewijzigd door ADR-040: nu `content/studiemateriaal/<po-slug>/voorbeeldexamenvragen.md`.)* | Accepted |
...
| Examen-vragen renderen (per programmaonderdeel) | ADR-032 — `tools/examen/render_merged_v4.py` → `content/studiemateriaal/<po-slug>/voorbeeldexamenvragen.md` (17 pagina's + index) |
...
| **Minicursus** schrijven voor een PO (PO-niveau verhaal + routekaart) | ADR-036 + [`docs/minicursus-schrijfregels.md`](../minicursus-schrijfregels.md) + mockup [`content/studiemateriaal/1-4/index.md`](../../content/studiemateriaal/1-4/index.md) |
