# VERIFY-run verify-run-20260515T141017Z — Instructies voor Opus-subagent

**Programmaonderdeel**: 1.4
**Run-id**: verify-run-20260515T141017Z
**Gegenereerd op**: 2026-05-15T14:10:18+00:00
...
- **Records** (30 stuks): `data/extractie/1.4/verify-runs/records-verify-run-20260515T141017Z.json`
- **Anchors** (13 stuks): `data/extractie/1.4/verify-runs/anchors-verify-run-20260515T141017Z.json`
- **Examenvragen** (0 stuks): `data/extractie/1.4/verify-runs/examen_vragen-verify-run-20260515T141017Z.json`
