# Competentie-destillatie-run competentie-run-20260515T183709Z — Instructies voor Opus

**Programmaonderdeel**: 1.4
**Run-id**: competentie-run-20260515T183709Z
**Gegenereerd op**: 2026-05-15T18:37:09+00:00
**Model**: claude-opus-4-7

## Jouw taak

Destilleer competentie-voorstellen voor programmaonderdeel 1.4
...
- **Anchors** (13 stuks): `data/extractie/1.4/competentie-runs/competentie-run-20260515T183709Z`
- **Exam-patterns** (2 bestanden): vraagvormen + complexiteitspatronen
